...
I18N.conf = {
     ...
     * 文件清單 files js-navigation-container js-active-navigation-container
     * 評論內容等 js-comment-body
     * 評論編輯區域 comment-form-textarea
     * 文件搜尋模式 js-tree-finder-virtual-filter
     * 倉庫文件清單 js-navigation-open Link--primary
     * 快捷鍵 按鍵 js-modifier-key
     * 洞察-->流量-->熱門內容清單 capped-list-label
     * realease 頁面 描述主體 markdown-body my-3
     * f4 my-3
     * 倉庫頁 使用者名稱/倉庫名 標題 AppHeader-globalBar-start 新版全域導航
    ...
    // marked-text --> 文件搜尋模式/<user-name>/<repo-name>/find/<branch> 文件清單條目
...
I18N.zh["pubilc"] = { // 公共區域翻譯
    "static": { // 靜態翻譯
        ...
        "Search in this repository": "搜尋該倉庫", // new code search
        "Search in this owner": "搜尋該所有者", // new code search
        ...
        "Feature preview": "功能預覽",
            ...
            "Enable": "啟用",
            "Disable": "禁用",
            "New Code Search and Code View": "新版程式碼搜尋和程式碼檢視",
            "Colorblind themes": "色盲主題",
            "Command Palette": "指令面板",
            "Global navigation update": "全域導航更新",
        ...
        "Add a suggestion, <Ctrl+g>": "添加建議，<Ctrl+g>", // 拉取請求 程式碼審查 回復對話框
        ...
        "Add a bulleted list, <Ctrl+Shift+8>": "添加無序清單 <Ctrl+Shift+8>",
        "Add a numbered list, <Ctrl+Shift+7>": "添加有序清單 <Ctrl+Shift+7>",
        "Add a task list, <Ctrl+Shift+l>": "添加任務清單 <Ctrl+Shift+l>",
        ...
        "Attach files by dragging & dropping, selecting or pasting them.": "透過拖放，選擇或貼上來附加文件。",
        "Attach files by selecting or pasting them.": "透過選擇或貼上來附加文件。",
...
I18N.zh["page-profile/projects"] = { // 個人首頁- 項目標籤卡
    "static": { // 靜態翻譯
        ...
        // 項目標籤卡 ?tab=projects >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            "Kanban-style project board": "看板式項目板",
...
I18N.zh["page-profile/stars"] = { // 個人首頁 - 星標標籤卡
    "static": { // 靜態翻譯
        ...
        // 星標標籤卡 ?tab=stars >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            "Lists make it easier to organize and curate repositories that you have starred.": "清單可使您更容易組織和策劃您的星標倉庫。",
            "Create your first list.": "建立您的第一個清單。",
        ...
        // Profile 個人資料 https://github.com/settings/profile
            ...
            "Contributions & Activity": "貢獻與活動",
                "Make profile private and hide activity": "將個人資料設定為私密，並隱藏活動",
                    "Enabling this will hide your contributions and activity from your GitHub profile and from social features like followers, stars, feeds, leaderboards and releases.": "啟用此功能後，您的貢獻和活動將會從您的 GitHub 個人資料中隱藏起來，也不會被關注者、觀星者、訂閱源、排行榜和發布等社交功能所發現。",
            ...
            "Building an application, service, or tool that integrates with GitHub?": "構建與 GitHub 整合的應用程式、服務或工具？",
            "Join the GitHub Developer Program": "加入 GitHub 開發者計劃",
            ", or read more about it at our": "，或閱讀更多關於它的資訊在我們的",
            "Developer site": "開發者網站",
            ...
            "No Preference": "未設定",
            "We'll use this language preference to filter the trending repository lists on": "我們將使用此語言偏好來過濾趨勢倉庫清單在",
            "and our": "和我們的",
        ...
        // Notification center 通知 https://github.com/settings/notifications
            ...
            "Subscriptions": "訂閱",
                "Watching": "關注倉庫",
                    ...
                    "Notify me:": "提醒我：",
                    "on GitHub, Email": "在 GitHub 上、電子郵件",
...
I18N.zh["settings/billing"] = { // 設定 - 帳單和計劃
    "static": { // 靜態翻譯
        ...
        // 帳單和計劃 https://github.com/settings/billing
            ...
            "Switch to yearly billing and save": "切換到按年計費並儲存", // 組織設定
            ...
            "120 core-hours of Codespaces compute": "120 個核心小時的程式碼空間計算",
            "15GB of Codespaces storage": "15GB 的程式碼空間儲存",
            "Community support": "社群支援",

            "Not included:": "不包含：",
            "Protected branches on all repos": "所有倉庫上的受保護分支",
            "Access to Codespaces": "訪問程式碼空間",
            "Multiple reviewers in pull requests": "拉取請求中多個審閱者",
            "Required status checks": "所需的狀態檢查",
            "Code owners": "程式碼所有者",
            "Required reviewers": "所需的審閱者",
        ...
        // 組織設定 邀請帳單管理員 '/organizations/<org-login>/billing_managers/new'
            ...
            "have the ability to:": "具備以下能力：",
                ...
                "View a list of billing managers": "查看帳單管理員清單",
            ...
            "be able to:": "能夠：",
                ...
                "Be seen in the list of organization members": "在組織成員清單中可見",
        ...
        // Emails 電子信箱 https://github.com/settings/emails
            ...
            "Email preferences": "郵件偏好設定",
                "Receive all emails, except those I unsubscribe from.": "接收所有的郵件，除了那些我取消訂閱的郵件。",
                    "We’ll occasionally contact you with the latest news and happenings from the GitHub Universe.": "我們會不定期地聯絡您，告訴您來自 GitHub 宇宙的最新消息和發生的事情。",
                "Only receive account related emails, and those I subscribe to.": "僅接收帳戶相關的郵件，以及我訂閱的郵件。",
                    "We’ll only send you legal or administrative emails, and any emails you’re specifically subscribed to.": "我們僅向您發送法律或行政郵件，以及您特別訂閱的任何郵件。",

                "You’re subscribed to:": "您已訂閱：",
                    "Vulnerability newsletter": "漏洞簡訊",
                "Unsubscribe": "取消訂閱",
            "Save email preferences": "儲存郵件偏好設定",
            // 頂部提醒
                "Successfully updated your email preferences.": "成功更新了您的郵件偏好設定。",
...
I18N.zh["settings/security"] = { // 設定 - 密碼和身份身份驗證
    "static": { // 靜態翻譯
        ...
        // 密碼和身份身份驗證 - 帳戶安全 https://github.com/settings/security
            ...
            "Password is too short (minimum is 8 characters), needs at least 1 lowercase letter, and is in a list of passwords commonly used on other websites": "密碼太短（最少8個字元），至少需要1個小寫字母，而且已在其他網站常用密碼清單中",
            "Password is too short (minimum is 8 characters), needs at least 1 lowercase letter, cannot include your login, and is in a list of passwords commonly used on other websites": "密碼太短（最少為8個字元），至少需要1個小寫字母，而且不能包括您的登入名，以及在其他網站常用的密碼清單中。",
            "Password is too short (minimum is 8 characters), needs at least 1 number, cannot include your login, and is in a list of passwords commonly used on other websites": "密碼太短（最少8個字元），需要至少1個數字，不能包含您的登入名，以及在其他網站常用的密碼清單中",
            "Password is too short (minimum is 8 characters) and is in a list of passwords commonly used on other websites": "密碼太短（最少為8個字元），而且已在其他網站常用的密碼清單中。",
            "Password needs at least 1 lowercase letter and is in a list of passwords commonly used on other websites": "密碼需要至少 1 個小寫字母，而且已在其他網站常用的密碼清單中",
            "Password is in a list of passwords commonly used on other websites": "密碼在其他網站常用的密碼清單中",
            ...
            "Two-factor authentication": "雙重身份驗證",
                ...
                ". Thank you for helping keep the ecosystem safe!": " 起，您的帳戶將需要啟用雙重身份驗證。感謝您幫助維護生態系統的安全！",
            ...
            "Two-factor methods": "雙重身份驗證方式",
                ...
                "Authenticator app": "身份驗證器應用",
                    ...
                    "Learn more about enabling 2FA": "了解更多有關啟用 2FA 的資訊",
                ...
                "GitHub Mobile": "GitHub 行動應用",
                    "GitHub Mobile can be used for two-factor authentication by installing the GitHub Mobile app and signing in to your account.": "透過安裝 GitHub 行動應用並登入帳戶，可以使用 GitHub 行動應用來進行雙重身份驗證。",
                    "Manage GitHub Mobile": "管理 GitHub 行動端",
...
I18N.zh["settings/auth"] = {
    "static": { // 靜態翻譯
        ...
        // 查看復原碼 https://github.com/settings/auth/recovery-codes
            ...
            "Generate new recovery codes": "生成新的復原碼",
                "When you generate new recovery codes, you must download or print the new codes.": "當您生成新的復原碼時，您必須下載或列印新復原碼。",
...
I18N.zh["settings/sessions"] = {
    "static": { // 靜態翻譯
        ...
        // 工作階段詳情 https://github.com/settings/sessions
            "Web sessions": "網路工作階段",
            "GitHub Mobile can be used to verify your identity when signing in from a new device and as a two-factor authentication method.": "GitHub Mobile 可用於從新裝置登入時驗證您的身份，並作為一種雙因素身份驗證方法。",
            ...
            "This is a list of devices that have logged into your account. Revoke any sessions that you do not recognize.": "這是已登入您帳戶的裝置清單。 復原任何您不認識的工作階段。",
            "See more": "查看更多",
            "Your current session": "您目前的工作階段",
            "Last accessed on": "最後訪問日期：",

            "GitHub Mobile sessions": "GitHub 移動工作階段",
            "This is a list of devices that have logged into your account via the GitHub Mobile app. Revoke any session that you do not recognize or you can": "這是已透過 GitHub Mobile 應用登入到您帳戶的裝置清單。復原任何您不認識的工作階段，或者您可以",
            "revoke": "復原",
            "your GitHub Mobile app authorization to sign out of all your devices.": "您的 GitHub Mobile 應用授權以註銷您的所有裝置。",
            "Revoke": "復原",
            "Registered -": "註冊於 -",
            "Last accessed -": "最後訪問 -",
...
I18N.zh["settings/keys"] = { // 設定 - SSH 與 GPG 公鑰
    "static": { // 靜態翻譯
        ...
        // SSH and GPG keys SSH 與 GPG 公鑰 https://github.com/settings/keys
            ...
            "This is a list of SSH keys associated with your account. Remove any keys that you do not recognize.": "這是與您的帳戶相關的 SSH 金鑰的清單。刪除任何您無法識別的金鑰。",
            ...
            "This is a list of GPG keys associated with your account. Remove any keys that you do not recognize.": "這是與您的帳戶相關的 GPG 金鑰的清單。刪除任何您無法識別的金鑰。",
...
I18N.zh["settings/organizations"] = { // 設定 - 組織
    "static": { // 靜態翻譯
        ...
        // Organizations 組織 https://github.com/settings/organizations
            ...
            "You cannot transform this account into an organization because you have an active GitHub Sponsors account.": "由於您有一個活躍的 GitHub 贊助商帳戶，因此您無法將此帳戶轉換為組織。", // 存在贊助商帳戶時
...
I18N.zh["settings/codespaces"] = { // 設定 - 程式碼空間
    "static": { // 靜態翻譯
        ...
        // 程式碼空間 https://github.com/settings/codespaces
            ...
            "encrypted": "被加密",
            "and only exposed to Codespaces you create.": "並且只暴露給您建立的程式碼空間。",
            ...
            "Codespaces created from the following repositories can have GPG capabilities and sign commits so that GitHub can verify that they come from a trusted source. Only enable this for repositories that you trust.": "從以下倉庫庫建立的程式碼空間可以具有 GPG 功能並簽署提交，以便 GitHub 可以驗證它們來自可信源。僅對您信任的倉庫啟用此功能。",
            "Disabled": "禁用",
                "GPG will not be available in Codespaces": "GPG 將無法在 程式碼空間中使用",
            "All repositories": "所有倉庫",
                "GPG will be available for Codespaces for all repositories": "GPG 可用於所有倉庫的程式碼空間",
            "Selected repositories": "選定的倉庫",
                "GPG will be available for Codespaces from the selected repositories": "GPG 可用於選定倉庫的程式碼空間",
...
I18N.zh["settings/copilot"] = { // 設定 - GitHub Copilot
    "static": { // 靜態翻譯
        ...
        // GitHub Copilot https://github.com/settings/copilot
            "Don't fly solo": "不要獨自飛翔",
            "GitHub Copilot is an AI pair programmer that offers autocomplete-style suggestions as you code.": "GitHub Copilot 是一款 AI 配對程式設計師，當您編碼時，它會提供自動完成樣式的建議。",
            "You can receive suggestions from GitHub Copilot either by starting to write code you want to use, or by writing a natural language comment describing what you want the code to do.": "您可以從 GitHub Copilot 接收建議透過開始編寫您要使用的程式碼，或者編寫描述您希望程式碼執行的自然語言注釋。",
            "Get Copilot": "獲取 Copilot",
            "Try Copilot free for 60 days": "免費試用 Copilot 60 天",
    ...
    "static": { // 靜態翻譯
        ...
        // 程式碼安全性與分析 https://github.com/settings/security_analysis
            ...
            "Dependabot security updates": "Dependabot 安全更新",
                "Allow Dependabot to open pull requests automatically to resolve Dependabot alerts.": "允許 Dependabot 自動打開拉取請求，以解決 Dependabot 警報。",
...
I18N.zh["settings/installations"] = { // 設定 - 應用/安裝的 GitHub 應用
    "static": { // 靜態翻譯
        ...
        // https://github.com/settings/installations/<id>
            ...
            "Uninstall": "移除",
                // 取消按鈕 提醒資訊
                // [/This action cannot be undone. Are you sure you want to uninstall this GitHub App from (\d+) repositor(y|ies)?/, "此操作無法復原。您確定要從 1 個倉庫中移除此 GitHub 應用程式嗎？"],


            "Report abuse": "檢舉濫用",
            "Revoke": "復原",
            "Read more about connecting with third-party applications at": "了解更多關於與第三方應用程式連接的資訊，請訪問",
        ...
        // https://github.com/settings/applications
            ...
            // 全部復原對話框
            "Are you sure you want to revoke access for all applications?": "您確定要復原對所有應用程式的訪問權限嗎？",
            "This will revoke access for": "這將復原訪問",
            "all third-party": "所有第三方",
            "OAuth applications. This action cannot be undone.": "OAuth 應用程式。此操作無法復原。",
...
I18N.zh["settings/apps"] = { // 設定 - 開發者設定/GitHub 應用程式
    "static": { // 靜態翻譯
            "Developer settings": "開發者設定",
...
I18N.zh["settings/apps/new"] = { // 建立 GitHub 應用程式
    "static": { // 靜態翻譯
        ...
        // 註冊 GitHub 應用程式 https://github.com/settings/apps/new
            ...
            "Permissions": "權限",
                ...
                "Repository permissions": "倉庫權限",
                    ...
                    "Repository announcement banners": "倉庫公告橫幅",
                        "View and modify announcement banners for a repository.": "查看和修改倉庫的公告橫幅。",
                    "Secret scanning alerts": "隱私掃描警報",
                        "View and manage secret scanning alerts.": "查看和管理隱私掃描警報。",
                    "Secrets": "隱私",
            ...
            "Security advisory": "安全提示",
                "Security advisory published, updated, or withdrawn.": "發布、更新或復原的安全提示",
...
I18N.zh["settings/developers"] = { // 設定 - 開發者設定/OAuth 應用程式
    "static": { // 靜態翻譯
            "Developer settings": "開發者設定",
            "GitHub Apps": "GitHub 應用程式",
            "OAuth Apps": "OAuth 應用程式",
...
I18N.zh["settings/applications/new"] = { // 設定 - 開發者設定/OAuth 應用程式
    "static": { // 靜態翻譯
...
I18N.zh["settings/tokens"] = { // 設定 - 開發者設定/個人訪問令牌
    "static": { // 靜態翻譯
        ...
        // 開發者設定/個人訪問令牌（經典） https://github.com/settings/tokens
            ...
            ", but will not revoke access for any authorized third-party OAuth applications. This action cannot be undone.": "，但不會復原任何授權第三方 OAuth 應用程式的訪問權限。此操作無法復原。",
        ...
        // 建立新個人訪問令牌 https://github.com/settings/tokens/new
            ...
            "Any applications or scripts using this token will no longer be able to access the GitHub API. You cannot undo this action.": "任何使用此令牌的應用程式或腳本將無法再訪問 GitHub API。您無法復原此操作。",
        ...
        // 編輯個人訪問令牌 https://github.com/settings/tokens/<id>
            ...
            "If you’ve lost or forgotten this token, you can regenerate it, but be aware that any scripts or applications using this token will need to be updated.": "如果您遺失或忘記了此令牌，則可以重新生成它，但請注意，需要更新使用此令牌的任何腳本或應用程式。",
        ...
        // 重新生成個人訪問令牌 https://github.com/settings/tokens/<id>/regenerate
            ...
            "Submitting this form will generate a new token. Be aware that any scripts or applications using this token will need to be updated.": "提交此表單將產生一個新的令牌。請注意，任何使用該令牌的腳本或應用程式將需要更新。",
...
I18N.zh["repository-public"] = { // 倉庫-公共部分
    "static": { // 靜態翻譯
       // 倉庫頁面 /<user-name>/<repo-name>/
            ...
            // 復刻下拉
            // [/Fork your own copy of ([^ ]+)/, "復刻成您自己的 $1 副本"],
            ...
            // 議題
                ...
                "Pull request - Conversation tab": "拉取請求 - 對話標籤卡",
                    ...
                    "Request reviewers": "請求審閱者",
                    "Link an issue or pull request from the same repository": "連結同一倉庫的議題或拉取請求",
                    "Toggle visibility of all collapsed review comments instead of just the current one": "切換所有摺疊審查評論的可見性，而不僅僅是目前的審查評論",
                "Pull request - Files changed tab": "拉取請求 - 文件更改標籤卡",
                    "Open commits list": "打開提交清單",
                    "Open files list": "打開文件清單",
                    "Next commit": "下一個提交",
    ...
    "regexp": [ // 正則翻譯
        ...
        [/This repository has been archived by the owner (on .+). It is now read-only./, "此倉庫已由所有者於 $1存檔。它現在是唯讀的。"],
    ],
};
...
I18N.zh["page-new-repo"] = {// 倉庫 - 建立/匯入/復刻倉庫
    "static": { // 靜態翻譯
        ...
        // 建立倉庫 https://github.com/new
            "Create a new repository": "建立新倉庫",
            "A repository contains all project files, including the revision history. Already have a project repository elsewhere?": "倉庫包含項目中的所有文件，包括修訂歷史記錄。在其他地方已有倉庫？",
            "Import a repository.": "匯入倉庫",
            //"Cancel": "取消",
            //"Begin import": "開始匯入",
            "Owner": "所有者",
            ...
            "Add .gitignore": "添加 .gitignore 文件",
                "Choose which files not to track from a list of templates.": "從模板清單中選擇哪些文件不需要跟蹤。",
        ...
        // 匯入倉庫 第一頁 https://github.com/new/import
            ...
            "Import all the files, including the revision history, from another version control system.": "匯入的所有文件，包括修訂歷史記錄，來自其他版本控制系統。",
        ...
        // 復刻倉庫 /<user-name>/<repo-name>/fork
            ...
            "Copy the": "僅複製",
            "branch only": "分支",
            // [/Contribute back to ([^ ]+) by adding your own branch./, "透過添加您自己的分支來回饋 $1。"],
...
I18N.zh["repository"] = { // 倉庫頁面 /<user-name>/<repo-name>/
    "static": { // 靜態翻譯
        ...
        // 初始化空倉庫 /<user-name>/<repo-name>/
            // 組織倉庫
            "Give access to the people you work with": "授予與您一起工作的同伴的訪問權限",
            "You should give access to the collaborators and teams you need to work with.": "您應該給您需要合作的協作者和團隊提供訪問權限。",
            "Add teams and collaborators": "添加團隊和協作者",
...
I18N.zh["repository/issues"] = { // 倉庫 - 議題和拉取請求頁面
    "static": { // 靜態翻譯
        // pull 與 request 公共詞條
            "Filters": "篩選",
                // 篩選下拉選單
        ...
        // 倉庫 --> 議題 標籤卡/<user-name>/<repo-name>/issues
            ...
            "Issues are used to track todos, bugs, feature requests, and more. As issues are created, they’ll appear here in a searchable and filterable list. To get started, you should": "議題用於跟蹤待辦事項、錯誤、功能請求等。建立議題後，它們將出現在可搜尋和可篩選的清單中。要開始，您應該",
        ...
        // 某條具體的議題 /<user-name>/<repo-name>/issues/<id> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            // 右側欄
                "Reviewers": "審閱者",
                    ...
                    // 下拉
                    "Request up to 15 reviewers": "最多請求 15 個審閱者",
                    // [/([^ ]+) approved these changes/, "$1 批准這些更改"], // 具體的拉取請求 審閱者
                    "Request": "請求",
                    // [/Request review from ([^ ]+)/, "請求 $1 審查"], // 具體的拉取請求 審閱者
                ...
                "You’re ignoring this repository.": "您忽略了這個倉庫。",
                    ...
                    "You will only be notified for the events selected from the list below.": "您只會收到從以下清單中選擇的事件的通知。",
...
I18N.zh["repository/pull"] = { // 倉庫 - 某個拉取請求頁面
    "static": { // 靜態翻譯
        ...I18N.zh["repository-public"]["static"],
        ...
        // 倉庫 --> 拉取請求 標籤卡 /<user-name>/<repo-name>/pulls
            ...
            "Pull requests help you collaborate on code with other people. As pull requests are created, they’ll appear here in a searchable and filterable list. To get started, you should": "拉取請求可幫助您與其他人協作處理程式碼。建立拉取請求後，它們將出現在可搜尋和可篩選的清單中。要開始，您應該",
        ...
        // 某條具體的拉取請求 /<user-name>/<repo-name>/pull/<id> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            "Choose a base branch": "選擇基礎分支",
                ...
                "Some commits from the old base branch may be removed from the timeline, and old review comments may become outdated.": "舊的基礎分支的一些提交可能會從時間軸上刪除，而舊的審查評論可能會變得過時。",
                "Change base": "更改基礎分支",
            ...
            "Show resolved": "顯示已解決",
            "Hide resolved": "隱藏已解決",
            "Show all reviewers": "顯示所有審閱者",
            "Hide all reviewers": "隱藏所有審閱者",
            ...
            // [/(\d+) approving reviews? by reviewers? with write access./, "$1 個批准的審查由具有寫入權限的審閱者進行審查。"],
            // [/(\d+) approvals?/, "$1 項批准"],
            ...
            "Require approval from specific reviewers before merging": "合併前需要特定審閱者的批准",
        ...
        // 拉取請求 --> 更改的文件 標籤卡 /<user-name>/<repo-name>/pull/<id>/files
            ...
            "Some generated files are not rendered by default.": "某些生成的文件預設不呈現。",
    ...
    "regexp": [ // 正則翻譯
        ...
        [/(\d+) approving reviews? by reviewers? with write access./, "$1 個批准的審查由具有寫入權限的審閱者進行審查。"],
        [/(\d+) approvals?/, "$1 項批准"],
        // [/(\d+) reviews? requesting changes by reviewers with write access/, "$1 項審查，要求有寫入權限的審閱者進行更改"],
...
I18N.zh["repository/commit"] = { // 倉庫 - 建立議題頁面
    "static": { // 靜態翻譯
        ...I18N.zh["repository-public"]["static"],
    ...
    "static": { // 靜態翻譯
        ...
        // 文件程式碼頁面 /<user-name>/<repo-name>/blob/<brach>/<file> >>>>>>>>>>>>>>>>>>>>>>
            ...
            "Edit this file": "編輯本文件",
                ...
                // "Edit the file in your fork of this project": "在您的復刻中編輯該文件", // 他人庫
                // "Fork this project and edit the file": "復刻項目再編輯文件", // 他人庫
            ...
            "Delete this file":"刪除本文件",
                ...
                // "Delete the file in your fork of this project": "在您的復刻中刪除該文件", // 他人庫
                // "Fork this project and delete the file": "復刻項目再刪除文件", // 他人庫
...
I18N.zh["repository/discussions"] = { // 討論頁面
    "static": { // 靜態翻譯
        ...
        // 討論頁面 /<user-name>/<repo-name>/discussions 組織討論頁 /orgs/<orgs-name>/discussions
            "Teams": "團隊", //組織倉庫
            "People": "成員", //組織倉庫
        ...
        // 討論分類 /<user-name>/<repo-name>/discussions/categories
            ...
            "Warning:": "警告：",
            "Changing the Discussion format from Q&A will mean no previously marked answers will be retained.": "將 “討論” 的形式從 “問答” 改為 “討論”，意味著以前標記的答案將不會被保留。",
            "All previous discussions in this category will be considered an announcement, even if not posted by a maintainer or admin.": "所有以前在這個類別的討論都將被視為公告，即使不是由維護者或管理員發布。",
        ...
        // 某個討論頁面 /<user-name>/<repo-name>/discussions/<id>
            ...
            "Unpin discussion": "取消置頂討論",
                ...
                "The discussion itself won't be deleted, it just won't be shown prominently above the list of discussions.": "討論本身不會被刪除，只是不會突出顯示在討論清單上方。",
                // 頂部提醒
            ...
            // [/Are you sure you want to convert (\d+) issues? with the following label to discussions?/, "您確定要將帶有以下標籤的 2 個議題轉換為討論嗎？"], // 分頁面
            // "What happens when an issue is converted into a discussion:": "將議題轉化為討論時，會發生什麼事：",
    ...
    "static": { // 靜態翻譯
        ...
        // /actions/caches
            ...
            "Sort by": "排序方式",
                ...
                "Smallest size": "最小尺寸",
            "No caches": "尚無快取",
            "Nothing has been cached by actions running in this repository.": "在此倉庫中執行的操作未快取任何內容。",
...
I18N.zh["repository/new"] = { // 倉庫 - 建立/編輯/上傳/刪除文件頁面
    "static": { // 靜態翻譯
        ...
        // 編輯文件頁面 /<user-name>/<repo-name>/edit/<branch>/<file>
            ...
            // 編輯 LICENSE 授權條款文件
                "Choose a license template": "選擇一個授權條款模板",
        ...
        // 分支頁面 branches  /<user-name>/<repo-name>/branches
            ...
            "New branch": "建立分支",
                ...
                "Branch source": "源分支",
                    ...
                    "Choose a source branch": "選擇一個源分支",
                "Share feedback": "分享回饋",
...
I18N.zh["repository/releases"] = { // 倉庫 - 發行版頁面
    "static": { // 靜態翻譯
        ...
        // 建立發行版 /releases/new 和 編輯發行版 /releases/edit/<tag>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            "Choose an existing tag, or create a new tag when you publish this release.": "選擇一個現有的標籤，或在您發布這個版本時，建立一個新標籤。",
...
I18N.zh["repository/pulse"] = { // 倉庫 -> 洞察 - 統計
    "static": { // 靜態翻譯
        ...
        //統計 /<user-name>/<repo-name>/pulse
            ...
            "person": "人",
            "people": "人",
            "Sometimes conversations happen on old items that aren’t yet closed. Here is a list of all the Issues and Pull Requests with unresolved conversations.": "有時會針對尚未關閉的舊項目進行討論。以下是所有未解決的討論的議題和拉取請求的清單。",
...
I18N.zh["repository/network/dependencies"] = { // 倉庫 -> 洞察 - 依賴關係圖 - 依賴關係
    "static": { // 靜態翻譯
        ...
        //依賴關係圖 - 依賴關係 /network/dependencies
            ...
            "No manifest files found": "未找到清單文件",
    ...
    "static": { // 靜態翻譯
        ...
        // 通常 - 設定頁面 /<user-name>/<repo-name>/settings ====================================
            ...
            "Limit how many branches and tags can be updated in a single push": "限制一次推送中可以更新多少個分支和標籤",
                ...
                "about this setting, and send us your": "關於此設定，並向我們發送您的",
                "feedback": "回饋",
            ...
            "This action": "該操作",
            "cannot": "不能",
            "be undone. This will permanently delete the": "被復原。這將永久刪除",
    ...
    "static": { // 靜態翻譯
        ...
        // 建立分支保護規則 頁面 /<user-name>/<repo-name>/settings/branch_protection_rules/new====================================
            ...
            "Protect your most important branches": "保護您最重要的分支",
                ...
                "Your rules won't be enforced on this private repository until": "您的規則將不會在此私有倉庫上強制執行，直到",
                ...
                "upgrade this organization account to GitHub Team or Enterprise": "升級組織帳戶至 GitHub 團隊或企業版", // 組織
            ...
            "When enabled, all commits must be made to a non-protected branch and submitted via a pull request before they can be merged into a branch that matches this rule.": "啟用後，所有提交都必須提交到不受保護的分支，並透過拉取請求提交，然後才能將它們合併到與此規則匹配的分支中。",
                ...
                "New reviewable commits pushed to a matching branch will dismiss pull request review approvals.": "推送到匹配分支的新的可審查提交將復原拉取請求的審查批准。",
            ...
            "Require deployments to succeed before merging": "要求部署成功後再合併",
                "Choose which environments must be successfully deployed to before branches can be merged into a branch that matches this rule.": "選擇必須成功部署到哪些環境才能將分支合併到與此規則匹配的分支中。",
                        ...
                        "Sorry, we couldn’t find any deployments for this repository.": "抱歉，我們找不到此倉庫的任何部署。",
            ...
            "Restrict who can push to matching branches": "限制誰可以推送到匹配的分支",
                "Specify people, teams, or apps allowed to push to matching branches. Required status checks will still prevent these people, teams, and apps from merging if the checks fail.": "指定允許推送到匹配分支的人員、團隊或應用程式。如果檢查失敗，所需的狀態檢查仍然會阻止這些人、團隊和應用程式的合併。",
            ...
            "Allow force pushes": "允許強制推送",
                ...
                "Specify who can force push": "指定誰可以強制推送",
                    "Only these people, teams, or apps are allowed to force push.": "僅允許這些人、團隊或應用強制推送。",
                    "Search for people, teams, or apps": "搜尋人員、團隊或應用",
                    "People, teams, or apps who can force push": "可以強制推送的人員、團隊或應用",
            "Allow deletions": "允許刪除",
            "Allow users with push access to delete matching branches.": "允許有推送權限的使用者刪除匹配的分支。",
...
I18N.zh["repository/settings/rules"] = { // 倉庫設定 - 規則 /<user-name>/<repo-name>/settings/rules
    "static": { // 靜態翻譯
        ...I18N.zh["repository-public"]["static"],
        ...I18N.zh["repository-settings-menu"]["static"],
        ...I18N.zh["orgs-settings-menu"]["static"], // 組織設定

        // 規則 頁面 /<user-name>/<repo-name>/settings/rules===============================
            "Rulesets": "規則集",
            "New branch ruleset": "建立分支規則集",
                "New tag ruleset": "建立標籤規則集",

            "No rulesets will be enforced until this organization account is upgraded to GitHub Enterprise.": "在將此組織帳戶升級到 GitHub 企業版之前，不會強制執行任何規則集。", //組織設定
        ...
        // 建立分支規則 /<user-name>/<repo-name>/settings/rules/new?target=branch&enforcement=disabled
            ...
            "This ruleset will not be enforced until this organization account is upgraded to GitHub Enterprise.": "在將此組織帳戶升級到 GitHub 企業版之前，不會強制執行此規則集。", //組織設定
            ...
            "Bypass list": "旁路清單",
                "Add a team or app to the bypass list": "將團隊或應用添加到旁路清單",
                "Add a team to the bypass list": "將團隊添加到旁路清單", //組織設定

                "Bypass list is empty": "旁路清單為空",
                "Exempt teams or apps from this ruleset by adding them to the bypass list": "透過將團隊或應用添加到旁路清單中，使其免於此規則集",
                "Exempt teams": "豁免團隊",
                "or apps": "或應用",
                "from this ruleset by adding them to the bypass list": "在用於規則，透過將它們添加到旁路清單",

            "Target repositories": "目標倉庫", // 組織設定
                    "Include all repositories": "包含所有倉庫",
                "No repository targets have been added yet": "尚未添加倉庫目標",
                    "Repository targeting determines which repositories will be protected by this ruleset. Use inclusion patterns to expand the list of repositories under this ruleset. Use exclusion patterns to exclude repositories.": "倉庫目標決定了哪些倉庫將受此規則集保護。使用包含規則來擴展此規則集下的倉庫清單。使用排除規則來排除倉庫。",
                ...
                "All repositories": "所有倉庫",
                "Targets have changed and repository match list will update on save.": "目標已更改，倉庫匹配清單將在儲存時更新。",
            ...
            "Target branches": "目標分支",
                ...
                "Branch targeting has not been configured": "尚未配置分支目標",
                    ...
                    "branches": "分支",
                    "will be protected by this ruleset. Use inclusion patterns to expand the list of": "將受此規則集保護。使用包含規則來擴展此規則集下的清單",
                    "under this ruleset. Use exclusion patterns to exclude": "使用排除規則來排除",

                "Default": "預設",
                "All branches": "所有分支",
                "Targets have changed and branch match list will update on save.": "目標已更改，分支匹配清單將在儲存時更新。",
            ...
            "Branch protections": "分支保護",
                ...
                "Require status checks to pass before merging": "要求在合併前通過狀態檢查",
                    "Choose which status checks must pass before branches can be merged into a branch that matches this rule. When enabled, commits must first be pushed to another branch, then merged or pushed directly to a branch that matches this rule after status checks have passed.": "選擇必須通過哪些狀態檢查，才能將分支合併到符合此規則的分支。啟用後，提交必須先推送到另一個分支，然後在狀態檢查通過後合併或直接推送到符合此規則的分支。",
                "Block force pushes": "阻止強制推送",
                    "Prevent users with push access from force pushing to branches.": "防止具有推送權限的使用者強制推送到分支。",
            ...
            // 授權訪問 sudo 模式身份驗證
                ...
                "Use GitHub Mobile": "使用 GitHub 行動應用驗證",
                ...
                "GitHub Mobile": "GitHub 行動應用",
                "Creating a verification request for your GitHub Mobile app.": "為您的 GitHub Mobile 應用程式建立驗證請求。",
                "We sent you a verification request on your GitHub Mobile app. Enter the digits shown below to enter sudo mode.": "我們向您的 GitHub 行動應用發送了一個驗證請求。輸入下面顯示的數字以進入 sudo 模式。",
    ...
    "static": { // 靜態翻譯
        ...
        // 操作頁面 /<user-name>/<repo-name>/settings/actions
            ...
            // [/Allow ([^ ]+), and select non-([^ ]+), actions and reusable workflows/, "允許 $1，並選擇非 $2、操作和可復用的工作流程"],
                ...
                "Enter a comma-separated list of actions and reusable workflows": "輸入以逗號分隔的操作和可復用的工作流程清單",
        ...
        // 添加鉤子 頁面 /<user-name>/<repo-name>/settings/hooks/new ====================================
            ...
            "Which events would you like to trigger this webhook?": "您希望哪些事件觸發此 Web 鉤子？",
                ...
                "Let me select individual events.": "讓我選擇單個事件。",
                    ...
                    "Dependabot alerts": "Dependabot 警報",
                        "Dependabot alert created, dismissed, reopened, fixed, or reintroduced.": "Dependabot 警報建立、駁回、重開、修復或重新引入。",
                    "Deploy keys": "部署金鑰",
                    ...
                    // "Discussion": "討論",
                        "Discussion created, edited, closed, reopened, pinned, unpinned, locked, unlocked, transferred, answered, unanswered, labeled, unlabeled, had its category changed, or was deleted.": "討論的建立、編輯、關閉、重新打開、置頂、取消置頂、鎖定、解鎖、轉移、回答、未回答、標記、未標記、更改其類別或刪除。",
                    "Forks": "復刻",
                        "Repository forked.": "倉庫復刻。",
                    "Issue comments": "發表評論",
                        "Issue comment created, edited, or deleted.": "議題評論的建立、編輯或刪除。",
                    // "Issue": "議題",
                        "Issue opened, edited, deleted, transferred, pinned, unpinned, closed, reopened, assigned, unassigned, labeled, unlabeled, milestoned, demilestoned, locked, or unlocked.": "議題的打開、編輯、刪除、轉移、釘住、取消釘住、關閉、重新打開、分配、未分配、標記、未標記、密閉、去密閉、鎖定或解鎖。",
                    "Labels": "標籤",
                        "Label created, edited or deleted.": "標籤的建立、編輯或刪除。",
                    "Memberships": "團隊成員", // 組織設定
                        "Team membership added or removed.": "添加或刪除團隊成員。",
                    "Merge groups": "合併組",
                        "Merge Group checks requested.": "合併組檢查已請求。",
                    "Meta": "中繼資料",
                    ...
                    // "": "拉取請求",
                        "Pull request assigned, auto merge disabled, auto merge enabled, closed, converted to draft, demilestoned, dequeued, edited, enqueued, labeled, locked, milestoned, opened, ready for review, reopened, review request removed, review requested, synchronized, unassigned, unlabeled, or unlocked.": "拉取請求的分配、自動合併禁用、自動合併啟用、關閉、轉換為草稿、刪除、復原排隊、編輯、排隊、標記、鎖定、里程碑、打開、準備好審查、重新打開、刪除審查請求、請求審查、同步、復原分配、復原標記或解鎖。",
                    "Pushes": "推送",
                    ...
                    "Secret scanning alert locations": "金鑰掃描警報位置",
                        "Secrets scanning alert location created": "金鑰掃描警報位置的建立",
                    "Secret scanning alerts": "金鑰掃描警報",
                        "Secrets scanning alert created, resolved, or reopened": "金鑰掃描警報的建立、解決或重新打開",
                    "Security and analyses": "安全和分析",
                    "Code security and analysis features enabled or disabled for a repository.": "為倉庫啟用或禁用的程式碼安全和分析功能。",
                    // "": "星標",
                    ...
                    "Teams": "團隊",  // 組織設定
                        "Team is created, deleted, edited, or added to/removed from a repository.": "團隊被建立、刪除、編輯或添加到倉庫/從倉庫中刪除。",
                    ...
                    "Workflow jobs": "工作流程的工作",
                        "Workflow job queued, waiting, in progress, or completed on a repository.": "在倉庫上的工作流程的排隊、等待、正在進行或完成。",
    ...
    "static": { // 靜態翻譯
        ...
        // 編輯環境 /<user-name>/<repo-name>/settings/environments/<id>/edit
            ...
            "Deployment branches": "部署分支",
                ...
                "Specify a list of branches using branch name patterns.": "使用分支名稱模式指定一個分支清單",
            ...
            "Code scanning": "程式碼掃描",
                ...
                "Tools": "工具",
                    "CodeQL analysis": "CodeQL 分析",
                        "Identify vulnerabilities and errors in your code with": "識別程式碼中的漏洞和錯誤，通過",
                        "Set up": "設定",
                        "Default": "預設",
...
//             [/Last used within the last (\d+) months?/, "最後一次使用是最近 $1 個月之內"], //金鑰使用時間
//     ],
// };

// // I18N.zh["repository/edit_repositories/new_key"] = { // 倉庫設定頁面(含組織倉庫) /<user-name>/<repo-name>/settings
// I18N.zh["repository/settings/keys/new"] = { // 倉庫設定頁面(含組織倉庫) /<user-name>/<repo-name>/settings
//     "static": { // 靜態翻譯
//         ...I18N.zh["repository-public"]["static"],
//         ...I18N.zh["repository-settings-menu"]["static"],
...
I18N.zh["repository/settings/secrets"] = { // 倉庫設定 - 機密 /<user-name>/<repo-name>/settings/secrets
    "static": { // 靜態翻譯
        ...
        // 操作機密 /<user-name>/<repo-name>/settings/secrets/actions
            ...
            // "Manage your environments and add environment secrets": "管理您的環境並添加環境機密",
        ...
        // /<user-name>/<repo-name>/settings/variables/actions
            ...
            "There are no variables for this repository’s environments.": "此倉庫的環境暫無變數。",

            "Repository variables": "倉庫變數",
            "There are no variables for this repository.": "此倉庫暫無變數。",
        ...
        // 程式碼空間機密 /<user-name>/<repo-name>/settings/secrets/codespaces
            ...
            "collaborator": "協作者",
            "access to this repository can use these secrets for Codespaces.": "訪問此倉庫可以將這些秘密用於程式碼空間。",
...
I18N.zh["repository/settings/notifications"] = { // 倉庫設定 - 郵件通知 /<user-name>/<repo-name>/settings/notifications/edit
    "static": { // 靜態翻譯
        ...
        // 郵件通知管理 頁面 /<user-name>/<repo-name>/settings/notifications/edit ====================================
            ...
            "Sets the": "設定",
            "Active": "啟用",
            "header to automatically approve the message in a read-only or moderated mailing list.": "標頭以自動批准唯讀或審核郵件清單中的郵件。",
...
I18N.zh["homepage"] = { // 未登入的首頁
    "static": { // 靜態翻譯
        ...
        "Harnessed for productivity. Designed for collaboration. Celebrated for built-in security. Welcome to the platform developers love.": "駕馭生產力。專為協作而設計。以內建安全性著稱。歡迎來到廣大開發者喜愛的平台。",
...
I18N.zh["session-authentication"] = { // 登入頁 包含(/login, /session, /sessions/two-factor, sessions/recovery, /sessions/recovery/token, /password_reset等)
    "static": { // 靜態翻譯
        ...
        // 裝置啟用 https://github.com/login/device
            ...
            "Enter the code displayed on your device": "輸入您裝置上顯示的程式碼",
            "Continue": "繼續",
        ...
        // 雙重身份驗證登入 https://github.com/sessions/two-factor
            ...
            "Verify": "驗證",
                "Verifying": "驗證中",
                "Verifying…": "驗證中…",
            "Open the two-factor authenticator (TOTP) app on your mobile device to view your authentication code.": "打開您的行動裝置上的兩步 “身份驗證器” 應用（TOTOP），以查看您的身份驗證碼。",
            ...
            "Having problems?": "有問題嗎？",
                "Authenticate with GitHub Mobile": "使用 GitHub 行動應用進行身份驗證",
                "Use a recovery code or request a reset": "使用復原碼或請求重設",

        // https://github.com/sessions/two-factor/mobile
            "We sent you a sign-in request on your GitHub Mobile app. Enter the digits shown below to verify your identity.": "我們向您的 GitHub 行動應用發送了一個登入請求。輸入下面顯示的數字以驗證您的身份。",
            "We could not verify your identity": "我們無法核實您的身份",
            "Retry": "請重試",
        ...
        // 雙重身份驗證復原 https://github.com/sessions/two-factor/recovery
            ...
            "Locked out?": "被鎖在外面了嗎？",
            "Try recovering your account": "請嘗試復原您的帳戶",
        ...
        // 帳戶復原 https://github.com/sessions/recovery
            ...
            //使用 GitHub 行動應用進行身份驗證
            "It looks like you have a GitHub Mobile session that could be used for two-factor authentication. If you have access to your mobile device, you may be able to use it to login.": "看起來您有一個 GitHub 行動應用工作階段，可以用來進行雙重身份驗證。如果您能訪問您的行動裝置，您也許能用它來登入。",
            ...
            "Emails": "電子信箱",
                "View and update your email addresses": "查看和更新您的電子郵件地址",
                "Verified emails": "經過驗證的電子信箱",
                "Verified emails give you access to more features on GitHub": "經過驗證的電子信箱讓您可以使用 GitHub 上的更多功能",
            "Two-factor methods": "雙重身份驗證方式",
                "Primary two-factor method": "主要雙重身份驗證方式",
                    "Configured: Authenticator app": "已配置：身份驗證器應用",
                "Security keys": "安全金鑰",
                    "Security keys are hardware devices that can be used as your second factor of authentication.": "安全金鑰是一種硬體裝置，可以作為您的第二個驗證步驟。",
            ...
            "Recovery options": "復原選項",
                ...
                "Fallback SMS number": "備用手機號碼",
                    "Providing a fallback SMS number will allow GitHub to send your two-factor authentication codes to an alternate device if you lose your primary device.": "如果您遺失主要裝置，提供備用手機號碼將允許 GitHub 將您的雙重身份驗證碼發送到備用裝置。",
                "No fallback SMS number": "未設定備用手機號碼",
            "Configured": "已配置",
            "Not configured": "未配置",
            // "No recovery tokens": "未設定復原令牌",
            "Update": "更新",
            "Confirm": "確認",
        ...
        // 首次設定雙重身份驗證 https://github.com/settings/two_factor_authentication/setup/intro
            ...
            // 第3步
                ...
                "GitHub Mobile": "GitHub 行動應用",
                    "Install": "安裝",
                    "The GitHub Mobile app on your phone can be used as a 2FA method. Enable it by installing the GitHub Mobile app for": "您手機上的 GitHub 行動應用可用作雙重身份驗證方法。透過安裝 GitHub 行動應用（",
...
I18N.zh["stars"] = { // 星標 https://github.com/stars/<使用者名稱>
    "static": { // 靜態翻譯
        "Your Stars": "我的星標",
...
I18N.zh["search"] = { // 搜尋頁面
    "static": { // 靜態翻譯
        ...
        //  倉庫 中 搜尋結果頁面 /<user-name>/<repo-name>/search >>>>>>>>>>>>>>>>>>>>>>>>
            "Code Search could not process your request, please try different search criteria.": "程式碼搜尋無法處理您的請求，請嘗試不同的搜尋標準。",
            "We track these errors automatically, but if the problem persists feel free to":"我們自動跟蹤這些錯誤，但如果問題持續存在，請隨時",
            "contact us":"與我們聯繫",
            ". We will update any status on our":"。我們將更新任何狀態，在我們",
            "status site.":"狀態網站。",
...
I18N.zh["marketplace"] = { // 應用商店
    "static": { // 靜態翻譯
        ...
        // /marketplace/travis-ci/order/MDIyOk1hcmtldHBsYWNlTGlzdGluZ1BsYW43MA==?account=maboloshi
            ...
            "grant this app access": "授予此應用程式的權限",
        ...
        // /apps/codacy-production
            ...
            "Read more about this app on the Marketplace": "了解更多關於商城中此應用程式的資訊",
        ...
        //>>>>>>>>>>>>>>>>>> 組織首頁/概況頁 <<<<<<<<<<<<<<<<<<<<<
            ...
            // 右側欄
                ...
                "Top discussions this past month": "上個月的熱門討論",
                    ...
                    "Discussions are for sharing announcements, creating conversation in your community, answering questions, and more.": "討論是為了分享公告，在你的社群建立對話，回答問題，以及更多。",
                    "Start a new discussion": "開始新的討論",
                    "View all discussions": "查看全部討論", // 組織討論
            ...
            "Automation and CI/CD": "自動化和 CI/CD",
                "See more about automation and CI/CD": "查看更多有關自動化和 CI/CD 的資訊",
...
I18N.zh["orgs/people"] = { // 組織 - 成員標籤卡
    "static": { // 靜態翻譯
        ...
        // 項目分頁 https://github.com/orgs/<orgs-name>/projects
            "There aren't any public projects yet": "尚無任何公共項目。",
            "There aren't any projects yet": "尚無任何項目。",
            "Try starting a new one.": "嘗試開始一個新的項目。",
    ...
    "static": { // 靜態翻譯
        ...
        // 組織資料 /organizations/<org-login>/settings/profile
            ...
            "GitHub Developer Program": "GitHub 開發者計劃",
                ...
                "Check out the Developer site": "查看開發者網站，",
                "for guides, our API reference, and other resources for building applications that integrate with GitHub. Make sure your contact information is up-to-date below. Thanks for being a member!": "了解指南、我們的 API 參考和其他用於構建與 GitHub 整合的應用程式的資源。請確保您的聯繫資訊是最新的。感謝您成為我們的會員！",
...
I18N.zh["orgs/settings/actions"] = { // 組織設定 - 操作
    "static": { // 靜態翻譯
            ...
            "Policies": "政策",
                ...
                //     [/Any action or reusable workflow that matches the specified criteria, plus those defined in a repository within the ([^ ]+) organization, can be used./, "可以使用符合指定條件的操作或可復用的工作流程，以及在 $1 組織內的倉庫中定義的操作或可復用的工作流程。"], // 操作頁面
                    ...
                    "repositories only": "倉庫，僅僅",
                        ...
                        // "Using a list of specific actions is only supported for public repositories on your current GitHub plan. To have this list apply to private repositories,": "只有目前 GitHub 計劃中的公共倉庫才支援使用特定操作清單。要將此清單應用於私有倉庫，",
        ...
        // 快取 /organizations/<org-login>/settings/actions/caches
            ...
            "Nothing has been cached by actions running in any repositories of this organization.": "在此組織的任何倉庫中執行的操作都沒有被快取。",
...
I18N.zh["orgs/settings/hooks"] = { // 組織設定 - Web 鉤子
    "static": { // 靜態翻譯
        ...I18N.zh["orgs-settings-menu"]["static"],
...
I18N.zh["orgs/settings/discussions"] = { // 組織設定 - 討論
    "static": { // 靜態翻譯
        ...
        // 討論 /organizations/<org-login>/settings/discussions
            ...
            "Choose a source repository that will host the discussions.": "選擇一個承載討論的原始碼庫。",
...
I18N.zh["orgs/settings/security"] = { // 組織設定 - 身份驗證安全主
    "static": { // 靜態翻譯
        ...I18N.zh["orgs-settings-menu"]["static"],
        ...
        // 身份驗證安全  /organizations/<org-login>/settings/security
            ...
            "An IP allow list lets your organization limit access based on the IP address a person is accessing from.": "IP  白名單可讓您的組織根據成員訪問的 IP 位址來限制訪問。",
...
I18N.zh["orgs/settings/security_analysis"] = { // 組織設定 - 程式碼安全性與分析
    "static": { // 靜態翻譯
        ...
        // 程式碼安全性與分析 /organizations/<org-login>/settings/security_analysis
            ...
            "Code scanning": "程式碼掃描",
                "Identify vulnerabilities and errors in your code with": "檢測程式碼中的漏洞和錯誤，使用",
...
I18N.zh["orgs/settings/secrets"] = { // 組織設定 - 機密
    "static": { // 靜態翻譯
        ...
        // 操作變數 /organizations/<org-login>/settings/variables/actions
            ...
            "There are no variables for this organization.": "此組織暫無變數。",
        ...
        // 程式碼空間機密 /<user-name>/<repo-name>/settings/secrets/codespaces
            ...
            ". Anyone with": "。任何對此倉庫具有",
            "collaborator": "協作者",
            "access to the repositories with access to each secret can use it for Codespaces.": "訪問權限的倉庫的每個機密都可以用於程式碼空間。",
...
I18N.zh["orgs/settings/installations"] = { // 組織設定 - GitHub 應用
    "static": { // 靜態翻譯
        ...I18N.zh["orgs-settings-menu"]["static"],
...
I18N.zh["orgs/settings/reminders"] = { // 組織設定 - 定時提醒
    "static": { // 靜態翻譯
        ...
        // 定時提醒 /organizations/<org-login>/settings/reminders
            ...
            "here.": "這裡。",
            "1. Clicking on 'Add' will configure your Slack workspace with the new GitHub app.": "1. 點擊 “添加” 將用新的 GitHub 應用程式配置您的 Slack 工作區。",
            "2. If you already have the old app in Slack, it will uninstall the legacy app and install the new one.": "2. 如果您在 Slack 中已有舊應用程式，它將移除舊應用程式並安裝新應用程式。",
            "Add workspace": "添加工作區",
...
I18N.zh["orgs/settings/applications"] = { // 組織設定 - OAuth 應用程式
    "static": { // 靜態翻譯
        ...I18N.zh["orgs-settings-menu"]["static"],
...
I18N.zh["orgs/settings/apps"] = { // 組織設定 - GitHub 應用程式
    "static": { // 靜態翻譯
        ...I18N.zh["orgs-settings-menu"]["static"],
...
I18N.zh["orgs/settings/publisher"] = { // 組織設定 - GitHub 發布者驗證
    "static": { // 靜態翻譯
        ...
        // 發布者驗證 /organizations/<org-login>/settings/publisher
            ...
            "badge will be added to your apps published in the marketplace, recognizing that apps and other published materials were created by you.": "徽章將添加到您在市場上發布的應用程式中，以識別應用程式和其他已發布材料是由您建立的。",
    ...
    "static": { // 靜態翻譯
        ...
        // 建立項目 https://github.com/new/project
          //同 倉庫 建立項目頁面  /<user-name>/<repo-name>/projects/new
            ...
            "Project board name": "項目板名稱",
            "Description": "描述",
            "(optional)": "(可選)",
            "Project template": "項目模板",
            "Save yourself time with a pre-configured project board template.": "使用預先配置的項目板模板可為您節省時間。",
            "Template:": "模板：",
                "Templates": "模板",
                "None": "無",
                    "Start from scratch with a completely blank project board. You can add columns and configure automation settings yourself.": "從一個完全空白的項目板開始。您可以自己添加欄目並配置自動化設定。",
                "Basic kanban": "基礎看板",
        ...
        // 倉庫 項目頁面  /<user-name>/<repo-name>/projects >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            "Organize your issues with project boards": "使用項目板組織您的議題",
            "Did you know you can manage projects in the same place you keep your code? Set up a project board on GitHub to streamline and automate your workflow.": "您知道您可以在儲存程式碼的同一個地方管理項目嗎？在 GitHub 上設定項目板以簡化和自動化您的工作流程。",
            ...
            "Wrap up": "結束工作",
            "After you wrap up your work, close your project board to remove it from your active projects list. On to the next project!": "結束工作後，關閉項目板，並從活動項目清單中刪除。進入下一個項目！",
        ...
        // https://github.com/users/<user-name>/projects/<id>
            ...
            "Add column": "添加欄目",
                ...
                "Automation": "自動化",
                "Choose a preset to enable progress tracking, automation, and better context sharing across your project.": "選擇一個預設，以便在您的項目中實現進度跟蹤、自動化和更好的內容共享。",
                "Loading…": "載入中…",
                "Preset:": "預設：",
                    "Select type": "選擇類型",
                    "None": "無",
                    ...
                    "In progress": "進行中",
                        ...
                        "Pending approval by reviewer": "由審閱者待批准",
                        "Pull requests in this project will automatically move here when a reviewer requests changes, or it no longer meets the minimum number of required approving reviews. Recommended when another column has the": "當審閱者請求更改或不再滿足所需的最小批准審查數時，此項目中的拉取請求將自動移至此處。當另一欄目啟用了 “",
                    "Done": "已完成",

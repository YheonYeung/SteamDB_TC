...
let projects = {    // 項目頁面 補全
    ...
    "Filter by keyword or by field": "按關鍵字或欄位篩選",
    "Discard": "放棄",
    ...
    "Let everyone know what this project is about, how to use it and link to important resources.": "讓每個人都知道這個項目是關於什麼的，如何使用它，並連結到重要資源.",
...
I18N.conf = {
     ...
     * 忽略區域的 class 正則
     *
     * 代碼編輯器 內容 代碼高亮 CodeMirror
     * 代碼編輯器 最小單元 cm-line ͼ.*
     * 代碼高亮 blob-code
     ...
     * 追溯 視圖 代碼 react-code-text
     * tree 視圖 檔案名 react-directory-filename-column 提交資訊 react-directory-commit-message
     * 代碼差異頁面 代碼 pl-s1|pl-smi|pl-token|pl-c1|pl-kos|pl-k|pl-c|pl-en
     */
...
I18N.zh["title"] = { // 標題翻譯
    "static": { // 靜態翻譯
        ...
        "Webhooks": "Web 鉤子",
        "Environments": "環境",
        "Code security & analysis": "代碼安全性與分析",
        "Deploy keys": "部署金鑰",
...
I18N.zh["pubilc"] = { // 公共區域翻譯
    "static": { // 靜態翻譯
        ...
        "Sorry about that. Please try refreshing and contact us if the problem persists.": "對此我們很抱歉。請嘗試刷新，如果問題仍然存在，請聯絡我們。",
        ...
        // 搜索欄
            ...
            "Search in this directory": "在文件夾中搜尋",
        ...
        // 右上角個人圖示下拉菜單
            ...
            "Feature preview": "功能預覽",
                ...
                "Disable": "禁用",
                "Documentation": "文件",
                "Codespaces Connectivity v2": "代碼空間連接 v2",
                    "Codespaces is rolling out improved infrastructure for both the main connection, and forwarded ports, resulting in better performance and increased reliability.": "代碼空間 正在推出針對主連接和埠轉發的改進基礎設施，從而實現更佳的性能和更高的穩定性。",
                    "If you primarily use Codespaces behind a firewall, you may have to update your firewall settings to enable this new approach. Codespaces will now require access to *.visualstudio.com to facilitate your connection to the codespace.": "如果您通常在防火牆後使用 代碼空間，為了適應這一新的接入方式，您可能需要對您的防火牆設定進行更新。代碼空間 現在需要訪問 *.visualstudio.com 以便於您連接到 代碼空間。",
                ...
                "Project Migration": "項目遷移",
                    "We've made it easy for you to migrate your project (classic) boards to the all new Projects experience! Enable this feature so that you can try out tables, multiple views, new automation options, and powerful field types using your existing projects.": "我們已經為您簡化了將您的項目（經典版）面板遷移到全新項目的體驗！啟用此功能，您可以在現有項目中嘗試表格、多視圖、新的自動化選項和強大的欄位類型。",
                    "How it works:": "如何工作：",
                ...
                "Deployments Dashboard View": "部署儀錶板視圖",
                ...
                "Slash Commands": "斜槓命令",
                    "Slash commands make it easier to type more complex Markdown, such as tables, tasklists, and code blocks.": "斜線命令可以讓您更輕鬆地輸入更複雜的 Markdown，如表格、任務列表和代碼塊。",
                    "Simply type": "只需在議題、拉取請求和討論中鍵入",
                    "on Issues, PRs and Discussions to check out a list of available commands!": "，即可查看可用命令的列表！",
            "Help": "幫助",
            "Settings": "設定",
            "GitHub Docs": "GitHub 文件",
            "GitHub Support": "GitHub 支持",
            "GitHub Community": "GitHub 社區",
            "Sign out": "退出",

        // 狀態設定對話框
        // 出現位置: 個人資料頁, Gist 個人首頁, 倉庫頁右上角個人圖示下拉菜單
            "Edit status": "編輯狀態",
        ...
        // 底部條
            ...
            "Do not share my personal information": "請勿分享我的個人資訊",
        ...
        // 驗證標記浮動資訊
            ...
            "Unverified": "未驗證",
                "Upload your public signing GPG key": "上傳您的公共簽名 GPG 金鑰",
        ...
        // Cookie 設定
            ...
            "Save changes": "保存更改",
            "Required": "必要的",
            "GitHub uses required cookies to perform essential website functions and to provide the services. For example, cookies are used to log you in, save your language preferences, provide a shopping cart experience, improve performance, route traffic between web servers, detect the size of your screen, determine page load times, improve user experience, and for audience measurement. These cookies are necessary for our websites to work.": "GitHub 使用必需的 Cookie 來執行基本網站功能並提供服務。例如，Cookie 用於登錄、保存您的語言偏好、提供購物車體驗、提高性能、在 Web 伺服器之間路由流量、檢測螢幕大小、確定頁面載入時間、改善用戶體驗以及用於受眾測量。這些 Cookie 是我們網站正常運行所必需的。",
            "Analytics": "分析",
            "We allow third parties to use analytics cookies to understand how you use our websites so we can make them better. For example, cookies are used to gather information about the pages you visit and how many clicks you need to accomplish a task. We also use some analytics cookies to provide personalized advertising.": "我們允許第三方使用分析性 Cookie 來了解您如何使用我們的網站，以便我們改進網站。例如，Cookie 用於收集有關您訪問的頁面以及完成任務所需的點擊次數的資訊。我們還使用一些分析性 Cookie 來提供個性化廣告。",
            "Social Media": "社交媒體",
...
I18N.zh["page-dashboard"] = { // 已登入的首頁 - 儀錶板（含組織）
    "static": { // 靜態翻譯
        ...
        "write comments, and open a pull request.": "寫評論，並創建一個拉取請求。(教學內容就不翻譯了...)",
        ...
        "Welcome to your personal dashboard, where you can find an introduction to how GitHub works, tools to help you build software, and help merging your first lines of code.": "歡迎來到您的個人儀錶板，在這裡您可以看到關於 GitHub 工作原理的介紹，幫助您構建軟體的工具，以及幫助您合併您的第一行程式碼。",
        ...
        "Install a powerful code editor": "安裝一個強大的代碼編輯器",
            "is a multi-platform code editor optimized for building and debugging software.": "是針對構建和除錯軟體進行了最佳化的多平台代碼編輯器。",
        ...
        //"Unlock the full power of GitHub! Gain expertise and insights from top organizations through guided tutorials, boosting productivity, enhancing security, and enabling seamless collaboration.": "釋放 GitHub 的全部力量！通過指導教學獲得頂級組織的專業知識和見解，提高生產力、增強安全性並實現無縫協作。",
        //"Start learning": "開始學習",
    ...
    "regexp": [ // 正則翻譯
        ...
        [/, and (\d+) more/, "，以及其他 $1 個組織"], // 用戶 浮動資訊卡
...
I18N.zh["page-profile-public"] = { // 個人首頁（含組織）
    "static": { // 靜態翻譯
        // 左側用戶資訊欄
            ...
            "she/her": "她",
            "he/him": "他",
            "You have blocked this user": "您已封鎖此用戶",
            "Follow": "關注",
            "Sponsor": "贊助",
            "follower": "關注者",
            "followers": "關注者",
            ...
            // 編輯個人資料
                ...
                "Add a bio": "添加個人簡介",
                    "You can": "您可",
                    "@mention": "@使用者名稱或組織名",
                    "other users and organizations to link to them.": "連結到其他用戶和組織。",
                "Pronouns": "代詞",
                    "Don't specify": "不說明",
                    "they/them": "他們",
                    "she/her": "她",
            ...
            // 封鎖 & 檢舉用戶對話框
                ...
                "Add an optional note:": "添加可選備註：",
                    "Please don't include any personal information such as legal names or email addresses. Maximum 100 characters, markdown supported. This note will be visible to only you.": "請勿包含任何個人資訊，如法定姓名或電子郵件地址。最多 100 個字元，支持標記符。此備註只有您本人可見。",
...
I18N.zh["page-profile/repositories"] = { // 個人首頁 - 倉庫標籤卡
    "static": { // 靜態翻譯
        ...
        // 倉庫標籤卡 ?tab=repositories >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            // "Search starred repositories…": "搜索按讚的倉庫…",
    ...
    "selector": [ // 元素篩選器規則
        ["#type-options > summary > span:nth-child(1)", "類型"], // 個人首頁 --> 倉庫標籤頁-->類型篩選器 Type
    ],
};
...
I18N.zh["page-profile/projects"] = { // 個人首頁- 項目標籤卡
    "static": { // 靜態翻譯
        ...
        // 項目標籤卡 ?tab=projects >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            "Built like a spreadsheet, project tables give you a live canvas to filter, sort, and group issues and pull requests. Tailor them to your needs with custom fields and saved views.": "構建像電子表格一樣的項目表，給您一個即時的畫布來對議題和拉取請求進行篩選、排序和分組。透過自訂欄位和保存的視圖，使它們符合您的需要。",
            ...
            "Plan and track work across repositories with custom fields and multiple views": "透過自訂欄位和多個視圖來計劃和跟蹤整個倉庫的工作",
...
I18N.zh["page-profile/packages"] = { // 個人首頁 - 套裝軟體標籤卡
    "static": { // 靜態翻譯
        ...
        // 套裝軟體標籤卡 ?tab=packages >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            "A standard format for distributing Ruby programs and libraries used for the Ruby programming language.": "分發用於 Ruby 程式語言的 Ruby 程序和庫的標準格式。",
            "A package manager for JavaScript, included with Node.js. npm makes it easy for developers to share and reuse code.": "npm 是一個 JavaScript 的包管理器，包含在 Node.js 中。它使開發人員能夠輕鬆地分享和重用代碼。",
            "Containers": "容器",
    ...
    "static": { // 靜態翻譯
        ...
        // Profile 個人資料 https://github.com/settings/profile
            ...
            "Profile picture": "我的頭像",
                ...
                "Upload a photo…": "上傳圖片…",
                "Remove photo": "刪除圖片",
                "Are you sure you want to reset your current avatar?": "您確定要重設當前的頭像嗎？",
                "Your profile picture has been reset. It may take a few minutes to update across the site.": "您的個人頭像已重設，整個網站的更新可能需要幾分鐘的時間。",
            ...
            "You can manage verified email addresses in your": "您可以管理已驗證的電子信箱地址在您的",
            ...
            "All of the fields on this page are optional and can be deleted at any time, and by filling them out, you're giving us consent to share this data wherever your user profile appears. Please see our": "此頁面上的所有欄位都是可選的，可以隨時刪除，填寫這些欄位，即表示您同意我們在您的個人資料出現的任何地方共享此數據。請參閱我們的",
            ...
            "GitHub Developer Program": "GitHub 開發者計劃",
                "has guides, API and webhook references, information about creating GitHub Apps and other resources for building applications that integrate with GitHub. Make sure your contact information is up-to-date below. Thanks for being a member!": "包含指南、API 和 Web 鉤子、有關創建 GitHub 應用的資訊以及用於構建與 GitHub 集成的應用的其他資源。確保您的聯繫資訊是最新的。感謝您的加入！",
            ...
            "page.": "頁面。",
            "Save Trending settings": "保存趨勢設定",

            "ORCID provides a persistent identifier - an ORCID iD - that distinguishes you from other researchers. Learn more at": "ORCID 提供持久標識符 - ORCID iD - 將您與其他開發人員區分，了解更多資訊請訪問",
    ...
    "static": { // 靜態翻譯
        ...
        // Account settings 帳戶設定 https://github.com/settings/admin
            ...
            "unintended side effects": "意想不到的副作用",
                ...
                "set up redirects for Pages sites.": "為 GitHub Pages 站點設定重定向。",
            ...
            "Unlink Patreon account": "取消關聯 Patreon 帳戶",
                "Disconnect the Patreon account": "取消 Patreon 帳戶",
                "for": "和",
            ...
            "Add Successor": "添加繼任者",
            "Search by username, full name, or email address": "搜索使用者名稱、全名、或電子信箱",
...
I18N.zh["settings/accessibility"] = { // 設定 - 無障礙
    "static": { // 靜態翻譯
        ...
        // Accessibility 無障礙 https://github.com/settings/accessibility
            ...
            "Show or hide underlines for links within text blocks. Something isn't working as expected?": "顯示或隱藏文本塊內連結的下劃線。有什麼東西沒有按預期工作嗎？",
            "Let us know": "請告知我們",
            "Hide link underlines": "隱藏連結下劃線",
            "Show link underlines": "顯示連結下劃線",

            // 頂部提醒
            "Link underline preferences successfully saved.": "連結下劃線首選項已成功保存。",

            "Editor settings": "編輯器設定",
                "URL paste behavior": "URL 黏貼行為",
                "Select if URLs should be formatted on paste. You can use": "選擇是否應在黏貼時格式化 URL。您可以使用",
                "to paste a link in the opposite way.": "以相反的方式黏貼連結。",
                "Formatted link": "格式化連結",
                    "Pasting a URL while having text selected will format to a Markdown link": "在選擇了文本的情況下，黏貼 URL 將格式化為 Markdown 連結",
                "Plain text": "純文本",
                    "Pasting a URL while having text selected will replace the text": "在選擇了文本的情況下，黏貼 URL 將替換文本",
                "Save editor settings": "保存編輯器設定",
                    // 頂部提醒
                    "Paste behavior preferences successfully saved.": "黏貼行為首選項已成功保存。",
...
I18N.zh["settings/notifications"] = { // 設定 - 通知
    "static": { // 靜態翻譯
        ...
        // Notification center 通知 https://github.com/settings/notifications
            "Default notifications email": "默認郵件通知設定",
            ...
            "Email weekly digest": "每週電子郵件摘要",
                "Email a weekly summary summarizing alerts for up to 10 of your repositories.": "通過電子郵件發送每週摘要，匯總最多 10 個倉庫的警報。",
                "Don't send": "不發送",
                "Send weekly": "每週發送",
                "Send daily": "每日發送",
...
I18N.zh["settings/billing"] = { // 設定 - 帳單和計劃
    "static": { // 靜態翻譯
        ...
        // 帳單和計劃 https://github.com/settings/billing/summary
            ...
            "Current plan": "當前計劃",
                ...
                "15GB of Codespaces storage per developer": "每位開發者擁有 15GB 的代碼空間儲存空間",
            ...
            "Add-ons": "附加組件",
                // "GitHub Copilot": "",
                    ...
                    "GitHub Copilot uses the GPT-3.5 Turbo model to suggest code and entire functions in real-time, right from your editor": "GitHub Copilot 使用 GPT-3.5 Turbo 模型即時在您的編輯器中提供代碼和整個函數建議",

                     // 組織設定
                    "Learn more about Copilot Business": "了解更多關於 GitHub Copilot 商業版的資訊",
                    "Copilot Business": "GitHub Copilot 商業版",
                    "GitHub Copilot uses the OpenAI large language models to suggest code and entire functions in real-time, right from your editor. You can set up a GitHub Copilot Business subscription for your organization.": "GitHub Copilot 使用 OpenAI 大型語言模型，可在編輯器中即時建議代碼和整個函數。您可以為您的組織設定 GitHub Copilot 商業版訂閱。",
            ...
            "Usage this month": "本月使用情況",
                ...
                // 套裝軟體與操作的儲存空間
                    "Storage for Actions and Packages": "套裝軟體與操作的儲存空間",
                    "Shared storage consists of Actions artifacts and Packages usage. This graph shows the account's storage usage in GB-months. Removing stored artifacts will not reduce this number, but it will lower its rate of growth. To see your account's current storage, download a usage report.": "共享儲存由操作產生的文件和套裝軟體使用組成。此圖以每月 GB 數為單位顯示帳戶的儲存使用情況。刪除儲存的文件不會減少這個數字，但會降低其增長率。若要查看您帳戶的當前儲存空間，請下載使用情況報告。",
                    "Storage": "儲存空間",
                    "Shared Storage": "共享儲存空間",
                // 代碼空間
                    "Usage hours": "使用小時數",
                    "Core hours are calculated by multiplying the compute types by their per-hour rates, which can vary": "核心小時數是透過將計算類型乘以其每小時費率來計算的，該費率可能會有所不同",
                    "Price / hour": "單價 / 小時",
                    "2-core": "雙核",
                    "4-core": "四核",
                    "8-core": "八核",
                    "16-core": "十六核",
                    "32-core": "三十二核",
                    "Storage usage is updated daily and billed monthly": "儲存使用情況每天更新，每月計費",
                    "Price / GB": "單價 / GB",
                    "Prebuild Storage": "預構建儲存",
                // Git LFS 數據
            ...
            "GitHub Sponsors": "GitHub 贊助",
                ...
                "Switch to invoiced billing": "切換到發票帳單", // 組織
        ...
        // 支付資訊 https://github.com/settings/billing/payment_information
            ...
            "Save contact information": "保存聯繫資訊",
        ...
        // 支出限額 https://github.com/settings/billing/spending_limit
            ...
            "Unlimited spending": "不限制支出",
                "Pay as much as needed to keep Actions & Packages running": "按需支付，以保持操作和套裝軟體的運行",
            ...
            // 具體內容
                "Code management": "代碼管理",
                    "Public repositories": "公共倉庫",
                        "Host open source projects in public GitHub repositories, accessible via web or command line. Public repositories are accessible to anyone at GitHub.com.": "在 GitHub 公共倉庫中託管開源項目，可透過網路或命令行訪問。任何人都可以訪問 GitHub.com 上的公共倉庫。",
                    "Private repositories": "私有倉庫",
                        "Host code in private GitHub repositories, accessible via appliance, web, and command line. Private repositories are only accessible to you and people you share them with.": "在私有 GitHub 倉庫中託管代碼，可通過設備、網路和命令行訪問。只有您和與您共享的人才能訪問私有倉庫。",

                "Code workflow": "代碼工作流",
                    "GitHub Codespaces": "GitHub 代碼空間",
                        "Spin up fully configured dev environments in the cloud with the power of your favorite editor. A \"core hour\" denotes compute usage. On a 2-core machine, you would get 60 hours free. On a 4-core machine, you would get 30 hours free, etc. Free hours are assigned to personal accounts, rather than free organizations.": "利用您喜愛的編輯器的強大功能，在雲中快速配置完整的開發環境。“核心小時” 表示計算使用量。在雙核機器上，您將獲得 60 小時的免費時長。在 4 核機器上，您將獲得 30 小時的免費時長，以此類推。免費時長數分配給個人帳戶，而不是免費組織。",
                    "Github Actions": "Github 操作",
                        "Use execution minutes with GitHub Actions to automate your software development workflows. Write tasks and combine them to build, test, and deploy any code project on GitHub. Minutes are free for public repositories.": "利用 GitHub Actions 的幾分鐘執行時間，實現軟體開發工作流程自動化。編寫任務並組合它們，即可在 GitHub 上構建、測試和部署任何代碼項目。對於公共倉庫，執行時間是免費的。",
                    "GitHub Packages": "Github 套裝軟體",
                        "Host your own software packages or use them as dependencies in other projects. Both private and public hosting available. Packages are free for public repositories.": "託管您的套裝軟體，或將其用作其他項目的依賴項。提供私有和公共託管。對於公共倉庫，套裝軟體是免費的。",
                    "Code reviews": "代碼審查",
                        "Review new code, see visual code changes, and confidently merge code changes with automated status checks.": "審查新代碼，查看可視化的代碼更改，並通過自動化狀態檢查自行地合併代碼更改。",
                    // 拉取請求
                    ...
                    "Protected branches": "受保護的分支",
                        "Enforce restrictions on how code branches are merged, including requiring reviews by selected collaborators, or allowing only specific contributors to work on a particular branch.": "對代碼分支的合併方式實施限制，包括要求由選定的協作者進行審查，或僅允許特定的貢獻者在特定分支上工作。",
                    // 代碼所有者
                        "Automatically request reviews – or require approval – by selected contributors when changes are made to sections of code that they own.": "當選定的貢獻者對其擁有的代碼部分進行修改時，自動要求審查或要求批准。",
                    ...
                    // 定時提醒
                        "Send scheduled messages to you or your team listing open pull requests.": "按計劃的向您或您的團隊發送訊息，列出打開的拉取請求。",
                ...
                "Collaboration": "協作",
                    "Collaborators for public repositories": "公共倉庫協作者",
                        "Invite any GitHub member, or all GitHub members, to work with you on code in a public repository you control – including making changes and opening issues.": "邀請任何 GitHub 成員或所有 GitHub 成員，在您控制的公共倉庫上與您共同處理代碼，包括進行更改和提出議題。",
                    "Collaborators for private repositories": "私有倉庫協作者",
                        "Invite any GitHub member, or all GitHub members, to work with you on code in a private repository you control – including making changes and opening issues.": "邀請任何 GitHub 成員或所有 GitHub 成員，在您控制的私有倉庫上與您共同處理代碼，包括進行更改和提出議題。",
                    // 議題
                        "Track bugs, enhancements, and other requests, prioritize work, and communicate with stakeholders as changes are proposed and merged.": "跟蹤漏洞、增強功能和其他請求，確定工作的優先度，並在提出和合併變更時與利益相關者溝通。",
                    // 項目
                        "Visualize and manage issues and pull requests across tables, boards, and roadmaps with custom fields and views that you can arrange to suit your workflow.": "通過自訂欄位和視圖，在表格、面板和路線圖上可視化管理議題和拉取請求，以適應您的工作流程。",
                    "Milestones": "里程碑",
                    ...
                    // 團隊討論
                        "Discuss any topic, unattached to a specific project or issue. Control who has access, notify discussion participants with updates, and link from anywhere.": "討論任何主題，不與特定項目或議題相關。控制訪問權限，通知討論參與者最新情況，並從任何地方進行連結。",
                    ...
                    "Pages and wikis": "GitHub Pages 和 Wiki",
                        "Host documentation and simple websites for your project in a wiki format that contributors can easily edit either on the web or command line.": "以 Wiki 格式為您的項目託管文件和簡單網站，貢獻者可以輕鬆在網路或命令行上進行編輯。",
                    ...
                    "GitHub organizations give you team-based access control and discussions.": "GitHub 組織為您提供基於團隊的訪問控制和討論。",
                        "Learn more about organizations": "了解更多關於組織的資訊",
                ...
                "Security and compliance": "安全性與合規性",
                    ...
                    "Enterprises can connect to advanced systems like LDAP and SAML single sign-on (SSO).": "企業可以連接到如 LDAP 和 SAML 單一登錄 (SSO) 等高級系統。",
                        "Learn more about GitHub Enterprise": "了解更多關於 GitHub 企業版的資訊。",
                ...
                "Marketplace and integrations": "市場和集成",
                    ...
                    "Enterprise Server customers create pre-receive hooks to automatically accept or reject a push.": "企業伺服器客戶創建預接收掛鉤，以自動接受或拒絕推送。",
                        "Learn more about pre-receive hooks": "了解更多關於預接收掛鉤的資訊。",
                ...
                "Support and deployment": "支持與部署",
                    ...
                    "Standard Support": "標準支持",
                        "GitHub Support can help you troubleshoot issues you run into while using GitHub. Get support via the web.": "GitHub 支持可幫助您解決使用 GitHub 時遇到的問題。透過網路獲取支持。",
                ...
                "180 core-hours compute/month and 20GB storage": "每月 180 個核心小時計算和 20GB 儲存",
        ...
        // 組織設定 邀請帳單管理員 '/organizations/<org-login>/billing_managers/new'
            ...
            "is a user who manages the billing settings of your organization.": "是管理您組織的帳單設定的用戶。",
            "will": "會",
            "will not": "不會",
    ...
    "regexp": [ // 正則翻譯
        [/Included minutes quota resets (\d+) 天之內./, "包含的分鐘配額將在 $1 天之內重設"],
        [/Data transfer quota resets (\d+) 天之內./, "數據傳輸配額將在 $1 天之內重設"],
        [/Included quotas resets (\d+) 天之內./, "包含的配額將在 $1 天之內重設"],
        [/Bandwidth quota resets resets (\d+) 天之內./, "頻寬使用配額將在 $1 天之內重設"],
        [/In addition to your personal account, you manage (\d+) organizations?./, "除了您的個人帳戶之外，您還管理 $1 個組織。"],
        [/Leaving it at (\$\d+\.\d{2}) will avoid any extra expenses/, "將其限制在 $1 美元將避免任何額外的費用。"],
...
I18N.zh["settings/emails"] = { // 設定 - 電子信箱
    "static": { // 靜態翻譯
        ...
        // Emails 電子信箱 https://github.com/settings/emails
            ...
            "Primary": "主帳戶",
            "Unverified email addresses cannot receive notifications or be used to reset your password.": "未經驗證的電子郵件地址無法接收通知或用於重設您的密碼。",
            ...
            ". Your default notification email address is still set to": "。您的默認通知電子信箱仍然設定為",
            ...
            "when performing web-based Git operations (e.g. edits and merges) and sending email on your behalf. If you want command line Git operations to use your private email you must": "執行基於 Web 的 Git 操作（例如：編輯和合併）並以您的名義發送電子郵件。如果您想在命令行 Git 操作中使用您的私人電子信箱，您必須",
            ...
            "Email preferences": "郵件首選項",
                "Subscriptions through our various marketing platforms. Each email address has its own subscriptions.": "通過我們的各種行銷平台進行訂閱。每個電子郵件地址都有自己的訂閱。",
                "Manage": "管理",
        ...
        // 訂閱偏好 https://github.com/settings/emails/subscriptions
            ...
            "General info and offers from GitHub": "GitHub 的一般資訊和優惠",
...
I18N.zh["settings/security"] = { // 設定 - 密碼和身份身份驗證
    "static": { // 靜態翻譯
        ...
        // 密碼和身份身份驗證 - 帳戶安全 https://github.com/settings/security
            ...
            "Password is too short (minimum is 8 characters), needs at least 1 lowercase letter, cannot include your login, and is in a list of passwords commonly used on other websites": "密碼太短（最少為8個字元），至少需要1個小寫字母，而且不能包括您的登錄名，以及在其他網站常用的密碼列表中。",
            "Password is too short (minimum is 8 characters), needs at least 1 number, cannot include your login, and is in a list of passwords commonly used on other websites": "密碼太短（最少8個字元），需要至少1個數字，不能包含您的登錄名，以及在其他網站常用的密碼列表中",
            ...
            "Passkeys": "通行金鑰",
                "Passwordless sign-in with passkeys": "使用通行金鑰進行無密碼登錄",
                "Passkeys are a password replacement that validates your identity using touch, facial recognition, a device password, or a PIN. Passkeys can be used for sign-in as a simple and secure alternative to your password and two-factor credentials.": "通行金鑰是一種密碼替代品，可通過觸摸、臉部識別、設備密碼或 PIN 驗證您的身份。通行金鑰可用於登錄，作為密碼和雙重身份驗證的一種簡單而安全的替代方式。",
                "This browser or device does not fully support passkeys - you may be able to use a passkey from another device.": "此瀏覽器或設備不完全支持通行金鑰 - 您可以嘗試使用來自其他設備的通行金鑰。",
                "Add a passkey": "添加通行金鑰",

                "Passkeys are a password replacement that validates your identity using touch, facial recognition, a device password, or a PIN.": "通行金鑰是一種密碼替代品，可通過觸摸、臉部識別、設備密碼或 PIN 驗證您的身份。",
                    "This browser or device is reporting partial passkey support, but you may be able to use a passkey from a nearby device.": "此瀏覽器或設備報告支持部分通行金鑰，但您也許可以嘗試使用附近設備的通行金鑰。",
                "Your passkeys": "您的通行金鑰",
                "Seen from this browser": "該瀏覽器中查看",
                "| Last used": "| 最後使用",
                // | Last used less than 1 小時之前
                "Edit passkey nickname": "編輯通行金鑰暱稱",
                ...
                // 刪除金鑰對話框
                    ...
                    "Note: You may continue to see this passkey as an option during sign-in until you also delete it from your browser, device or associated account's password management settings.": "注意：您可能會在登錄過程中繼續看到此通行金鑰作為一個選項，直到您將其從瀏覽器、設備或關聯帳戶的密碼管理設定中刪除。",
                    "Deleting…": "刪除中…",
            ...
            // 雙重身份驗證
                // 頂部提醒
                    ...
                    "SMS/Text message successfully configured.": "簡訊/文本資訊配置成功。",
            ...
            "Preferred 2FA method": "首選 2FA 方法",
                "Set your preferred method to use for two-factor authentication when signing into GitHub.": "設定登錄 GitHub 時用於雙重身份驗證的首選方法。",
            ...
            "Two-factor methods": "雙重身份驗證方式",
                ...
                "SMS/Text message": "簡訊/文字資訊",
                    ...
                    "Get one-time codes sent to your phone via SMS to complete authentication requests.": "通過簡訊向您的手機發送一次性代碼，以完成認證請求。",

                    "Get authentication codes by SMS on your mobile phone when signing into GitHub. Make sure that": "登錄 GitHub 時通過手機簡訊獲取驗證碼。確保",
                    ...
                    // [/You will receive one-time codes at this phone number:/, "您將通過以下電話號碼收到一次性驗證碼："], // 已設定簡訊/文字資訊

                "Security keys": "安全金鑰",
                    "Security keys are hardware devices that can be used as your second factor of authentication.": "安全金鑰是一種硬體設備，可以作為您的第二個驗證步驟。",
                    "Hide": "隱藏",
                ...
                "GitHub Mobile": "GitHub Mobile",
                    "GitHub Mobile can be used for two-factor authentication by installing the GitHub Mobile app and signing in to your account.": "通過安裝 GitHub Mobile 應用並登入帳戶，可以使用 GitHub Mobile 來進行雙重身份驗證。",
                    "Manage GitHub Mobile": "管理 GitHub Mobile",

                    // [/(\d+) devices?/, "$1 設備"], // 設定--> 密碼和身份驗證頁
                    "Show": "顯示",
            ...
            // 授權訪問 sudo 模式身份驗證
                ...
                "This browser or device does not fully support passkeys.": "此瀏覽器或設備不完全支持通行金鑰。",
                "Use passkey": "使用通行金鑰",
    ...
    "static": { // 靜態翻譯
        ...
        // 查看恢復碼 https://github.com/settings/auth/recovery-codes
            ...
            "Recovery codes": "恢復碼",
                ...
                "These codes are the last resort for accessing your account in case you lose your password and second factors. If you cannot find these codes, you": "這些恢復碼是在您遺失密碼和第二要素的情況下訪問您帳戶的最後手段。如果您找不到這些恢復碼，您",
                "will": "將",
            ...
            "Generate new recovery codes": "生成新恢復碼",
                "When you generate new recovery codes, you must download or print the new codes.": "當您生成新恢復碼時，您必須下載或列印新恢復碼。",
...
I18N.zh["settings/sessions"] = {
    "static": { // 靜態翻譯
        ...
        // 會話詳情 https://github.com/settings/sessions
            ...
            "This is a list of devices that have logged into your account. Revoke any sessions that you do not recognize.": "這是已登入您帳戶的設備列表。 撤銷任何您不認識的會話。",
            "See more": "查看更多",
            "Your current session": "您當前的會話",
            "Last accessed on": "最後訪問日期：",

            "GitHub Mobile sessions": "GitHub Mobile 會話",
            "This is a list of devices that have logged into your account via the GitHub Mobile app. Revoke any session that you do not recognize or you can": "這是已通過 GitHub Mobile 應用登入到您帳戶的設備列表。撤銷任何您不認識的會話，或者您可以",
            "revoke": "撤消",
...
I18N.zh["settings/keys"] = { // 設定 - SSH 與 GPG 公鑰
    "static": { // 靜態翻譯
        ...
        // SSH and GPG keys SSH 與 GPG 公鑰 https://github.com/settings/keys
            ...
            "connecting to GitHub using SSH keys": "使用 SSH 金鑰連接到 GitHub",
            "or troubleshoot": "或解決",
...
I18N.zh["settings/organizations"] = { // 設定 - 組織
    "static": { // 靜態翻譯
        ...
        // Organizations 組織 https://github.com/settings/organizations
            ...
            "Any user-specific information (OAuth tokens, SSH keys, Job Profile, etc) will be erased": "任何用戶特定的資訊（OAuth 令牌, SSH 金鑰, 職位簡介, 等）將被刪除。",
...
I18N.zh["settings/blocked_users"] = { // 設定 - 黑名單
    "static": { // 靜態翻譯
        ...
        // Blocked users 黑名單 https://github.com/settings/blocked_users
            "Block a user": "封鎖用戶",
            "Blocking a user prevents the following on all your repositories:": "封鎖用戶可以防止所有倉庫中的以下操作：",
            ...
            "Additionally, blocked users are not able to:": "此外，被封鎖用戶無法：",
            ...
            "Search by username, full name or email address": "搜索使用者名稱、全名、或電子信箱",
                "Learn more about blocking a user": "了解更多關於封鎖用戶的資訊",
            "Block user": "封鎖用戶",
            "You have not blocked any users.": "您還沒有封鎖任何用戶。",
            "Unblock": "取消封鎖",
            "Warn me when a blocked user is a prior contributor to a repository": "請警告我，當被封鎖的用戶是倉庫的先前貢獻者時",
            "On repositories you haven’t contributed to yet, we’ll warn you when a user you’ve blocked has previously made contributions.": "在您還沒有貢獻的倉庫裡，當您封鎖的用戶之前有貢獻時，我們會警告您。",
...
I18N.zh["settings/interaction_limits"] = { // 設定 - 互動限制
    "static": { // 靜態翻譯
        ...
        // Interaction limits 互動限制 https://github.com/settings/interaction_limits
            ...
            ". Any changes here will override those limits.": " 的設定中。此處的全局設定將覆蓋那些倉庫的局部設定。",
            ...
            "Limit to prior contributors": "僅限於先前的貢獻者",
                "Users that have not previously committed to the default branch of one of your repositories will be unable to interact with that repository.": "以前從未提交到您某個倉庫預設分支的用戶將無法與該倉庫互動。",
            ...
            "6 months": "6 個月",
            // 頂部提醒
            "User interaction limit settings saved.": "用戶交互限制設定已保存。",
...
I18N.zh["settings/code_review_limits"] = { // 設定 - 代碼審查限制
    "static": { // 靜態翻譯
        ...I18N.zh["settings-menu"]["static"],

        // Code review limits 代碼審查限制 https://github.com/settings/code_review_limits
            ...
            "Code review limits may already be specified by individual repositories. Any changes here will override those limits until unset.": "代碼審查限制可能已經由各個倉庫指定。此處的任何更改都將覆蓋這些限制，直至取消設定。",
            "Code review limits are currently managed individually for all repositories. Enable limits to permit only users who have explicitly been granted access to each repository to submit reviews that \"approve\" or \"request changes\". Remove limits to allow all users to submit pull request reviews. All users able to submit comment pull request reviews will continue to be able to do so.": "目前，所有倉庫代碼審查限制都是單獨管理的。啟用限制，只允許明確授予每個倉庫訪問權的用戶提交 “批准” 或 “請求更改” 的審查。刪除限制，允許所有用戶提交拉取請求審查。所有能夠提交評論拉取請求審查的用戶將繼續能夠這樣做。",
...
I18N.zh["settings/repositories"] = { // 設定 - 倉庫
    "static": { // 靜態翻譯
        ...
        // Repository 倉庫 https://github.com/settings/repositories
            ...
            "Choose the default branch for your new personal repositories. You might want to change the default name due to different workflows, or because your integrations still require “master” as the default branch name. You can always change the default branch name on individual repositories.": "為您新的個人倉庫選擇預設的分支。由於工作流程的不同，或者由於您的集成仍然需要 “master” 作為預設分支名，您可能想改變默認名稱。您可以隨時改變個人倉庫的預設分支名稱。",
...
I18N.zh["settings/deleted_repositories"] = { // 設定 - 倉庫 - 刪除的倉庫
    "static": { // 靜態翻譯
        ...
        // 刪除的倉庫 https://github.com/settings/deleted_repositories
            ...
            "Learn more about restoring deleted repositories": "了解更多關於恢復已刪除倉庫的資訊",

            "These repositories were deleted, but can't be restored by you. Contact support if you want to restore them.": "這些倉庫已被刪除，但您無法恢復。如果您想恢復它們，請聯絡 GitHub 支持人員。",
            ...
            "Any team or collaborator permissions that previously existed for this repository will not be restored. If you require specific team or collaborator permissions, you will need to configure them in settings.": "此倉庫以前存在的任何團隊或協作者的權限將不會被恢復。如果您需要特定的團隊或協作者權限，則需要在設定中配置。",
...
I18N.zh["settings/codespaces"] = { // 設定 - 代碼空間
    "static": { // 靜態翻譯
        ...I18N.zh["settings-menu"]["static"],
        ...
        // 代碼空間 https://github.com/settings/codespaces
            ...
            "Learn how to set up your dotfiles for Codespaces.": "了解如何為代碼空間設定點文件。",
            ...
            "encrypted": "被加密的環境變數",
            ". They are available to any codespace you create using repositories with access to that secret.": "。它們可用於您使用訪問該機密的倉庫創建的任何代碼空間。",
            "There are no Codespaces secrets.": "尚無代碼空間機密",
            ...
            "GPG verification": "GPG 驗證",
                "Codespaces can have GPG commit signing capabilities so that GitHub can verify that commits made in the codespace come from a trusted source. When enabled, this setting will be applied to your list of trusted repositories.": "代碼空間可以具有 GPG 提交簽名功能，以便 GitHub 可以驗證代碼空間中的提交是來自受信任的來源。啟用後，該設定將被應用到您的受信任倉庫列表中。",
                // "Enabled": "啟用",
                    "GPG signing will be available in Codespaces": "GPG 簽名將在代碼空間中可用",

            "Settings Sync": "設定同步",
                "By enabling, your codespaces will be able to pull from VS Code Settings Sync service and push only for the trusted repositories you specify. Only enable this for repositories that you trust.": "透過啟用，您的代碼空間將能夠從 VS Code 設定同步服務中提取數據，並僅推送您指定的受信任倉庫。請只對您信任的倉庫啟用此功能。",
                // "Enabled": "啟用",
                    "VS Code Settings Sync will be available in Codespaces": "VS Code 設定同步將在代碼空間中可用",
            ...
            "Trusted repositories": "受信任倉庫",
                ...
                "All repositories": "所有倉庫",
                    "GPG signing and VS Code Settings Sync will be available for codespaces for all repositories": "GPG 簽名和 VS Code 設定同步將適用於所有倉庫的代碼空間",
                "Selected repositories": "選定的倉庫",
                    "GPG signing and VS Code Settings Sync will be available for codespaces from the selected repositories": "GPG 簽名和 VS Code 設定同步將適用於選定倉庫的代碼空間",
                    "Select repositories": "選擇倉庫",
                    // [/Selected (\d+) repositor(y|ies)./, "選定 #1 個倉庫"],
                    "GPG and VS Code Settings Sync will be available for Codespaces from these repositories.": "GPG 和 VS Code 設定同步將可用於這些倉庫的代碼空間。",

            "Access and security": "訪問和安全",
            "Deprecated": "棄用",
            "Codespaces you create for your personal account can either be restricted to accessing the repository it was opened for, or granted read access to other repositories you own.": "您為您個人帳戶創建的代碼空間可以限制訪問已啟用的倉庫或您其他被賦予讀取權限的倉庫",
            "Disabled": "禁用",
            "Limit access of personal Codespaces to the repository they were opened for": "限制個人代碼空間只能訪問對其打開的倉庫",
            ...
            "Editor preference": "編輯器偏好",
                // VS code
                    "Connect to the cloud from your local desktop client. Requires": "從本地桌面用戶端連接到雲。要求",
                    "with the": "安裝",
                    "GitHub Codespaces": "GitHub 代碼空間",
                    "extension.": "插件。",
                ...
                // "JetBrains Gateway": "",
                    "Connect to the cloud from your local desktop client. Requires the": "從本地桌面用戶端連接到雲。要求",
            ...
            "Region": "地區",
                "Your default region will be used to designate compute resources to your codespaces. GitHub can set your region automatically based on your location, or you can set it yourself. Codespaces are deployed to a subset of Azure regions.": "您的默認區域將被用來為您的代碼空間指定計算資源。 GitHub 可以根據您的位置自動設定您的區域，您也可以自己設定。代碼空間部署到 Azure 區域的子集。",
                "Set automatically": "自動設定",
                "We will determine the closest available region based on your location (IP address) at codespace creation time.": "我們將在創建代碼空間時根據您的位置（IP位址）確定最近的可用區域。",
                "Set manually": "手動設定",
...
I18N.zh["settings/packages"] = { // 設定 - 套裝軟體
    "static": { // 靜態翻譯
        ...
        // Packages 套裝軟體 https://github.com/settings/packages
            ...
            "Default Package Setting": "默認套裝軟體設定",
            "Default package settings": "默認套裝軟體設定", // 組織
            ...
            "These are packages that have been previously deleted belonging to this organization. You can restore a package deleted within the last 30 days.": "這些是先前已刪除的屬於您組織的套裝軟體。您可以恢復在過去 30 天內刪除的包。", // 組織設定
            "Search deleted packages": "搜索已刪除的套裝軟體",
...
I18N.zh["settings/pages"] = { // 設定 - GitHub Pages
    "static": { // 靜態翻譯
        ...I18N.zh["settings-menu"]["static"],
        ...I18N.zh["orgs-settings-menu"]["static"], // 組織設定菜單
...
I18N.zh["settings/replies"] = { // 設定 - 快捷回復
    "static": { // 靜態翻譯
        ...
        // Saved replies 快捷回復 https://github.com/settings/replies
            "Saved replies are re-usable text snippets that you can use throughout GitHub comment fields. Saved replies can save you time if you’re often typing similar responses.": "快捷回復是可重複使用的文本片段，您可以在整個 GitHub 評論區使用。如果您經常輸入類似的回覆，快捷回復可以節省您的時間。",
            ...
            "Your saved reply was created successfully.": "您的快捷回復已成功創建。",
...
I18N.zh["settings/security_analysis"] = { // 設定 - 代碼安全性與分析
    "static": { // 靜態翻譯
        ...I18N.zh["settings-menu"]["static"],

        // 代碼安全性與分析 https://github.com/settings/security_analysis
            "Security and analysis features help keep your repositories secure and updated. By enabling these features, you're granting us permission to perform read-only analysis on your repositories.": "安全和分析功能有助於確保您的倉庫安全和更新。透過啟用這些功能，您授予我們對您的倉庫執行只讀分析的權限。",
            ...
            "Secret scanning": "機密掃描",
                "Receive alerts on GitHub for detected secrets, keys, or other tokens.": "在 GitHub 上接收有關檢測到的機密、金鑰或其他令牌的警報。",
...
I18N.zh["settings/installations"] = { // 設定 - 應用/安裝的 GitHub 應用
    "static": { // 靜態翻譯
        ...
        // 安裝的 GitHub 應用設定 https://github.com/settings/installations/<id>
            // 頂部提醒
        ...
        // 授權的 OAuth 應用 https://github.com/settings/applications
            ...
            "Any SSH keys created on your behalf by applications will also be deleted.": "任何由應用代表您創建的 SSH 金鑰也將被刪除。",
        ...
        // 授權的 GitHub 應用授權設定 https://github.com/settings/connections/applications/<client-id>
        // 授權的 OAuth 應用授權設定 https://github.com/settings/connections/applications/<id>
            "Never used": "從未使用",
            ...
            "Read about third-party access.": "了解關於第三方訪問的資訊。",
        ...
        // 組織 OAuth 應用策略設定 /orgs/<orgs-name>/policies/applications/<id>
            ...
            "Read about organization OAuth app access restrictions.": "了解有關組織 OAuth 應用訪問限制的資訊。",
...
I18N.zh["settings/reminders"] = { // 設定 - 定時提醒
    "static": { // 靜態翻譯
        ...
        // 定時提醒 https://github.com/settings/reminders
            ...
            "To use scheduled reminders, make sure that the Slack or Microsoft Teams integration is installed and up-to-date. If you need help with this, please contact your organization's owner.": "要使用定時提醒，請確保已安裝 Slack 或 Microsoft Teams 集成並且是最新版本，如果您需要這方面的幫助，請聯絡您組織的所有者。",
    ...
    "static": { // 靜態翻譯
        ...
        // 註冊 GitHub 應用 https://github.com/settings/apps/new
            ...
            "Identifying and authorizing users": "識別並授權用戶",
                ...
                "Request user authorization (OAuth) during installation": "在安裝期間請求用戶授權 (OAuth)",
                    ...
                    "Identifying and authorizing users for GitHub Apps documentation": "關於 GitHub 應用識別並授權用戶的文件",
                "Enable Device Flow": "啟用設備流",
                    "Allow this GitHub App to authorize users via the Device Flow.": "允許此 GitHub 應用透過設備流程授權用戶。",
                    "Read the": "閱讀",
                    "Device Flow documentation": "設備流程文件",

            "Post installation": "安裝完成後",
                "Setup URL (optional)": "設定網址 (可選)",
                    "Users will be redirected to this URL after installing your GitHub App to complete additional setup.": "用戶在安裝完 GitHub 應用後，會被重定向到這個網址，以完成額外的設定。",
                    "Unavailable when requesting OAuth during installation.": "安裝過程中請求 OAuth 時不可用。",
                    "Users will be redirected to the 'User authorization callback URL' to complete additional setup.": "用戶將被重定向到 “用戶授權回調網址” 以完成其他設定。",
                "Redirect on update": "更新時重定向",
                    "Redirect users to the 'Setup URL' after installations are updated (E.g. repositories added/removed).": "在安裝後更新時將用戶重定向到 “設定網址”（例如: 添加/刪除倉庫）。",
            ...
            "Permissions": "權限",
                ...
                "for information about specific permissions.": "以了解關於特定權限的資訊。",
                ...
                "Repository permissions": "倉庫權限",
                    ...
                    "Administration": "管理",
                        "Repository creation, deletion, settings, teams, and collaborators.": "倉庫創建、刪除、設定、團隊和協作者。",
                    "Checks": "檢查",
                        "Checks on code.": "檢查代碼。",
                    "Code scanning alerts": "代碼掃描警報",
                    ...
                    "Codespaces lifecycle admin": "代碼空間的生命週期管理",
                        "Manage the lifecycle of Codespaces, including starting and stopping.": "管理代碼空間的生命週期，包括啟動和停止。",
                    "Codespaces metadata": "代碼空間元數據",
                        "Access Codespaces metadata including the devcontainers and machine type.": "訪問代碼空間元數據，包括開發容器和機器類型。",
                    "Codespaces secrets": "代碼空間機密",
                        "Restrict Codespaces user secrets modifications to specific repositories.": "限制代碼空間的用戶機密對特定倉庫的修改。",
                ...
                "Organization permissions": "組織權限",
                    ...
                    "Blocking users": "封鎖用戶",
                        "View and manage users blocked by the organization.": "查看和管理被組織封鎖的用戶。",
                    "Custom organization roles": "自訂組織角色",
                        "Create, edit, delete and list custom organization roles. View system organization roles.": "創建、編輯、刪除和列出自訂組織角色。查看系統組織角色。",
                    "Custom properties": "自訂屬性",
                    ...
                    "Custom repository roles": "自訂倉庫角色",
                        "Create, edit, delete and list custom repository roles.": "創建、編輯、刪除和列出自訂倉庫角色。",
                    "Events": "活動",
                    ...
                    "Organization codespaces settings": "組織代碼空間設定",
                        "Manage Codespaces settings for an organization.": "管理組織的代碼空間設定。",
                ...
                "Account permissions": "帳戶權限",
                    ...
                    "Block another user": "封鎖其他用戶",
                        "View and manage users blocked by the user.": "查看和管理被用戶封鎖的用戶。",
                    "Codespaces user secrets": "代碼空間用戶機密",
                        "Manage Codespaces user secrets.": "管理代碼空間用戶機密。",
                    "Email addresses": "電子信箱地址",
                        "Manage a user's email addresses.": "管理用戶的電子信箱地址。",
                    // 關注者
                        "A user's followers": "用戶的關注者",
                    "GPG keys": "GPG 金鑰",
                        "View and manage a user's GPG keys.": "查看和管理用戶的 GPG 金鑰。",
                    // Gist
                    ...
                    "Profile": "個人資訊",
                        "Manage a user's profile settings.": "管理用戶的個人資訊設定。",
                    "SSH signing keys": "SSH 簽名金鑰",
                        "View and manage a user's SSH signing keys.": "查看和管理用戶的 SSH 簽名金鑰。",
                    "Starring": "星標",
            ...
            "Subscribe to events": "訂閱事件",
                ...
                "Custom property": "自訂屬性",
                    "Custom property is created, updated, or deleted.": "自訂屬性的創建、更新或刪除。",
                ...
                "Deploy key": "部署金鑰",
                    "A deploy key is created or deleted from a repository.": "在倉庫中部署金鑰的創建或刪除。",
                "Deployment": "部署",
                ...
                "Pull request": "拉取請求",
                    "Pull request assigned, auto merge disabled, auto merge enabled, closed, converted to draft, demilestoned, dequeued, edited, enqueued, labeled, locked, milestoned, opened, ready for review, reopened, review request removed, review requested, synchronized, unassigned, unlabeled, or unlocked.": "拉取請求的分配、禁用自動合併、啟用自動合併、關閉、轉換為草稿、取消里程碑、取消隊列、編輯、隊列、標記、鎖定、設定里程碑、打開、準備審查、重新打開、取消審查請求、請求審查、同步、取消分配、取消標記或解鎖。",
        ...
        // 某個 GitHub 應用 https://github.com/settings/apps/<app-name>
            // 頂部提醒
                ...
                "The GitHub App is now private. It can only be installed on this account.": "GitHub 應用已私有化。只能安裝在此帳戶上。",
            ...
            // 關於
                ...
                "integration developer documentation": "集成開發者文件",
                ...
                "Revoke all user tokens?": "撤銷所有用戶令牌？",
                    ...
                    "All SSH keys created by this application will also be deleted.": "此應用創建的所有 SSH 金鑰也將被刪除。",
            ...
            "Display information": "顯示資訊",
                ...
                "The hex value of the badge background color. Hex colors should only contain numbers and letters from a-f.": "徽章背景顏色的十六進位制值。十六進位制顏色只能包含 a-f 之間的數字和字母。",
                // 剪裁對話框
                    "Crop your new avatar": "裁剪您的新頭像",
                    "Set new avatar": "設定新頭像",
                // 頂部提醒
            ...
            // 市場
                ...
                "Edit how your GitHub App is presented in the Marketplace directory, including screenshots and links.": "編輯 GitHub 應用在市場索引中的展示方式，包括截圖和連結。",
                "Edit Marketplace listing": "編輯市場上架資訊",
        ...
        // 某個 GitHub 應用 - 安裝 https://github.com/settings/apps/<app-name>/installations
            ...
            "Install": "安裝",
            // [/Install (.*) on this account./, "安裝 $1 到此帳戶上。"],
            "Installed": "已安裝",
        ...
        // 某個 GitHub 應用 - 高級 https://github.com/settings/apps/<app-name>/advanced
            "Danger zone": "危險區",
                ...
                "Make this GitHub App private": "私有化 GitHub 應用",
                    "Private GitHub Apps cannot be installed on other accounts.": "私有 GitHub 應用不能安裝在其他帳戶上。",
                    "Make private": "轉為私有",
                ...
                "Make this application private": "私有化應用",
                    "Private applications cannot be installed on other accounts.": "私有應用不能安裝在其他帳戶上。",
        ...
        // 某個 GitHub 應用 - 可選功能 https://github.com/settings/apps/<app-name>/beta
            ...
            "User-to-server token expiration": "用戶到伺服器訪問令牌過期",
                "User-to-server access tokens will expire after 8 hours. A Refresh Token will be provided which can be exchanged for a new access token.": "用戶到伺服器訪問令牌將在 8 小時後過期。我們將提供一個刷新令牌，用戶可以用它換取新的訪問令牌。",
                "Opt-out": "選擇退出",
                "Opt-in": "選擇加入",
                    "Disable user-to-server token expiration for this app.": "禁用此應用的用戶到伺服器訪問令牌過期。",
...
I18N.zh["settings/applications/new"] = { // 設定 - 開發者設定/OAuth 應用
    "static": { // 靜態翻譯
        ...
        // 註冊 OAuth 應用 https://github.com/settings/applications/new
            ...
            "Allow this OAuth App to authorize users via the Device Flow.": "允許此 OAuth 應用透過設備流程授權用戶。",
            "Read the": "閱讀",
            "Device Flow documentation": "設備流程文件",
...
I18N.zh["settings/tokens"] = { // 設定 - 開發者設定/個人訪問令牌
    "static": { // 靜態翻譯
        ...
        // 開發者設定/個人訪問令牌（經典） https://github.com/settings/tokens
            ...
            "Any SSH keys created on your behalf by personal access tokens will also be deleted.": "任何由個人訪問令牌代表您創建的 SSH 金鑰也將被刪除",
            "Type your username to confirm": "輸入您的使用者名稱進行確認",
            "I understand, revoke access for everything": "我明白了，依然撤銷對一切的訪問",
        ...
        // 創建精細化個人訪問令牌 https://github.com/settings/personal-access-tokens/new
            ...
            "Permissions": "權限",
                "Read our": "閱讀我們的",
                "permissions documentation": "權限文件",
                "for information about specific permissions.": "以了解關於具體權限的資訊。",
        ...
        // 創建新個人訪問令牌 https://github.com/settings/tokens/new
            ...
            "Access user email addresses (read-only)": "訪問用戶電子信箱地址（只讀）",
            ...
            "Full control of codespaces": "完全控制代碼空間",
            ...
            "Full control of public user GPG keys": "完全控制公共用戶 GPG 金鑰",
            "(Developer Preview)": "（開發者預覽版）",
            "Write public user GPG keys": "寫入公共用戶 GPG 金鑰",
            "Read public user GPG keys": "讀取公共用戶 GPG 金鑰",
            "Full control of public user SSH signing keys": "完全控制公共用戶 SSH 簽名金鑰",
            "Write public user SSH signing keys": "寫入公共用戶 SSH 簽名金鑰",
            "Read public user SSH signing keys": "讀取公共用戶 SSH 簽名金鑰",
            "Generate token": "生成令牌",
                // 頂部提醒
...
I18N.zh["repository-public"] = { // 倉庫 - 公共部分
    "static": { // 靜態翻譯
        // 倉庫頁面 /<user-name>/<repo-name>/
            ...
            "Access to this repository has been disabled by GitHub Staff due to a violation of GitHub's terms of service. If you are the owner of the repository, you may reach out to GitHub Support for more information.": "由於違反了 GitHub 的服務條款，GitHub 已禁止訪問此倉庫。如果您是倉庫的所有者，您可以聯繫 GitHub 支持以獲取更多資訊。",
        ...
        // 頁面載入異常(倉庫)
            "Error loading page": "載入頁面出錯",
            "It looks like your internet connection is down. Please check it.": "您的網路連接似乎出現故障。請檢查一下。",
        ...
        // 邀請繼任者提醒
            ...
            "Inviting a successor helps ensure the continuity of your work in case you are unable to access your account.": "邀請繼任者有助於在您無法訪問帳戶時確保工作的連續性。",
            "Invite a successor": "邀請繼任者",

        // 倉庫贊助
            "Couldn't load subscription status.": "無法載入贊助狀態。",
            "Retry": "重試",
    ...
    "regexp": [ // 正則翻譯
        [/Started (\d+) discussions? in this repository in the past week/, "過去一週內在此倉庫中開啟了 $1 個討論"], // 用戶 浮動資訊卡
        [/Started (\d+) discussions? in this repository in the past month/, "過去一個月內在此倉庫中開啟了 $1 個討論"], // 用戶 浮動資訊卡
        ...
        [/This repository has been archived by the owner (on .+). It is now read-only./, "此倉庫已由所有者於 $1 存檔。它現在是只讀的。"],
    ],
};
    ...
    "static": { // 靜態翻譯
        ...
        // 新建倉庫 https://github.com/new
            ...
            "Choose a license": "選擇許可證",
                "A license tells others what they can and can't do with your code.": "許可證告訴其他人，他們可以使用您的代碼做什麼和不能做什麼。",
                "Learn more about licenses.": "了解更多關於許可證的資訊。",
        ...
        // 導入倉庫 第一頁 https://github.com/new/import
            "Import your project to GitHub": "將您的項目導入到 GitHub",
                ...
                "Support for importing Mercurial, Subversion and Team Foundation Version Control (TFVC) repositories ended on April 12, 2024. For more details, see the": "對導入 Mercurial、Subversion 和 Team Foundation 版本控制 (TFVC) 倉庫的支持已結束於 2024 年 4 月 12 日。有關詳細資訊，請參閱",
                "changelog": "更新日誌",
            ...
            "Please enter your credentials if required for cloning your remote repository.": "如果需要複製遠程倉庫，請輸入您的憑據。",
            "Your username for your source repository": "源倉庫使用者名稱",
        ...
        // 復刻倉庫 /<user-name>/<repo-name>/fork
            ...
            "By default, forks are named the same as their upstream repository. You can customize the name to distinguish it further.": "默認情況下，復刻的名稱與他們的上游倉庫相同。您可以自訂名稱以進一步區分它。",
            "(optional)": "（可選）",
...
I18N.zh["repository"] = { // 倉庫頁面 /<user-name>/<repo-name>/
    "static": { // 靜態翻譯
        ...
        // 代碼標籤卡 & 倉庫首頁 /<user-name>/<repo-name>/ 和 /<user-name>/<repo-name>/tree/<branch>
            ...
            // 預設分支被重命名提醒框
                ...
                "If you have a local clone, you can update it by running the following commands.": "如果您有一個本地複製，您可以透過運行以下命令來更新它。",
                "OK, got it": "好的，我知道了！",
            ...
            // 代碼 下拉菜單
                "Local": "本地",
                    "Clone": "複製",
                        // HTTPS
                        "Clone using the web URL.": "使用 Web URL 複製。",
                        // SSH
                        "You don't have any public SSH keys in your GitHub account.": "您的 GitHub 帳戶中沒有任何公共 SSH 金鑰。",
                        "You can": "您可以",
                    ...
                    "Copy url to clipboard": "複製連結到剪貼板",
                    // "Copy to clipboard": "複製到剪切板",
                    // "Copied!": "✅ 複製成功!",
                ...
                // 代碼空間
                    ...
                    "Learn more about codespaces...": "了解更多關於代碼空間的資訊...",
        ...
        // 初始化空倉庫 /<user-name>/<repo-name>/
            ...
            "Add collaborators to this repository": "將合作者添加到此倉庫",
                "Search for people using their GitHub username or email address.": "使用 GitHub 使用者名稱或電子郵件地址搜索人員。",
        ...
        // 檔案管理器 /<user-name>/<repo-name>/tree/<branch>/<文件夾路徑>/
        ...
        // 檔案管理器 - 議題模板 /<user-name>/<repo-name>/tree/<branch>/.github/ISSUE_TEMPLATE
            "Customize the issue creation experience with a": "自訂議題的創建模板使用一個",
            "file.": "文件。",
    ...
    "regexp": [ // 正則翻譯
        ...
        [/Your ([^ ]+) branch isn't protected/, "您的 $1 分支不受保護"], // 倉庫首頁 分支保護
        [/([\d,]+) Commits?/, "$1 次提交"], // 新版倉庫概述
        [/Create a codespace on (.+)/, "在 $1 上創建代碼空間"], // 倉庫首頁 創建代碼空間
        [/Create codespace on (.+)/, "在 $1 上創建代碼空間"],
        [/Codespace \"(.+)\" stopped./, "代碼空間 “$1” 已停止。"],
        [/Codespace \"(.+)\" deleted./, "代碼空間 “$1” 已刪除。"],
        [/Are you sure you want to delete (.+)\?/, "您確定要刪除 $1 嗎？"],
...
I18N.zh["repository/pull_issue_public"] = { // 倉庫 - 議題和拉取請求頁面公共部分
    ...
    "regexp": [ // 正則翻譯
        [/At least (\d+) approving review is required by reviewers with write access./, "至少需要 $1 個審查者批准。"],
            ...
            // 右側欄 補充
                // "Development": "進展",
                    ...
                    // 在本地倉庫檢出對話框
                        ...
                        "Run the following commands in your local clone.": "在您的本地複製中運行以下指令。",
...
I18N.zh["repository/pull"] = { // 倉庫 - 拉取請求頁面
    "static": { // 靜態翻譯
        ...
        // 某條具體的拉取請求 /<user-name>/<repo-name>/pull/<id> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                ...
                // 代碼空間
                    ...
                    "Active": "啟用",
                        ...
                        "Change machine type": "更改機器類型",
                            ...
                            "Update codespace": "升級代碼空間",
                        "Stop codespace": "停止代碼空間",
                    "Codespace configuration": "代碼空間設定",
                    "No changes": "未更改",
            ...
            // 右側欄 補充
                ...
                "Allow edits by maintainers": "允許維護者進行編輯",
                    ...
                    "branch.": "分支上添加新的提交。",
                    "You can always change this setting later.": "您可以隨時修改此設定。",
                ...
                "into this branch.": "的最新更改合併到此分支中。",
                    "Update branch": "更新分支",
                        "Update with merge commit": "使用合併提交更新",
                            "The latest changes will be merged into this branch with a merge commit.": "最新的更改將通過合併提交合並到此分支中。",
            ...
            "Continuous integration has not been set up": "尚未設定持續集成",
            ...
            "This branch has conflicts that must be resolved": "該分支存在衝突，必須解決",
                ...
                "If the conflicts on this branch are too complex to resolve in the web editor, you can check it out via command line to resolve the conflicts.": "如果該分支上的衝突過於複雜，無法在 Web 編輯器中解決，您可以透過命令行檢出來解決衝突。",
                "Step 1:": "第 1 步：",
        ...
        // 拉取請求--> 提交 --> 某提交詳情/<user-name>/<repo-name>/pull/<id>/commits/<full SHA>
            ...
            "This merge commit was added into this branch cleanly.": "該合併提交被乾淨俐落地添加到該分支中。",
        ...
        // 拉取請求 --> 更改的文件 標籤卡 /<user-name>/<repo-name>/pull/<id>/files
            ...
            "Some generated files are not rendered by default. Learn more about": "某些生成的文件默認不呈現。了解更多資訊關於",
            "how customized files appear on GitHub": "更改文件在 GitHub 中的顯示方式",
            "File renamed without changes.": "文件僅重命名，內容沒有更改。",

            "These merge commits were added into this branch cleanly.": "這些合併提交已被乾淨俐落地添加到該分支中。",
            ...
            // 建議更改
                ...
                "Add suggestion to batch": "批次添加建議",
                    "Add this suggestion to a batch that can be applied as a single commit.": "將此建議添加到可批次處理的單個提交中。",
                    "Batching suggestions must be done from the files tab.": "批處理建議必須在 “文件” 選項卡中進行。",

                "Pending in batch": "待批次處理",
                "Remove from batch": "從批次處理中移除",
                    "Remove this suggestion from those to be applied in batch": "從批次應用的建議中刪除此建議",
                "Sign off and commit suggestions": "簽署並提交建議",
                    "Apply all batched suggestions as a single commit": "將所有批次建議作為單個提交應用",
                ...
                "Multiple suggested changes can be batched together in a single commit. Each suggestion author will be attributed in the commit as a co-author.": "多個建議更改可以在一次提交中批次處理。每個建議作者都將在提交中被歸為共同作者。",
...
I18N.zh["repository/compare"] = { // 倉庫 - 比較並創建拉取請求
    "static": { // 靜態翻譯
        ...
        // 變更比較 頁面 /<user-name>/<repo-name>/compare
            ...
            "Learn more about diff comparisons here": "點擊此處了解更多關於差異比較的資訊",
        ...
        // 直接提交拉取請求 /<user-name>/<repo-name>/compare/<branch>...<branch-1>?quick_pull=1
            ...
            "Create a new pull request by comparing changes across two branches. If you need to, you can also": "透過比較兩個分支的更改來創建一個新的拉請求。如果需要，還可以",
        ...
        // 創建拉取請求 按鈕下拉
            ...
            "Doesn't request code owners review and cannot be merged": "不請求代碼所有者審核並且無法合併",
...
I18N.zh["repository/commit"] = { // 倉庫 - 提交頁面
    ...
    "regexp": [ // 正則翻譯
        ...
        [/This commit closes issue (#\d+)./, "此提交關閉了提議 $1。"], //具體提交頁面
        [/from ([^ ]+) to ([^ ]+)/, "從 $1 到 $2。"], //具體提交頁面
        [/([\d,]+) additions, ([\d,]+) deletions not shown because the diff is too large. Please use a local Git client to view these changes./, "$1 處增加，$2 處刪除未顯示，因為差異太大。請使用本地 Git 用戶端查看這些更改。"],
...
I18N.zh["repository/blob"] = { // 倉庫 - 瀏覽代碼
    "static": { // 靜態翻譯
        ...I18N.zh["repository-public"]["static"],
        ...
        // 文件代碼頁面 /<user-name>/<repo-name>/blob/<brach>/<file>
            ...
            // 快捷鍵
                "Source code browsing": "原始碼瀏覽",
                    ...
                    "Open raw file": "打開源文件",
                "File tree": "文件樹",
                    "Move focus to row starting with string": "將焦點移至字串",
            ...
            // 三個點
                "Raw file content": "原始文件內容",
                    "Download": "下載",
                    // "Jump to line": "跳轉到行",
                    "Find in file": "在文件中查找", // 啟用 “換行” 時顯示
                    "Copy path": "複製路徑",
                    "Copy permalink": "複製永久連結",
                    "View options": "查看選項",
                        "Show code folding buttons": "顯示代碼摺疊按鈕",
                        "Wrap lines": "換行",
                        "Center content": "核心內容",
            ...
            // 代碼操作欄
                ...
                // Copilot 廣告
                    "Code 55% faster with GitHub Copilot": "使用 GitHub Copilot 編碼速度提高 55%",
                        "Spend less time creating boilerplate and repetitive code patterns, and more time building great software. Try it in Codespaces or your favorite file editor.": "花更少的時間創建模板和重複的代碼模式，花更多的時間構建優秀的軟體。在 GitHub 代碼空間或您最喜歡的文件編輯器中嘗試一下哈。",
            ...
            // 提醒
                "This file contains bidirectional Unicode text that may be interpreted or compiled differently than what appears below. To review, open the file in an editor that reveals hidden Unicode characters.": "此文件包含雙向 Unicode 文本，其解釋或編譯方式可能與下面的顯示不同。要查看，請在一個能顯示隱藏的 Unicode 字元的編輯器中打開文件。",
    ...
    "static": { // 靜態翻譯
        ...
        // 某個討論頁面 /<user-name>/<repo-name>/discussions/<id>
            ...
            "Transfer this discussion": "轉移討論",
                // 轉移議題 對話框
                "Results are limited to top repositories, search to find more.": "結果僅限於置頂倉庫，請搜索以查找更多資訊。",
...
I18N.zh["repository/actions"] = { // 倉庫 - 操作頁面
    "static": { // 靜態翻譯
        ...
        // 復刻倉庫操作頁面提示
            ...
            "Because this repository contained workflow files when it was forked, we have disabled them from running on this fork. Make sure you understand the configured workflows and their expected usage before enabling Actions on this repository.": "因為這個倉庫在被分支時含有工作流檔案，我們已禁止在此分支上運行它們。在開啟此倉庫的操作之前，請務必理解配置的工作流程及其預期的使用方式。",
        ...
        // 新建操作 /<user-name>/<repo-name>/actions/new
            ...
            "Build, test, and deploy your code. Make code reviews, branch management, and issue triaging work the way you want. Select a workflow to get started.": "構建、測試和部署您的代碼。以您想要的方式進行程式碼審查、分支管理和議題分類。選擇一個工作流以開始使用。",
            "Skip this and": "跳過並",
            ...
            "Create custom workflows to control your project's life cycle processes.": "創建自訂工作流程以控制項目的生命週期過程。",
        ...
        // 操作 /<user-name>/<repo-name>/actions
            ...
            "GitHub Actions makes it easy to automate all your software workflows, now with world-class CI/CD. Build, test, and deploy your code right from GitHub.": "GitHub Actions 現在可以使用世界一流的 CI/CD 輕鬆自動化所有軟體工作流程。直接從 GitHub 構建、測試和部署您的代碼。",
            "Learn more about getting started with Actions.": "了解更多關於開始使用 Actions 的資訊。",
        ...
        // 快取 /<user-name>/<repo-name>/actions/caches
            ...
            "Sort by": "排序方式",
                ...
                "Smallest size": "最小尺寸",
            "No caches": "尚無快取",
            "Nothing has been cached by workflows running in this repository.": "在此倉庫中運行的工作流程尚未快取任何內容。",
            ...
            "No caches matched your search": "沒有與您的搜索相匹配的快取",
            // [/No caches matched your search branch:([^ ]+)/, "沒有與您搜索的分支: $1 相匹配的快取"],
        ...
        // /<user-name>/<repo-name>/actions/runs/<id>
            ...
            "Create status badge": "創建狀態徽章",
                "Copy status badge Markdown": "複製狀態徽章 Markdown 代碼",
        ...
        // 上傳文件頁面 /<user-name>/<repo-name>/upload/<branch>
            // 自有倉庫
                ...
                // 提交框 補充
                    ...
                    "Learn more about pull requests.": "了解更多關於拉取請求的資訊。", // 上傳頁面
...
I18N.zh["repository/find"] = { //  倉庫 - 查找文件頁面
    "static": { // 靜態翻譯
        ...
        // Find file 頁面 /<user-name>/<repo-name>/find/<branch>
            ...
            "file finder": "文件搜尋模式",
            ". Start typing to filter the file list. Use": "。輸入關鍵字查找您的文件。使用",
            "and": "和",
            "to navigate,": "選擇文件",
            "to view files,": "查看文件",
            "to exit.": "返回。",
    ...
    "static": { // 靜態翻譯
        ...
        // 分支頁面 branches  /<user-name>/<repo-name>/branches
            ...
            "New pull request": "發起拉取請求",
                ...
                // 重命名分支對話框
                "Rename default branch": "重命名預設分支", // 重命名預設分支 標題
...
I18N.zh["repository/releases"] = { // 倉庫 - 發行版頁面
    "static": { // 靜態翻譯
        ...
        // 某個發行版標籤 /<user-name>/<repo-name>/releases/tag/<tag>
            ...
            // 刪除標籤對話框
            "Delete tag?": "刪除標籤？",
            "This will delete the information for this tag and cannot be undone.": "將刪除該標籤的所有資訊，並且無法撤消。",
            ...
            // 編輯器按鈕(老版)
                ...
                "Add saved reply": "添加快捷回復",
                    "Select a reply": "選擇回復",
                        ...
                        "Create a new saved reply": "創建新快捷回復",
                "Attach files by dragging & dropping, selecting or pasting them.": "通過拖拽、選擇或黏貼來附加文件。",
...
I18N.zh["repository/packages"] = { // 倉庫 - 套裝軟體頁面
    "static": { // 靜態翻譯
        ...
        // /<user-name>/<repo-name>/packages
            ...
            "Package settings": "套裝軟體設定",
            "Repository source": "倉庫來源",
            "This is the repository where the package's source code is stored. This is defined in the repository's package.json file using the": "這是套裝軟體原始碼的倉庫。這是在倉庫中的 package.json 文件使用欄位",
            "field.": "定義的。",
            "A GitHub repository has been identified as the source for this package. This package will be displayed in this repositories package list.": "GitHub 倉庫已被確定為該套裝軟體的來源，該套裝軟體將顯示在此倉庫的套裝軟體列表中。",
            "You have referenced a non-GitHub source for this package that cannot be verified.": "您引用了一個無法驗證的非 GitHub 來源的套裝軟體。",
            "Manage Actions access": "操作訪問權限管理",
            "Add Repository": "添加倉庫",
            "Pick the repositories that can access this package using": "選擇可以訪問此套裝軟體的倉庫，用於",
            "Role:": "角色:",
            "Choose role": "選擇角色",
            "Change role": "更改角色",
            "Read": "只讀",
            ...
            "Pick the repositories that can access this package using GitHub Actions.": "選擇可以使用 GitHub Actions 訪問此套裝軟體的倉庫。",
            "Permissions added for selected repositories.": "為選定的倉庫添加了權限。",
            "Permissions updated for selected repositories.": "更新了選定倉庫的權限。",
            "Can upload and download this package. Can read and write package metadata.": "可以上傳和下載此套裝軟體，並且可以讀取和寫入元數據。",
            "Can download this package and read package metadata.": "可以下載此套裝軟體並讀取元數據。",
            "Can upload, download, and manage this package. Can read and write package metadata. Can delete and restore packages.": "可以上傳、下載和管理此套裝軟體，可以讀取和寫入元數據，可以刪除和恢復此套裝軟體。",
            "Can upload, download, and manage this package. Can read and write package metadata. Can grant package permissions.": "可以上傳、下載和管理此套裝軟體，可以讀取和寫入元數據，可以授予套裝軟體權限。",
            "Manage Codespaces access": "代碼空間訪問管理",
            "Codespaces repository access": "代碼空間倉庫訪問",
            "Pick the repositories that can read this package using GitHub Codespaces.": "選擇可以使用 GitHub 代碼空間 讀取此套裝軟體的倉庫。",
            "Pick the repositories that can read this package using": "選擇可以讀取此套裝軟體的倉庫，用於",
            "Inherited access": "繼承訪問",
            "Inherit access from source repository (recommended)": "從源倉庫繼承訪問權限 (推薦)",
            "Go to": "轉到",
            "to change access, or remove inherited access to manage it separately. Inherited access is recommended.": "的訪問設定以更改訪問權限，或刪除繼承的訪問權限以單獨管理它，建議使用繼承訪問權限。",
            "Danger Zone": "危險操作",
            "Change package visibility": "更改套裝軟體可見性",
            "This package is currently public.": "該套裝軟體當前是公開的",
            "This package is currently private.": "該套裝軟體當前是私有的",
            "Change visibility": "更改可見性",
            "Delete this package": "刪除套裝軟體",
            "Once you delete a package, there is no going back. Please be certain.": "您一旦刪除了套裝軟體，將再也無法恢復，請確認！",
            "Manage access": "訪問管理",
            "Invite teams or people": "邀請團隊或人員",

        // 倉庫連結對話框
            "Confirm you want to unlink this repository": "確認您要取消與此倉庫的連結",
            "Yes, unlink this repository": "是的，取消連結此倉庫",

        // 添加倉庫對話框
            "Select repository that can access this package using GitHub actions": "選擇可以使用 GitHub 操作訪問此套裝軟體的倉庫",
        ...
        // 代碼空間添加倉庫對話框
            "Select repository that can access this package using GitHub codespaces": "選擇可以使用 GitHub 代碼空間訪問此套裝軟體的倉庫",

        // 更改套裝軟體可見性對話框
            "Make this package visible to anyone.": "使這個套裝軟體對所有人都可見。",
            "Make this package visible privately, to organization members that have access.": "僅這個套裝軟體有權訪問的組織成員可見。",
            "Please type": "請輸入",
            "to confirm:": "進行確認：",
            "I understand the consequences, change package visibility.": "我明白後果，依然更改套裝軟體可見性",

        // 刪除套裝軟體對話框
            "Are you absolutely sure?": "您真的確定嗎？",
            "Once this package is deleted, it will no longer be accessible.": "一旦刪除了這個套裝軟體，您將無法再訪問它。",
            "This action will delete package": "此操作將刪除套裝軟體",
            ". Versions of this package will no longer be accessible, and it will not appear in searches or package listings.": "。此套裝軟體的版本將不再可訪問，並且不會出現在搜索結果或套裝軟體列表中。",
            "I understand the consequences, delete this package": "我明白後果，依然刪除這個套裝軟體",

        // 更改倉庫角色對話框
            "Select a new role": "選擇新角色",
            "Recommended for non-code contributors who want to view or discuss your package.": "推薦給想要查看或討論您的套裝軟體的非代碼貢獻者。",
            "Recommended for contributors who actively push to your package.": "推薦給積極推送代碼到您的套裝軟體的貢獻者。",

        // 更改成員角色對話框
            "Recommended for people who need full access to the package, including sensitive and destructive actions like managing security and package visibility.": "建議需要完全訪問套裝軟體的人員使用，包括管理安全性和套裝軟體可見性等敏感和破壞性操作。",
        ...
        // 邀請團隊或人員對話框
            ...
            "Search by username, full name, or email": "搜索使用者名稱、全名或電子郵件"
    },
    "regexp": [
        [/Are you sure you want to unlink (.*) from (.*)\?/, "您確定要取消 $1 與 $2 的連結嗎？"],
        ...
        [/(\d+) members?/, "$1 個成員"],
        [/(.*)'s access settings/, "$1 訪問設定"],
        [/Removed access from repository (.*)\./, "刪除了倉庫 $1 的訪問權限。"],
        [/Removed (.*) as a package collaborator\./, "刪除了 $1 作為套裝軟體的協作者。"],
...
I18N.zh["repository/pkgs"] = { // 倉庫 - 套裝軟體
    "static": { // 靜態翻譯
        ...
        // /<user-name>/<repo-name>/pkgs/container/<pag name>
            ...
            "Learn more about npm packages": "了解更多關於 npm 套裝軟體的資訊",
            ...
            "Add a Readme to the linked repository": "添加一個 README 自述文件到連結的倉庫",
            "The linked repository's Readme will be shown here.": "連結倉庫中的 README 自述文件將在此處顯示。",
...
I18N.zh["packages"] = { // 套裝軟體 - 未連結倉庫的套裝軟體
    "static": { // 靜態翻譯
        ...I18N.zh["repository/pkgs"]["static"],

        "Link this package to a repository": "將此套裝軟體連結到倉庫",
        "By linking to a repository, you can automatically add a Readme, link discussions, and show contributors on this page.": "通過連結到倉庫，您可以自動添加 README 自述文件、連結討論、在此頁面上顯示貢獻者。",
        "Connect Repository": "關聯倉庫",

        // 關聯倉庫對話框
        "Select a repository to link to this package.": "選擇一個倉庫以連結到此套裝軟體。"
    },
    "regexp": [  // 正則翻譯
...
I18N.zh["repository/security"] = { // 倉庫 - 安全頁面
    "static": { // 靜態翻譯
        ...
        // Dependabot 警報 /<user-name>/<repo-name>/security/dependabot
            ...
            "Opt out": "設定",
            "learn more about auto-dismissing alerts.": "了解更多關於自動撤消警報的資訊。",
        ...
        // 代碼掃描器 /<user-name>/<repo-name>/security/code-scanning
            ...
            "Configure tools that integrate with Code Scanning to keep the quality of your code under control. Learn more about": "與代碼掃描集成的配置工具，使您的代碼質量得到控制。了解更多關於",
    ...
    "static": { // 靜態翻譯
        ...
        // 社區 /<user-name>/<repo-name>/graphs/community
            ...
            "Discussions page views": "討論頁面瀏覽量",
                ...
                "Read more about insights": "閱讀更多關於見解的資訊",

            "Discussions daily contributors": "每日討論的貢獻者",
                "Count of unique users who have reacted, upvoted, marked an answer, commented, or posted in the selected period.": "在所選時間段內，作出反應、投票、標記答案、評論或發文的唯一用戶的數量。",
            "Discussions new contributors": "討論的新貢獻者",
                "Count of unique new users to Discussions who have reacted, upvoted, marked an answer, commented, or posted in the selected period.": "在所選時間段內，對討論作出反應、投票、標記答案、評論或發文的唯一新用戶的數量。",
    ...
    "static": { // 靜態翻譯
        ...
        // 添加許可證 /<user-name>/<repo-name>/community/license/new?branch=<branch name>&template=<template name>
            ...
            // 中間欄 頂部 權限資訊
                ...
                "Learn more about repository licenses": "了解更多關於倉庫許可證的資訊",
...
I18N.zh["repository/graphs/code-frequency"] = { // 倉庫 -> 洞察 - 代碼頻率
    "static": { // 靜態翻譯
        ...I18N.zh["repository-public"]["static"],
        ...I18N.zh["repository-insights-menu"]["static"],
...
I18N.zh["repository/network/dependencies"] = { // 倉庫 -> 洞察 - 依賴關係圖 - 依賴關係
    "static": { // 靜態翻譯
        ...
        // 依賴關係圖 - 依賴關係 /network/dependencies
            ...
            "Learn more about how we use your data": "了解更多關於我們如何使用您的數據的資訊",
            "Allow access": "允許訪問",
            ...
            "Known security vulnerability in": "已知的安全漏洞，在",
                ...
                "Always verify the validity and compatibility of suggestions with your codebase.": "始終驗證建議與代碼庫的有效性和相容性。",
...
I18N.zh["repository/network/updates"] = { // 倉庫 -> 洞察 - 依賴關係圖 - Dependabot
    "static": { // 靜態翻譯
        ...
        // 依賴關係圖 - Dependabot /network/updates
            ...
            "Dependabot version updates": "Dependabot 版本更新",
            "automatically keep your application up-to-date by periodically updating dependencies to their latest versions.": "透過定期將依賴項更新到最新版本，自動保持應用的最新狀態。",
...
I18N.zh["repository-settings-menu"] = { // 倉庫設定公共部分
    "static": { // 靜態翻譯
        // >>>>>>>>>>>>>>>>>>   倉庫設定 公共部分  <<<<<<<<<<<<<<<<<<<
            ...
            "Repository settings saved.": "倉庫設定已保存。",
    ...
    "static": { // 靜態翻譯
        ...
        // 通常 - 設定頁面 /<user-name>/<repo-name>/settings ====================================
            ...
            "Template repository": "模板庫",
                ...
                "Enabling this setting will require contributors to sign off on commits made through GitHub’s web interface. Signing off is a way for contributors to affirm that their commit complies with the repository's terms, commonly the": "啟用此設定將要求貢獻者簽署通過 GitHub 的 Web 界面所做的提交。簽署是貢獻者確認他們的提交符合倉庫條款的一種方式，通常是",
                "Developer Certificate of Origin (DCO)": "開發者來源證書（DCO）",
                "Learn more about signing off on commits": "了解更多關於簽署提交的資訊",

            "Default branch": "預設分支",
            "The default branch is considered the “base” branch in your repository, against which all pull requests and code commits are automatically made, unless you specify a different branch.": "預設分支被認為是倉庫中的 “基礎” 分支，所有的拉取請求和代碼提交都是針對該分支進行的，除非您指定一個不同的分支。",
            "Rename branch": "重命名分支",
                // 重命名分支對話框
            ...
            "Switch to another branch": "切換到另一分支",
                ...
                // 頂部提醒
                    // [/Default branch changed to ([^ ])/, "預設分支更改為 $1"]
            ...
            // 私人庫 啟用 Wiki 提醒
                ...
                "GitHub Wikis is a simple way to let others contribute content. Any GitHub user can create and edit pages to use for documentation, examples, support, or anything you wish.": "GitHub Wikis 是一種讓他人貢獻內容的簡單方法。任何 GitHub 用戶都可以創建和編輯頁面，用於文件、範例、支持或任何您想要的東西。",
                // "Upgrade": "升級",
            ...
            // "Pull Requests": "拉取請求",
                ...
                "Allow squash merging": "允許壓縮合併",
                    ...
                    "Default to PR title for squash merge commits": "默認將拉取請求的標題作為壓縮合併提交的資訊",
            ...
            "Archives": "檔案",
            "When creating source code archives, you can choose to include files stored using Git LFS in the archive.": "創建原始碼存檔時，您可以選擇在存檔中包含使用 Git LFS 儲存的文件。",
            ...
            "Limit how many branches and tags can be updated in a single push": "限制一次推送中可以更新多少個分支和標籤",
                ...
                "Learn more about this setting": "了解更多關於此設定的資訊",
            ...
            "I want to make this repository private": "我想將此倉庫設為私有",
                ...
                "Dependency graph and Dependabot alerts will remain enabled with permission to perform read-only analysis on this repository. Any custom Dependabot alert rules will be disabled unless GitHub Advanced Security is enabled for this repository.": "依賴關係圖和 Dependabot 警報將繼續啟用，並允許對該倉庫執行只讀分析。除非為該倉庫啟用了 GitHub 高級安全功能，否則任何自訂的 Dependabot 警報規則都將被禁用。",
            ...
            "Disable branch protection rules": "禁用分支保護規則",
                ...
                // 頂部提醒
                    "Branch protection settings saved.": "分支保護設定已保存。",
            ...
            // 刪除倉庫對話框
                ...
                "repository, wiki, issues, comments, packages, secrets, workflow runs, and remove all collaborator associations.": "倉庫、Wiki、議題、評論、套裝軟體、機密、工作流程，並刪除所有協作者關聯。",
                "repository, wiki, issues, comments, packages, secrets, workflow runs, and remove all team associations.": "倉庫、Wiki、議題、評論、套裝軟體、機密、工作流程，並刪除所有團隊關聯。", // 組織倉庫
    ...
    "static": { // 靜態翻譯
        ...
        // 協作者 / 協作者和團隊 - 訪問管理頁面 /<user-name>/<repo-name>/settings/access ====================================
            ...
            // 邀請對話框
                ...
                "Search by username, full name, or email": "搜索使用者名稱、全名、或電子信箱",
...
I18N.zh["repository/settings/interaction_limits"] = { // 倉庫設定 - 互動限制 /<user-name>/<repo-name>/settings/interaction_limits
    "static": { // 靜態翻譯
        ...
        // 同全局 同組織倉庫
            ...
            "You can restrict repository interactions across your account in your": "您可以限制倉庫交互，在您的帳戶設定中的",
            ...
            // 頂部提醒
            "Repository interaction limit settings saved.": "倉庫交互限制設定已保存。",
    },
    "regexp": [ // 正則翻譯
        ...I18N.zh["repository-public"]["regexp"],
            [/You can restrict repository interactions across the ([^ ]+) organization in your/, "您可以在您的 $1 組織中限制倉庫交互"],
...
I18N.zh["repository/settings/code_review_limits"] = { // 倉庫設定 - 代碼審查限制 /<user-name>/<repo-name>/settings/code_review_limits
    "static": { // 靜態翻譯
        ...I18N.zh["repository-public"]["static"],
        ...I18N.zh["repository-settings-menu"]["static"],

        // Code review limits 代碼審查限制 /<user-name>/<repo-name>/settings/code_review_limits
            ...
            // 頂部提醒
                "Code review limit settings saved.": "代碼審查限制設定已保存。",
    },
    "regexp": [ // 正則翻譯
        ...I18N.zh["repository-public"]["regexp"],
    ],
...
I18N.zh["repository/settings/branches"] = { // 倉庫設定 - 分支 /<user-name>/<repo-name>/settings/branches
    "static": { // 靜態翻譯
        ...
        // 分支管理頁面 /<user-name>/<repo-name>/settings/branches====================================
            ...
            // 頂部提醒
            "Branch protection rule settings saved.": "分支保護規則設定已保存。",
            ...
            "Protect matching branches": "保護匹配的分支",
                "Require a pull request before merging": "要求在合併前提交拉取請求",
                    ...
                    "Require review from Code Owners": "要求代碼所有者進行審查",
                        "Require an approved review in pull requests including files with a designated code owner.": "要求在拉取請求中進行批准審查，包括有指定代碼所有者的文件。",
                ...
                "Require status checks to pass before merging": "要求在合併前通過狀態檢查",
                    ...
                    "Require branches to be up to date before merging": "要求分支在合併前必須是最新的",
                        "This ensures pull requests targeting a matching branch have been tested with the latest code. This setting will not take effect unless at least one status check is enabled (see below).": "這可確保針對匹配分支的拉取請求已使用最新的代碼進行了測試。除非啟用了至少一個狀態檢查，否則這個設定不會生效（見下文）。",
                ...
                "Require conversation resolution before merging": "要求在合併前解決對話",
                    "When enabled, all conversations on code must be resolved before a pull request can be merged into a branch that matches this rule.": "啟用後，必須先解決所有有關代碼的對話，然後才能將拉取請求合併到與此規則匹配的分支中。",
...
I18N.zh["repository/settings/rules"] = { // 倉庫設定 - 規則 - 規則集 /<user-name>/<repo-name>/settings/rules
    "static": { // 靜態翻譯
        ...
        // 規則集 頁面 /<user-name>/<repo-name>/settings/rules
            ...
            "Organization rulesets won't be enforced": "在您將該組織帳戶升級到 GitHub 企業版之前，", // 組織設定
            "until you upgrade this organization account to GitHub Enterprise.": "組織規則集將不會強制執行。", // 組織設定

            "You haven't created any rulesets": "您尚未創建任何規則集",
                "Define whether collaborators can delete or force push and set requirements for any pushes, such as passing status checks or a linear commit history.": "定義協作者是否可以刪除或強制推送，並為任何推送設定要求，如通過狀態檢查或線性提交歷史。",
                "Learn more about rulesets.": "了解更多關於規則集的資訊。",
        ...
        // 編輯規則 /<user-name>/<repo-name>/settings/rules/<id>
            ...
            "Bypass list": "旁路列表",
                "Exempt roles, teams, or apps from this ruleset by adding them to the bypass list": "透過將角色、團隊或應用程式添加到旁路列表，使其免受此規則集的約束",
                "Exempt roles or teams from this ruleset by adding them to the bypass list": "透過將角色或團隊添加到旁路列表，使其免受此規則集的約束", // 組織設定
                "Add bypass": "添加旁路",
            ...
            "Targets": "目標",
                ...
                "Which repositories and branches do you want to make a ruleset for?": "您想為哪些倉庫和分支創建規則集？", // 組織設定
                ...
                // 組織設定
                    ...
                    "Target by repository properties": "目標倉庫屬性",
                        ...
                        "Include repositories by custom property": "按自訂屬性包含倉庫",
                            "Custom properties allow you to create your own metadata for repositories": "自訂屬性允許您為倉庫創建自己的元數據，",
                            "include": "包括",
                            "exclude": "排除",
                            "Property": "屬性",
                ...
                "Target": "目標",
                    ...
                    "Tag targeting criteria": "目標標籤規則", // 標籤
                        ...
                        "Targets have changed and repository match list will update on save.": "目標已更改，倉庫匹配列表將在保存時更新。", // 組織設定
                ...
                "protections": "保護",
                    ...
                    "Require merge queue": "要求合併隊列", // 組織倉庫
                        ...
                        "Require all queue entries to pass required checks": "要求所有隊列條目通過必要的檢查",
                            "When this setting is disabled, only the commit at the head of the merge group, i.e. the commit containing changes from all of the PRs in the group, must pass its required checks to merge.": "禁用此設定後，只有位於合併組頭部的提交（即包含組內所有拉取請求 變更的提交）必須通過合併所需的檢查。",
                    ...
                    "Require deployments to succeed": "要求部署成功",
                        ...
                        "Hide additional settings": "隱藏附加設定",
                        "Show additional settings": "顯示附加設定",
                    ...
                    "Require a pull request before merging": "要求在合併前提交拉取請求",
                        "Require all commits be made to a non-target branch and submitted via a pull request before they can be merged.": "要求所有的提交都必須在非目標分支上進行，並在合併前通過拉取請求提交。",
                            ...
                            "Require review from Code Owners": "要求代碼所有者進行審查",
                                "Require an approving review in pull requests that modify files that have a designated code owner.": "要求對具有指定代碼所有者的文件修改的拉取請求中進行批准審查。",
                            "Require approval of the most recent reviewable push": "要求批准最新的可審查推送",
                                "Whether the most recent reviewable push must be approved by someone other than the person who pushed it.": "最新的可審核推送是否必須得到推送者以外的其他人批准。",
                            "Require conversation resolution before merging": "要求在合併前解決對話",
                                "All conversations on code must be resolved before a pull request can be merged.": "在合併拉取請求之前，必須解決有關代碼的所有對話。",
                    "Require status checks to pass": "要求通過狀態檢查",
                        "Choose which status checks must pass before the ref is updated. When enabled, commits must first be pushed to another ref where the checks pass.": "更新引用之前必須選擇通過哪些狀態檢查。啟用後，提交必須首先推送到檢查通過的另一個引用。",
                            "Require branches to be up to date before merging": "要求分支在合併前必須是最新的",
                                "Whether pull requests targeting a matching branch must be tested with the latest code. This setting will not take effect unless at least one status check is enabled.": "針對匹配分支的拉取請求，使用最新代碼進行測試。至少啟用一項狀態檢查，否則此設定不會生效。",
                        ...
                        "Add workflow": "添加工作流",
                            "Add required workflow": "添加所需的工作流",
                                ...
                                "Enter a SHA": "輸入 SHA",
                                    ...
                                    "Invalid SHA": "無效的 SHA",
                                "Pick a workflow file": "選擇工作流檔案",
                                    "Please select a workflow path": "請選擇工作流路徑",

            "Restrictions": "限制", // 組織設定
                "Restrict commit metadata": "限制提交元數據",
                    "Restrict commit author email addresses, committer email addresses, commit message content, and other metadata": "限制提交作者電子信箱地址、提交者電子信箱地址、提交消息內容和其他元數據",
                            ...
                            // 添加元數據限制 對話框
                                "Add a metadata restriction": "添加元數據限制",
                                    ...
                                    "Description": "描述",
                                        ...
                                        // [/Commit message must match a given regex pattern/, "提交資訊必須匹配給定的正則表達式規則"],
                                        ...
                                        // [/Commit message must not match a given regex pattern/, "提交資訊不得匹配給定的正則表達式規則"],
                                        ...
                                        // [/Author email must match a given regex pattern/, "作者電子信箱地址必須匹配給定的正則表達式規則"],
                                        ...
                                        // [/Author email must not match a given regex pattern/, "作者電子信箱地址不得匹配給定的正則表達式規則"],
                                        ...
                                        // [/Committer email must match a given regex pattern/, "提交者電子信箱地址必須匹配給定的正則表達式規則"],
                                        ...
                                        // [/Committer email must not match a given regex pattern/, "提交者電子信箱地址不得匹配給定的正則表達式規則"],
            ...
            // 授權訪問 sudo 模式身份驗證
                ...
                "We just sent you a message via SMS with your authentication code. Enter the code in the form above to verify your identity.": "我們剛剛通過簡訊向您發送了一條消息，其中包含您的驗證碼。在上面的表格中輸入驗證碼以驗證您的身份。",
    ...
    "static": { // 靜態翻譯
        ...
        // 操作頁面 /<user-name>/<repo-name>/settings/actions
            ...
            // [/Allow ([^ ]+), and select non-([^ ]+), actions and reusable workflows/, "允許 $1，並選擇非 $2、操作和可復用的工作流程"],
                ...
                "Learn more about allowing specific actions and reusable workflows to run.": "了解更多關於允許運行特定操作和可復用的工作流程的資訊。",
                ...
                "Entire organization or repository examples:": "整個組織或倉庫的範例：",
                // "Save": "保存",
                "Saving...": "保存中...",
                // 頂部提醒
            ...
            "Artifact and log retention": "工件和日誌保留",
                ...
                "days.": "天。", //組織倉庫
                "Learn more about the artifact and log retention policy.": "了解更多關於工件和日誌保留政策的資訊。",

                "days": "天",

            "Fork pull request workflows": "復刻拉取請求工作流程",
                "Run workflows from fork pull requests": "從復刻拉取請求運行工作流程",
                    "This tells Actions to run workflows from pull requests originating from repository forks. Note that doing so will give maintainers of those forks the ability to use tokens with read permissions on the source repository.": "這告訴 Actions 運行工作流程，來自倉庫復刻的拉取請求。請注意，這樣做將使這些復刻的維護者有能力在原始碼庫上使用具有讀取權限的令牌。",
            ...
            "Fork pull request workflows from outside collaborators": "從外部協作者，復刻拉取請求工作流程",
                ...
                "Learn more about approving workflow runs from public forks.": "了解更多關於批准來自公共復刻的工作流運行的資訊。",
            ...
            "Workflow permissions": "工作流程權限",
                "Choose the default permissions granted to the GITHUB_TOKEN when running workflows in this repository. You can specify more granular permissions in the workflow using YAML.": "在倉庫中運行工作流程時，選擇授予 GITHUB_TOKEN 的預設權限。您可以使用 YAML 在工作流程中指定更細化的權限。",
                ...
                // 頂部提醒
                    "Default workflow permissions settings saved.": "已保存默認工作流程權限設定。",

        // 運行器頁面 /<user-name>/<repo-name>/settings/actions/runners
            "New self-hosted runner": "新建自託管運行器",
            "Host your own runners and customize the environment used to run jobs in your GitHub Actions workflows.": "託管您自己的運行器，並訂製用於在您的 GitHub Actions 工作流程中運行作業的環境。",
            "Learn more about self-hosted runners": "了解更多關於自託管運行器的資訊",
            "There are no runners configured": "暫無設定運行器",
            "Learn more about using runners": "了解更多關於使用運行器的資訊",
            "to run actions on your own servers.": "在您自己的伺服器上運行操作的資訊。",
...
I18N.zh["repository/settings/hooks"] = { // 倉庫設定 - Web 鉤子 /<user-name>/<repo-name>/settings/hooks
    "static": { // 靜態翻譯
        ...
        // 添加鉤子 頁面 /<user-name>/<repo-name>/settings/hooks/new ====================================
            ...
            "Add webhook": "添加 Web 鉤子",
            "We'll send a": "我們將",
            "request to the URL below with details of any subscribed events. You can also specify which data format you'd like to receive (JSON,": "請求到以下 URL，其中包含任何訂閱事件的詳細資訊。您還可以指定要接收的數據格式（JSON、",
            "etc": "等",
            ...
            "Which events would you like to trigger this webhook?": "您希望哪些事件觸發此 Web 鉤子？",
                ...
                "Let me select individual events.": "讓我選擇單個事件。",
                    ...
                    "Project v2 items": "項目項 v2", // 組織設定
                        "Project item created, edited, deleted, archived, restored, converted, or reordered. Feedback is welcome in": "項目條目的創建、編輯、刪除、歸檔、恢復、轉換或重新排序。歡迎提供回饋意見在",
                        "this discussion": "這個討論",
                    // "": "項目",
                        "Project created, updated, or deleted.": "項目的創建、更新或刪除。",
                    "Projects v2": "項目 v2", // 組織設定
                        "Project created, updated, deleted, closed, or reopened. Feedback is welcome in": "項目的創建、更新、刪除、關閉或重新打開。歡迎提供回饋意見在",
            ...
            // 頂部提醒
            "Okay, that hook was successfully created. We sent a ping payload to test it out! Read more about it at https://docs.github.com/webhooks/#ping-event.": "好的，這個鉤子已經成功創建。我們發送了一個 ping 負載來測試它! 閱讀更多關於它的資訊，請訪問 https://docs.github.com/webhooks/#ping-event。",

        // 管理 鉤子 /<user-name>/<repo-name>/settings/hooks/<id>
            "Manage webhook": "管理 Web 鉤子",
            "If you've lost or forgotten this secret, you can change it, but be aware that any integrations using this secret will need to be updated. —": "如果您遺失或忘記了此機密，則可以更改它，但請注意，使用此機密的任何集成都需要更新。 —",
            "Change Secret": "更改機密",
    ...
    "static": { // 靜態翻譯
        ...
        // 編輯環境 /<user-name>/<repo-name>/settings/environments/<id>/edit
            ...
            "Deployment protection rules": "部署保護規則",
                "Configure reviewers, timers, and custom rules that must pass before deployments to this environment can proceed.": "配置審查者、計時器和自訂規則，在繼續部署到此環境之前必須通過這些規則。",
            ...
            "Environment variables": "環境變數",
                "Variables are used for non-sensitive configuration data. They are accessible only by GitHub Actions in the context of this environment. They are accessible using the": "變數用於非敏感配置數據。它們只能通過此環境上下文中的 GitHub Actions 訪問。它們可以使用",
                "vars context": "變數內容",
                "Add variable": "添加變數",
...
I18N.zh["repository/settings/codespaces"] = { // 倉庫設定 - 代碼空間 /<user-name>/<repo-name>/settings/codespaces
    "static": { // 靜態翻譯
        ...I18N.zh["repository-public"]["static"],
        ...I18N.zh["repository-settings-menu"]["static"],
        ...
        // 代碼空間 /<user-name>/<repo-name>/settings/codespaces
            ...
            "Prebuild configurations speed up Codespace creations significantly by pre-executing all the tasks required to build your development environment.": "預構建配置通過預先執行構建開發環境所需的所有任務，大大加快了代碼空間的創建。",
            "Learn more about setting up prebuilds": "了解更多關於預構建設定的資訊",

        // 代碼空間 /<user-name>/<repo-name>/settings/codespaces
            "/ New prebuild configuration": "/ 新建預構建設定",
            "Configuration": "設定",
            ...
            "Default Codespaces Configuration": "默認代碼空間設定",
            ...
            "Reduce prebuild available to only specific regions": "減少僅適用於特定區域的預構建",
                "By default, your prebuilt image will be available to all regions where codespaces are available and storage costs will apply for each region. You can adjust this to manage your storage usage.": "默認情況下，您的預構建映像將適用於所有代碼空間可用的區域，並且每個地區都有儲存費用。。您可以調整此項以管理您的儲存使用情況。",
            ...
            "Template history": "模板歷史",
                "You can specify the number of prebuild template versions retained to speed up codespaces from an older commit to manage storage costs. The maximum value is 5 versions.": "您可以指定保留的預構建模板版本的數量，以加快舊提交的代碼空間，以管理儲存成本。最大值為 5 個版本。",
            ...
            "You can disable prebuild optimization if you're having issues where codespaces are several commits behind on a specific branch.": "如果您遇到代碼空間在特定分支上落後多個提交的問題，您可以禁用預構建最佳化。",
        ...
        // GitHub Pages 頁面 /<user-name>/<repo-name>/settings/pages====================================
            ...
            "Custom domain": "自訂域",
                ...
                "Enforce HTTPS": "強制 HTTPS",
                    "— Required for your site because you are using the default domain (": "— 必須先設定自訂域，目前您正在使用默認域 (",
...
I18N.zh["repository/settings/security_analysis"] = { // 倉庫設定 - 代碼安全性與分析 /<user-name>/<repo-name>/settings/security_analysis
    "static": { // 靜態翻譯
        ...I18N.zh["repository-public"]["static"],
        ...I18N.zh["repository-settings-menu"]["static"],

        // 代碼安全性與分析 /<user-name>/<repo-name>/settings/security_analysis
            "Security and analysis features help keep your repository secure and updated. By enabling these features, you're granting us permission to perform read-only analysis on your repository. Unarchive your repository to access additional features.": "安全和分析功能有助於確保您的倉庫安全和更新。透過啟用這些功能，您授予我們對您的倉庫執行只讀分析的權限。解除您倉庫的存檔以訪問其他功能。", //存檔倉庫
            "Security and analysis features help keep your repository secure and updated. By enabling these features, you're granting us permission to perform read-only analysis on your repository.": "安全和分析功能有助於確保您的倉庫安全和更新。透過啟用這些功能，您授予我們對您的倉庫執行只讀分析的權限。",
            ...
            // Dependabot
                ...
                "Dependabot alerts": "Dependabot 警報",
                    ...
                    "Dependabot rules": "Dependabot 規則",
                        "Create your own custom rules and manage alert presets.": "創建您自己的自訂規則並管理警報預設。",
            ...
            "Code scanning": "代碼掃描",
                ...
                "Tools": "工具",
                    "CodeQL analysis": "CodeQL 分析",
                        ...
                        "Advanced": "高級",
                            "Customize your CodeQL configuration via a YAML file checked into the repository.": "通過倉庫中的 YAML 文件訂製您的 CodeQL 配置。",
                        "Not supported": "不支持",
                ...
                "Protection rules": "保護規則",
                    ...
                    "Check runs failure threshold": "檢查運行失敗閾值",
                ...
                // 頂部提醒
                "Code Scanning alert severity settings saved.": "代碼掃描警報嚴重性設定已保存。",
...
I18N.zh["repository/settings/secrets"] = { // 倉庫設定 - 機密 /<user-name>/<repo-name>/settings/secrets
    "static": { // 靜態翻譯
        ...
        // 操作機密 /<user-name>/<repo-name>/settings/secrets/actions
            ...
            "Secrets and variables allow you to manage reusable configuration data. Secrets are": "機密和變數允許您管理可重複使用的配置數據。機密是",
            "encrypted": "被加密",
            "and are used for sensitive data.": "並用於敏感數據。",
            "Learn more about encrypted secrets": "了解更多關於加密機密的資訊",
            ". Variables are shown as plain text and are used for": "。變數顯示為純文本，用於",
            "non-sensitive": "不敏感",
            "data.": "數據。",
        ...
        // 操作變數 /<user-name>/<repo-name>/settings/variables/actions
            ...
            "Repository variables": "倉庫變數",
                "New repository variable": "新建倉庫變數",
        ...
        // 新建倉庫變數 /<user-name>/<repo-name>/settings/variables/actions/new
            "Actions variables": "操作變數",
            "/ New variable": "/ 新建變數",
            "Note: Variable values are exposed as plain text. If you need to encrypt and mask sensitive information,": "注意：變數值是以純文本形式暴露的。如果您需要對敏感資訊進行加密和屏蔽，請使用",
        ...
        // Dependabot 機密 /<user-name>/<repo-name>/settings/secrets/dependabot
            ...
            "Secrets are not passed to forks.": "機密不會傳遞給復刻。",
            "Encrypted secrets allow you to store private access tokens so that Dependabot can update dependencies from private registries.": "加密的機密允許您儲存私有訪問令牌，以便 Dependabot 可以從私有註冊表更新依賴項。",
...
I18N.zh["repository/settings/installations"] = { // 倉庫設定 - GitHub 應用 /<user-name>/<repo-name>/settings/installations
    "static": { // 靜態翻譯
        ...
        // 全局設定在 Applications 應用 /settings/installations
            "Installed GitHub Apps": "安裝的 GitHub 應用",
            "GitHub Apps augment and extend your workflows on GitHub with commercial, open source, and homegrown tools.": "GitHub 應用通過商業、開源和自主開發的工具來增強和擴展您在 GitHub 上的工作流程。",
            "Configure": "配置",
    ...
    "static": { // 靜態翻譯
        ...
        // 轉讓倉庫 /<user-name>/<repo-name>/transfer
            ...
            // 私有倉庫轉讓
                ...
                "Any existing": "任何已存在的",
                "wikis": "WiKi",
                "Pulse, Contributors, Community, Traffic, Commits, Code Frequency, Network,": "統計，貢獻者，社區，流量，提交，代碼頻率，網路，",
                "Forks": "復刻",
                "on the": "在",
                "Insights": "洞察",
                "tab": "標籤頁",
...
I18N.zh["repository/codespaces"] = { // 倉庫 - 代碼空間界面 /<user-name>/<repo-name>/codespaces
    "static": { // 靜態翻譯
        ...I18N.zh["repository-public"]["static"],
        ...
        // 倉庫 - 代碼空間界面 /<user-name>/<repo-name>/codespaces
            ...
            "Go to docs": "轉到文件",
            // [/Create codespace on ([^ ]+)/, "在 $1 上創建代碼空間"],
                    "2-core • 8GB RAM • 32GB": "雙核 • 8GB 記憶體 • 32GB 硬碟",
            ...
            "4-core • 16GB RAM • 32GB": "四核 • 16GB 記憶體 • 32GB 硬碟",
...
I18N.zh["homepage"] = { // 未登入的首頁
    "static": { // 靜態翻譯
        ...
        "GitHub Codespaces": "GitHub 代碼空間",
        "offers a complete dev environment in seconds. Code, build, test, and open pull requests from any repo.": "可在幾秒鐘內提供完整的開發環境。可在任何代碼庫中編寫程式碼、構建、測試並打開拉取請求。",
        ...
        "allow real-time communication and collaboration about code changes.": "允許就代碼更改進行即時交流和協作。",
...
I18N.zh["session-authentication"] = { // 登入頁 包含(/login, /session, /sessions/two-factor, sessions/recovery, /sessions/recovery/token, /password_reset等)
    "static": { // 靜態翻譯
        ...
        // 登入頁 https://github.com/login
            ...
            "Forgot password?": "忘記密碼？",
            "Sign in": "登錄",
            "Sign in with a passkey": "使用通行金鑰登錄",
            "Signing in…": "登錄中…",

            "Add an account": "添加帳號", // 添加新帳號
            "Want to create an account?": "想要新建一個帳戶嗎？", // 添加新帳號

            "Or": "或",
            // "This browser or device does not fully support passkeys.": "此瀏覽器或設備不完全支持通行金鑰。",
            "This browser or device is reporting partial passkey support.": "此瀏覽器或設備報告部分支持通行金鑰。",
            "Sign-in with a passkey": "使用通行金鑰登錄",
        ...
        // 設備啟用 https://github.com/login/device
            "Device Activation": "設備啟用",
        ...
        // 雙重身份驗證恢復 https://github.com/sessions/two-factor/recovery
            ...
            "If you are unable to access your mobile device, enter one of your recovery codes to verify your identity.": "如果您無法訪問您的行動裝置，請輸入您的一個恢復碼以驗證您的身份。",
            ...
            "If you can’t access a verified device or recovery codes you can request a reset of your authentication settings. For security reasons": "如果您無法訪問已驗證的設備或恢復碼，您可以請求重設您的驗證設定。出於安全考慮",
            "this can take 1-3 days": "這可能需要 1-3 天",
            "Step 1": "第一步",
            "Verify an email associated with this account.": "驗證與該帳戶相關的電子信箱。",
            "Step 2": "第二步",
            "Verify a device, SSH key or personal access token.": "驗證一個設備、SSH 金鑰或個人訪問令牌。",
            "Step 3": "第三步",
        ...
        // 帳戶恢復 https://github.com/sessions/recovery
            ...
            "It looks like you have a GitHub Mobile session that could be used for two-factor authentication. If you have access to your mobile device, you may be able to use it to login.": "看起來您有一個 GitHub Mobile 會話，可以用來進行雙重身份驗證。如果您能訪問您的行動裝置，您也許能用它來登錄。",
            ...
            "This can be a verified device, an SSH key or a personal access token associated with this account.": "這可以是一個經過驗證的設備，一個SSH 金鑰或一個與此帳戶相關的個人訪問令牌。",
            ...
            "Emails": "電子信箱",
                ...
                "Unverified emails": "未經驗證的電子信箱",
                "Unverified emails cannot receive notifications or be used to reset your password.": "未經驗證的電子信箱無法接收通知或用於重設密碼。",
        ...
        // 配置無密碼身份驗證 https://github.com/sessions/trusted-device?return_to=%2Fsettings%2Fsecurity
            ...
            "Add a passkey": "添加通行金鑰",
            "Your device supports passkeys, a password replacement that validates your identity using touch, facial recognition, a device password, or a PIN.": "您的設備支持密碼替代方案，通過觸摸、臉部識別、設備密碼或者 PIN 碼來驗證您的身份。",

            "Passkeys can be used for sign-in as a simple and secure alternative to your password and two-factor credentials.": "通行金鑰可以作為一種簡單且安全的替代方式，用於登錄而不需要密碼和雙重身份驗證。",
            "Add passkey": "添加通行金鑰",
            ...
            "From now on, you can use this passkey to sign-in to GitHub.": "從現在起，您可以使用此通行金鑰登錄 GitHub。",
            "Passkey nickname": "通行金鑰暱稱",
            "Continue...": "繼續中...",

        // 重設密碼 https://github.com/password_reset
            "Reset your password": "重設您的密碼",
            "Enter your user account's verified email address and we will send you a password reset link.": "輸入您的用戶帳戶經過驗證的電子信箱，我們將向您發送一份帶密碼重設連結的郵件。",
            "Enter your email address": "輸入您的信箱地址",
            "Verify your account": "驗證您的帳戶",
            "Send password reset email": "發送密碼重設郵件",
            "Check your email for a link to reset your password. If it doesn’t appear within a few minutes, check your spam folder.": "檢查您的電子郵件以獲取重設密碼的連結。如果它在幾分鐘內沒有出現，請檢查您的垃圾郵件文件夾。",
        ...
        // 首次設定雙重身份驗證 https://github.com/settings/two_factor_authentication/setup/intro
            ...
            // 第2步
                ...
                "If you lose your device and don't have the recovery codes, you will lose access to your account.": "如果您遺失了您的設備，並且沒有恢復碼，您將無法訪問您的帳戶。",
            ...
            // 第3步
                ...
                "Configuring additional authentication methods will help you gain access to your account in case you lose your device and don't have your recovery codes.": "配置額外的認證方法將幫助您在遺失設備和沒有恢復碼的情況下獲得對帳戶的訪問。",

                "Security key": "安全金鑰",
                    "Use your device with Touch ID, Windows Hello, etc. or a physical security key (e.g. YubiKey)": "使用您的設備配合 Touch ID、Windows Hello 等功能或物理安全金鑰（例如YubiKey）。",
                    "Manage": "管理",
                    "Register new security key": "註冊新安全金鑰",
                    "Enter a nickname for this security key": "輸入安全金鑰的暱稱",
                    "Waiting for input from browser interaction...": "等待來自瀏覽器交互的輸入...",
        ...
        // https://github.com/settings/two_factor_checkup
            ...
            "As a reminder, recovery codes can be used as a second factor to authenticate in case you lose your device. If you don't have your recovery codes, you may lose access to your account.": "作為提醒，恢復碼可用作第二個身份驗證因素，以防您遺失設備。如果您沒有恢復碼，則可能無法訪問您的帳戶。",
        ...
        // 切換帳戶 https://github.com/switch_account
            "Signed out": "已註銷",
    ...
    "regexp": [ // 正則翻譯
        [/(\d+) verified emails?/, "$1 個經過驗證的信箱"],
        [/(\d+) unverified emails?/, "$1 個未經驗證的信箱"],
        [/(\d+) keys?/, "$1 個通行金鑰"],
        [/(\d+) devices?/, "$1 設備"],
        [/You will receive one-time codes at this phone number:/, "您將通過以下電話號碼收到一次性驗證碼："], // 已設定簡訊/文字資訊
...
I18N.zh["notifications"] = { // 通知頁面
    "static": { // 靜態翻譯
        ...
        "ProTip!": "專業提示！",
            ...
            "Create custom filters to quickly access your most important notifications.": "創建自訂篩選器以快速訪問最重要的通知。",
    },
    "regexp": [ // 正則翻譯
        [/(\d+) selected/, "$1 條被選中"],
...
I18N.zh["search"] = { // 搜索頁面
    "static": { // 靜態翻譯
        ...
        // 搜索 https://github.com/search >>>>>>>>>>>>>>>>>>>>>>>>
            ...
            "ProTip!": "專業提示！",
            "Press the": "再次按",
            "key to activate the search input again and adjust your query.": "鍵啟用搜索輸入並調整您的搜索結果。",
            "For an": "要進行",
            "advanced search": "高級搜索",
            ", use our": "，使用我們的",
            "prefixes": "前綴",
        ...
        // 搜索結果頁面 https://github.com/search?q=  >>>>>>>>>>>>>>>>>>>>>>>>
            ...
            "Search across repositories": "跨倉庫搜索",
                ...
                "Note that we don't currently support regular expressions in the repo or org qualifiers. For more information on search syntax, see our": "請注意，我們目前不支持 repo 或 org 限定符中的正則表達式。更多關於搜索語法的資訊，請參閱我們的",
                "syntax guide": "語法指南",
            ...
            "Find a particular file extension": "查找特定的文件副檔名",
                "With .txt extensions:": "帶有 .txt 副檔名：",
                "JavaScript and TypeScript files:": "JavaScript 和 TypeScript 文件：",

                "The path qualifier can search the entire file path, not just the extension, and supports regular expressions. For more information, see our": "路徑限定符可以搜尋整個文件路徑，而不僅僅是副檔名，並且支持正則表達式。更多資訊，請參閱我們的",

            "Why wasn't my code found?": "為什麼找不到我的代碼？",
...
I18N.zh["gist"] = { // 代碼片段頁面
    "static": { // 靜態翻譯
        ...
        "Clone with Git or checkout with SVN using the repository’s web address.": "通過倉庫 web 地址進行 Git 複製或 SVN 檢出。",
        ...
        "Empty file.": "空文件。",
        "File renamed without changes.": "文件僅重命名，內容沒有更改。",
        // [/([\d,]+) additions, ([\d,]+) deletions not shown because the diff is too large. Please use a local Git client to view these changes./, "$1 處添加，$2 處刪除未顯示，因為差異太大。請使用本地 Git 用戶端查看這些更改。"],

        // 星標標籤卡
        "Stargazers": "追星者",
        "Be the first to star this gist.": "成為第一個該代碼片段標星人。",
        "Learn more about starring Gists": "了解更多關於標星代碼片段的資訊",
...
I18N.zh["login/oauth"] = { // 應用授權
    "static": { // 靜態翻譯
        ...
        // 範例 /login/oauth/authorize?client_id=Iv1.1a4d20f84a40d790&state=login
    ...
    "static": { // 靜態翻譯
        ...
        // github.com/explore/email
            "Explore email newsletter": "探索電子郵件通訊",
                "Get email updates about what GitHub finds for you based on your interests": "根據您的興趣，通過電子郵件獲取 GitHub 為您找到的最新資訊",
...
I18N.zh["trending"] = { // 熱門頁面
    "static": { // 靜態翻譯
        ...
        "These are the developers building the hot tools this week.": "這些是本週創建熱門項目的開發人員。",
        ...
        "Spoken Language:": "母語：",
            ...
            "This setting can be saved in your": "此設定可以保存在您的",
...
I18N.zh["sponsors"] = { // 贊助界面
    "static": {
        // 贊助者首頁 https://github.com/sponsors
            ...
            "Anyone can sponsor, but you must reside in a supported region to receive funds.": "任何人都可以贊助，但您必須居住在受支援的地區才能獲得資金。",
        ...
        // 加入等候名單界面 https://github.com/sponsors/<user-name>/waitlist
            "GitHub Sponsors is now out of beta for 103 regions!": "GitHub 贊助者現已在 103 個地區推出測試版！",
                "If you have a bank account in": "如果您的銀行帳戶所在",
                ...
                "If you don't have an eligible bank account, don't worry! We're working hard to get more countries out of beta soon. Join the waitlist to be the first to know.": "如果您沒有符合條件的銀行帳戶，也不用擔心！我們正在努力讓更多的國家或地區通過測試。加入等候名單，第一時間獲知消息。",
            "Contact email": "聯繫電子信箱",
                "Select a verified email address for us to contact you about your GitHub Sponsors profile. This will not be shared publicly.": "請選擇一個經過驗證的電子信箱地址，以便我們就您的 GitHub 贊助者個人資料與您聯繫。該信箱地址不會公開。",
                "You can manage verified email addresses in your": "您可以管理已驗證的電子信箱地址在您的",
                "email settings": "電子信箱設定",
            ...
            "How you receive payments": "收款方式",
                "Use a bank account": "使用銀行帳戶",
                    "You can use your bank account to join GitHub Sponsors.": "您可以使用您的銀行帳戶加入 GitHub 贊助者。",
                    "Note that you are responsible for all applicable taxes on payouts you receive. If you use a personal bank account, your country may tax your GitHub Sponsors payouts as personal income.": "請注意，您需承擔您收到的付款的所有適用稅款。如果您使用個人銀行帳戶，您所在國家或地區可能會將您的 GitHub 贊助者收款作為個人收入徵稅。",
                    "Learn more about setting up a Stripe account": "了解更多關於設定 Stripe 帳戶的資訊",

                    "Country or region where your bank account is located:": "您的銀行帳戶所在的國家或地區：",
                        "Your region is": "您所在的地區",
                        "not supported": "不受支援",
                        "or may be in": "或者可能處於",
                        "beta": "測試階段",
                    "Use another bank account where GitHub Sponsors is available or complete signup to receive a notification if your region becomes available.": "使用另一個 GitHub 贊助者可用的銀行帳戶，或者在您所在的地區可用時完成註冊以收到通知。",
                "Use a fiscal host": "使用財務託管",
                    "You can use a fiscal host to join GitHub Sponsors instead of using your own bank account.": "您可以使用財務託管機構代替自己的銀行帳戶來加入 GitHub 贊助者。",
                    "Choose a fiscal host:": "選擇一個財務託管機構：",
                    "Select a fiscal host": "選擇一個財務託管機構",

                    "Fiscal host project profile URL:": "財務託管機構項目資料連結：",
                        "Please include a link to your profile on your fiscal host's site, if available.": "如果有的話，請提供您在的財務託管機構上的個人資料連結。",
                    "e.g.,": "例如，",
    ...
    "static": { // 靜態翻譯
        ...
        "Add-ons": "附加組件",
            "Get GitHub Copilot Business in this organization": "在組織中獲取 GitHub Copilot 商業版",
                "Boost developer productivity for $19/user/month. Pay only for assigned seats after setup.": "以 $19 /用戶/月的價格提高開發人員的工作效率。僅需在設定後為分配的席位付費。",
                "See Copilot Business docs.": "請參閱 GitHub Copilot 商業版文件。",
...
I18N.zh["marketplace"] = { // GitHub 市場
    "static": { // 靜態翻譯
        // GitHub 市場首頁 https://github.com/marketplace
            ...
            // 類別
                ...
                "Continuous integration": "持續集成",
                    ...
                    "Mobile CI": "移動 CI",
                        "Continuous integration for Mobile applications": "行動應用的持續集成",
                ...
                "IDEs": "集成開發環境",
                    "Find the right interface to build, debug, and deploy your source code.": "找到合適的界面來構建、除錯和部署原始碼。",
                "Learning": "學習",
        ...
        // 待安裝頁面 https://github.com/marketplace/installations/pending
            ...
            "Grant this app access to your GitHub account to complete installation.": "授予此應用訪問 GitHub 帳戶的權限，以完成安裝。",

        // 應用介紹頁面 https://github.com/marketplace/<app-name>
        // 範例: https://github.com/marketplace/codacy 第一頁
            "Apps": "應用",
            // 左側資訊欄
            ...
            "privacy policy": "隱私政策",
            ", and": "，和",
            "support documentation": "支持文件",
            "support contact": "支持聯絡",

        // 應用的審查、編輯訂單 第二頁 https://github.com/marketplace/<app-name>/order/<order-id>?account=<account-name>
        // 收費應用範例: https://github.com/marketplace/travis-ci/order/MDIyOk1hcmtldHBsYWNlTGlzdGluZ1BsYW43MA==?account=maboloshi
            "Edit your plan": "編輯您的計劃",
            "Account:": "帳戶：",
            "Order summary": "訂單摘要",
            "Open Source": "開源",
            ...
            "Billing information": "帳單資訊",
            "Please confirm your billing details to continue. You only need to do this once.": "請確認您的帳單詳情以繼續。您只需確認一次。",
            ...
            // 頂部提醒
                "An error occurred while saving payment information.": "保存支付資訊時發生錯誤。",

        // 免費應用範例: https://github.com/marketplace/gitlocalize/order/MDIyOk1hcmtldHBsYWNlTGlzdGluZ1BsYW4zOTg=?account=maboloshi
            "Review your order": "審查您的訂單",
            "Free": "免費",
            "For individuals, teams, and communities, public and private projects": "對於個人、團隊和社區，公共和私人項目",
            "Total amount": "總金額",

            "An organization owner or billing manager must link their personal billing information with this organization account. You can switch to a business account to use your business’ billing information by": "組織所有者或帳單管理者必須將其個人帳單資訊與該組織帳戶關聯。您可以切換到企業帳戶，以使用企業的帳單資訊通過",
            "signing": "簽署",
            "the": " ",
            "GitHub Customer Agreement": "GitHub 客戶協議",

        // GitHub 應用頁面 https://github.com/apps/<app-name>
        // 範例: https://github.com/apps/codacy-production
            "GitHub App": "GitHub 應用",

            "No description": "尚無描述",
            "Read more about this app on the Marketplace": "了解更多關於市場中此應用的資訊",
            ...
            "Developer": "開發者",
                "App settings": "應用設定", // 已安裝
                "Website": "網站",

            "is provided by a third-party and is governed by separate terms of service, privacy policy, and support documentation.": "是由第三方提供的，並受單獨的服務條款、隱私政策和支持文件的約束。",

            "Report abuse": "檢舉濫用",

        // GitHub 應用 安裝、授權頁面 https://github.com/apps/<app-name>/installations/new/permissions?target_id=<id>
        // 範例 https://github.com/apps/codacy-production/installations/new/permissions?target_id=7850715
            ...
            "Next: you’ll be directed to the GitHub App’s site to complete setup.": "下一步：您將被引導到GitHub 應用網站完成設定。", // 組織

        // 應用設定 - 選擇目標 https://github.com/apps/<app-name>/installations/select_target
            // [/Install (.*)/, "安裝 $1"],
        ...
        // 範例: https://github.com/marketplace/actions/merge-upstream
            // 頂部提醒
            ...
            "Learn more about verified Actions": "了解更多關於經驗證操作的資訊",

            "Contributors": "貢獻者",
            "Links": "連結",
            "Open issues": "打開議題",
            "is not certified by GitHub. It is provided by a third-party and is governed by separate terms of service, privacy policy, and support documentation.": "未經 GitHub 認證。它由第三方提供，並受單獨的服務條款、隱私政策和支持文件的約束。",
...
I18N.zh["orgs"] = { // 組織頁面
        ...
        //>>>>>>>>>>>>>>>>>> 組織首頁/概況頁 <<<<<<<<<<<<<<<<<<<<<
            ...
            // 右側欄
                ...
                // "People": "成員",
                    ...
                    "Invite someone": "邀請他人",
                        ...
                        "Search by username, full name or email address": "搜索使用者名稱，全名或信箱地址：",
                        "Invite": "邀請",
            ...
            "Invite your people": "邀請同伴",
                ...
                "Customize members' permissions": "自訂成員權限",
                    "Set everyone’s base permissions for your code.": "為您的代碼設定每個人的基本權限。",
    ...
    "selector": [ // 元素篩選器規則
        ["#type-options > summary > span:nth-child(1)", "類型"], // 組織首頁 --> 倉庫標籤頁-->類型篩選器 Type
    ],
};
    ...
    "static": { // 靜態翻譯
        ...
        // 組織資料 /organizations/<org-login>/settings/profile
            ...
            "GitHub Developer Program": "GitHub 開發者計劃",
                ...
                "for guides, our API reference, and other resources for building applications that integrate with GitHub. Make sure your contact information is up-to-date below. Thanks for being a member!": "以獲取指南、我們的 API 參考和其他用於構建與 GitHub 集成的應用的資源。請確保您的聯繫資訊是最新的。感謝您成為我們的成員！",
            ...
            "Terms of Service": "服務條款",
                ...
                "Corporate": "企業",
                    "Best for businesses that need to protect their intellectual property and secure visibility into their data.": "最適合需要保護智慧財產權並確保數據可見性的企業。",
            ...
            "Danger zone": "危險區",
                ...
                "Archive this organization": "存檔組織",
                    ...
                    "Archive organization": "存檔組織",
                        ...
                        "Modifying settings will be limited and creating new repositories will be blocked.": "修改設定將受到限制，並且創建新倉庫將被阻止。",
                ...
                "Unarchive this organization": "解鎖存檔組織",
                    ...
                    "Modifying settings will be possible and creating new repositories will be unblocked.": "可以修改設定，創建新倉庫也將不再受限。",
...
I18N.zh["orgs/settings/roles"] = { // 組織設定 - 倉庫角色
    "static": { // 靜態翻譯
        ...
        // 倉庫角色 /organizations/<org-login>/settings/roles
            "Roles are used to grant access and permissions for teams and members. In addition to the available pre-defined roles, you can create up to 0 custom roles to fit your needs.": "角色是用來為團隊和成員授予訪問和權限的。除了可用的預定義角色外，您可以創建多達 0 個自訂角色以滿足您的需求。",
            ...
            "Custom roles": "自訂角色",
                "Create a role": "創建角色",
                "Create custom roles with GitHub Enterprise": "使用 GitHub 企業版創建自訂角色",
                    "Enterprise accounts offer organizations more granular control over permissions by allowing you to configure up to three custom repository roles. This enables greater control over who and how your users access code and data in your organization.": "企業帳戶允許配置最多三個自訂倉庫角色，從而為企業提供更細粒度的權限控制。這樣就能更好地控制組織內用戶訪問代碼和數據。",
                "Try GitHub Enterprise": "試用 GitHub 企業版",
        ...
        // 成員權限 /organizations/<org-login>/settings/member_privileges
            "Member repository permissions": "成員倉庫權限",
                ...
                "Projects base permissions": "項目基本權限",
                    "Projects created by members will default to the elected role below.": "成員創建的項目將預設為下面選定的角色。",
                ...
                "Admin repository permissions": "管理員倉庫權限",
                    ...
                    "Issue deletion": "議題刪除",
                        "Allow repository administrators to delete issues for this organization": "允許倉庫管理員刪除此組織的議題",
                            ...
                            "Learn more about allowing people to delete issues in your organisation": "了解更多關於允許成員刪除組織內議題的資訊",
                        // 頂部提醒
...
I18N.zh["orgs/settings/import-export"] = { // 組織設定 - 導入/導出
    "static": { // 靜態翻譯
        ...I18N.zh["orgs-settings-menu"]["static"],

        // Import/Export 導入/導出 - 占位帳戶 /organizations/<org-login>/settings/import-export
            "Mannequins": "占位帳戶",
            "Search mannequins by login or email...": "通過登錄名或電子信箱地址搜索占位帳戶...",
...
I18N.zh["orgs/settings/interaction_limits"] = { // 組織設定 - 互動限制
    "static": { // 靜態翻譯
        ...
        // Interaction limits 互動限制 /organizations/<org-login>/settings/interaction_limits
            ...
            "Limit to prior contributors": "僅限於先前的貢獻者",
                "Users that have not previously committed to the default branch of a repository in this organization will be unable to interact with that repository.": "以前從未提交到您組織某個倉庫預設分支的用戶將無法與該倉庫互動。",
            "Limit to repository collaborators": "僅限倉庫協作者",
...
I18N.zh["orgs/settings/code_review_limits"] = { // 組織設定 - 代碼審查限制
    "static": { // 靜態翻譯
        ...I18N.zh["orgs-settings-menu"]["static"],

        // 代碼審查限制 /organizations/<org-login>/settings/code_review_limits
...
I18N.zh["orgs/settings/repository-defaults"] = { // 組織設定 - 倉庫 / 預設值
    "static": { // 靜態翻譯
        ...
        // 倉庫預設分支 /organizations/<org-login>/settings/repository-defaults
            "Repository default branch": "倉庫預設分支",
                "Choose the default branch for new repositories in this organization. You might want to change the default name due to different workflows, or because your integrations still require “master” as the default branch name. You can always change the default branch name on individual repositories.": "為該組織中的新倉庫選擇預設的分支。由於工作流程的不同，或者由於您的集成仍然需要 “master” 作為預設分支名，您可能想改變默認名稱。您可以隨時改變單個倉庫的預設分支名稱。",
                "Learn more about default branches.": "了解更多關於預設分支的資訊。",
            // "Update": "更新",
            "Updating…": "更新中…",
            // 頂部提醒
                // [/New repositories created in ([^ ]+) will use main as their default branch./, "在 $1 中創建的新倉庫將使用 main 作為其預設分支。"],
            ...
            "Repository labels": "倉庫標籤",
                "Set the labels that will be included when a new repository is created in this organization.": "設定在此組織中創建新的倉庫時將包含的標籤。",
                "Learn more about managing default labels for your organization.": "了解更多關於為您的組織管理默認標籤的資訊。",
            "New label": "新建標籤",
                "Label preview": "標籤預覽",
                "Label name": "標籤名",
                "Description": "描述",
                ...
                "Save changes": "保存更改",
            // 刪除提醒
            "Are you sure? Deleting a label will remove as a default, and no future repositories will receive this label when created.": "您確定嗎？刪除標籤將作為預設值刪除，以後的倉庫在創建時不會收到此標籤。",
...
I18N.zh["orgs/settings/codespaces"] = { // 組織設定 - 倉庫 /代碼空間
    "static": { // 靜態翻譯
        ...I18N.zh["orgs-settings-menu"]["static"],
        "To manage Codespace ownership settings, please": "要管理代碼空間所有權設定，請",
        ...
        "Codespace ownership": "代碼空間所有權",
            "Control who owns codespaces created by your organization’s members on organization owned repositories. Codespace ownership dictates who is billed for usage, whose policies apply, and where audit logs are sent.": "控制誰擁有組織成員在組織擁有的倉庫上創建的代碼空間。代碼空間所有權決定了由誰來支付使用費、適用誰的策略以及審計日誌發送到何處。",
...
I18N.zh["orgs/settings/copilot"] = {  // 組織設定 - GitHub Copilot
    "static": { // 靜態翻譯
        ...
        // 組織設定 - GitHub Copilot /orgs/<org-login>/settings/copilot
            "The AI powered pair programmer for your organization. Once you complete onboarding, you’ll have the ability to manage policies and control which users or teams will have access to": "為您的組織提供人工智慧助理程式設計師。完成入職後，您將能夠管理策略並控制哪些用戶或團隊有權訪問組織內的",
    ...
    "static": { // 靜態翻譯
        ...
        // 操作頁面 /organizations/<org-login>/settings/actions
            ...
            // 運行器
                ...
                // 頂部提醒
                    "Repo-level self-hosted runners settings changed.": "倉庫級別的自託管運行器設定已更改。",

            "Artifact and log retention": "工件和日誌保留",
                "Choose the default repository settings for artifacts and logs.": "選擇工件和日誌的默認倉庫設定。",
                "days": "天",
            ...
            "Fork pull request workflows from outside collaborators": "從外部協作者，復刻拉取請求工作流程",
                ...
                "Require approval for all outside collaborators": "要求對所有外部協作者進行批准審查",
                    "All outside collaborators will always require approval to run workflows on their pull requests.": "所有外部協作者將始終需要批准才能在他們的拉取請求上運行工作流程。",
                // 頂部提醒
                    "Fork pull request outside collaborators settings saved.": "外部協作者復刻拉取請求設定已保存。",
            ...
            "Fork pull request workflows in private repositories": "私有倉庫的復刻拉取請求工作流程",
                ...
                "Run workflows from fork pull requests": "從復刻拉取請求運行工作流程",
                    ...
                    "Send write tokens to workflows from fork pull requests.": "從復刻拉取請求，發送可寫令牌到工作流程",
                        ...
                        "permissions to workflows from pull requests originating from repository forks. Note that doing so will give maintainers of those forks": "權限到工作流程，來自倉庫復刻的拉取請求。請注意，這樣做將授予這些復刻的維護者",
                        "permissions against the source repository.": "權限，針對源倉庫。",
                    "Send secrets and variables to workflows from fork pull requests.": "從復刻拉取請求，發送機密和變數到工作流程",
                        "This tells Actions to send repository secrets and variables to workflows from pull requests originating from repository forks.": "這告訴 Actions 發送倉庫機密和變數到工作流程，來自倉庫復刻的拉取請求。",
                ...
                // 頂部提醒
                    "Fork pull request workflow settings saved.": "復刻拉取請求工作流程設定已保存。",

            "Workflow permissions": "工作流程權限",
                "Choose the default permissions granted to the GITHUB_TOKEN when running workflows in this organization. You can specify more granular permissions in the workflow using YAML.": "在組織中運行工作流程時，選擇授予 GITHUB_TOKEN 的預設權限。您可以使用 YAML 在工作流程中指定更細化的權限。",
                "Learn more about managing permissions.": "了解更多關於管理權限的資訊。",
                ...
                "Repository administrators will only be able to change the default permissions to a more restrictive setting.": "倉庫管理員只能將預設權限改為更嚴格的設定。",
                    ...
                    // 頂部提醒
                        "Default workflow permissions settings saved.": "默認工作流程權限設定已保存。",

            "Required workflows": "所需的工作流程",
                "Add workflow": "添加工作流",
                "Set required workflows to run in your organization’s repositories. These workflows will run alongside the repository workflows and branch merging will be blocked until the required checks succeed.": "設定所需的工作流程，在您的組織的倉庫中運行。這些工作流程將與倉庫的工作流程一起運行，分支合併將被阻止，直到所需的檢查成功。",
        ...
        // 運行器頁面 /organizations/<org-login>/settings/actions/runners
            ...
            "Host your own runners and customize the environment used to run jobs in your GitHub Actions workflows. Runners added to this organization can be used to process jobs in multiple repositories in your organization.": "託管您自己的運行器，並訂製用於在您的 GitHub Actions 工作流程中運行作業的環境。添加到該組織的運行器可以用來處理您的組織中的多個倉庫的工作。",
            "Learn more about self-hosted runners": "了解更多關於自託管運行器的資訊",
            ...
            "New runner": "創建運行器",
                ...
                "New GitHub-hosted runner": "新建 GitHub 託管運行器",
                    "Pay-as-you-go, customizable, secure, scaled &": "即用即付、可訂製、安全、可擴展並",
        ...
        // 運行器組 /organizations/<org-login>/settings/actions/runner-groups
            "Control access to your runners by specifying the repositories that are able to use your shared organization runners. New runners will be automatically assigned to the default group if no other group is specified. Upgrade to an Enterprise plan to create groups.": "透過指定能夠使用您的共享組織運行器的倉庫來控制對運行器的訪問。如果沒有指定其他組，新運行器將自動分配到默認組。升級到企業計劃以創建組。",
        ...
        // 快取 /organizations/<org-login>/settings/actions/caches
            "Caches": "快取",
            "You can use caches for dependencies and other commonly reused files to speed up your workflows. The data on this page have at least 5 minutes of latency.": "您可以對依賴項和其他經常重複使用的文件的快取來加快您的工作流程。此頁面上的數據至少有 5 分鐘的延遲。",
            "Learn more about caches": "了解更多關於快取的資訊",
            ...
            "Nothing has been cached by workflows running in any repositories of this organization.": "該組織任何倉庫中運行的工作流程都未快取任何內容。。",
    ...
    "static": { // 靜態翻譯
        ...
        // 討論 /organizations/<org-login>/settings/discussions
            ...
            "Choose a source repository that will host the discussions.": "選擇承載討論的原始碼庫。",
                "All discussions on the source repository will be surfaced to the organization Discussions tab.": "原始碼庫上的所有討論都將顯示在組織討論選項卡中。",
...
I18N.zh["orgs/settings/projects"] = { // 組織設定 - 計劃 - 項目
    "static": { // 靜態翻譯
        ...I18N.zh["orgs-settings-menu"]["static"],
        ...
        // 項目 /organizations/<org-login>/settings/projects
            ...
            "Recommended templates": "推薦模板",
                "Customize a selection of recommended project templates for this organization. These templates will be surfaced first when a member of the organization creates a new project.": "為此組織訂製一系列推薦的項目模板。當組織成員創建新項目時，這些模板將首先出現。",
...
I18N.zh["orgs/settings/security_analysis"] = { // 組織設定 - 代碼安全性與分析
    "static": { // 靜態翻譯
        ...I18N.zh["orgs-settings-menu"]["static"],

        // 代碼安全性與分析 /organizations/<org-login>/settings/security_analysis
            "Try our new settings": "嘗試我們的新設定",
            // 頂部提醒
                "Something went wrong. Please try again.": "出了些問題。請再試一次。",

            "Security and analysis features help keep your repositories secure and updated. By enabling these features, you're granting us permission to perform read-only analysis on your organization's repositories.": "安全和分析功能有助於確保您的倉庫安全和更新。透過啟用這些功能，您授予我們對您組織的倉庫執行只讀分析的權限。",
            ...
            "Code scanning": "代碼掃描",
                "Identify vulnerabilities and errors with": "識別代碼中的漏洞和錯誤，通過",
                ". Default CodeQL analysis will be set up on": "。默認的 CodeQL 分析將被設定為",
                "eligible": "符合條件的",
                "public repositories.": "公共倉庫。",

                "Recommend the extended query suite for repositories enabling default setup": "建議為啟用默認設定的倉庫提供擴展查詢套件",
                    "The extended query includes the default suite, plus lower severity and precision queries.": "擴展查詢包括默認套件，以及較低嚴重性和精度的查詢。",

                // 對話框
                    "Enable code scanning default setup": "啟用代碼掃描默認設定",
                        "This will turn on CodeQL default setup for all eligible public repositories and repositories with GitHub Advanced Security enabled.": "這將為所有符合條件的公共倉庫和已啟用 GitHub 高級安全功能的倉庫開啟 CodeQL 默認設定。",
                        "What makes a repository eligible for default setup?": "怎樣的倉庫符合默認設定？",
                        "Query suites": "查詢套件",
                    ...
                    "Disable code scanning default setup": "禁用代碼掃描默認設定",
                        "This will disable CodeQL default setup on all repositories where it is enabled.": "這將禁用所有倉庫的 CodeQL 默認設定。",
            ...
            "Secret scanning": "機密掃描",
                ...
                "Push protection": "推送保護",
                    ...
                    "Add a resource link in the CLI and web UI when a commit is blocked": "當提交被阻止時，在 CLI 和 Web UI 中添加資源連結。",
                        "Link will show in addition to": "顯示連結和",
            ...
            "Security managers": "安全管理員",
                "Grant a team permission to manage security alerts and settings across your organization. This team will also be granted read access to all repositories.": "授予團隊管理整個組織的安全警報和設定的權限。該團隊還將被授予對所有倉庫的讀取權限。",
...
I18N.zh["orgs/settings/secrets"] = { // 組織設定 - 機密和變數
    "static": { // 靜態翻譯
        ...
        // 操作機密 /organizations/<org-login>/settings/secrets/actions
            ...
            "Learn more about encrypted secrets": "了解更多關於加密機密的資訊",
            ". Variables are shown as plain text and are used for": "。變數是明文顯示，用於",
            "non-sensitive": "不敏感",
            "data.": "數據。",
            "Learn more about variables": "了解更多關於變數的資訊",
            ...
            "Organization secrets and variables cannot be used by private repositories with your plan.": "在您的計劃中私有倉庫不能使用組織機密和變數。",
            "Please consider": "請考慮",
        ...
        // 操作變數 /organizations/<org-login>/settings/variables/actions
            "Create new organization variable": "新建組織變數",

            "Organization variables": "組織變數",
            "This organization has no variables.": "此組織尚無變數。",

            // 刪除變數對話框
            "Delete variable": "刪除變數",
                "variable": "變數",

        // 新建組織變數 /organizations/<org-login>/settings/variables/actions/new
            "Actions variables": "操作變數",
            "/ New variable": "/ 新建變數",
            "Note: Variable values are exposed as plain text. If you need to encrypt and mask sensitive information,": "注意：變數值是以純文本形式暴露的。如果您需要對敏感資訊進行加密和屏蔽，請使用",
            "create a secret": "創建機密",
            ...
            "Variable names may only contain alphanumeric characters ([a-z], [A-Z], [0-9]) or underscores (_).": "變數名稱只能包含字母數字字元（[A-Z]，[A-Z]，[0-9]）或僅下劃線（_）。",
            "Variable names cannot start with a number.": "變數名稱不能以數字開頭。",
            "Variable names cannot start with": "變數名稱不能以",
            "prefix.": "前綴開頭。",

            // 變數名稱警示
                "Variable name can only contain alphanumeric characters. Special characters and spaces are not allowed.": "變數名稱只能包含字母數字字元。不允許特殊字元和空格。",
                "Variable name can only start with a letter or underscore.": "變數名稱只能以字母或下劃線開頭。",
                "Variable name cannot start with \"GITHUB_\" prefix.": "變數名稱不能以 “GITHUB_” 前綴開頭。",

            // "Public repositories": "公共倉庫",
                "This variable may be used by public repositories in the organization. Paid GitHub plans include private repositories.": "改變數可由組織中的公共倉庫使用。付費的 GitHub 計劃包括私有倉庫。",
            // "Private repositories": "私有倉庫",
                "Organization variables cannot be used by private repositories with your plan.": "在您的計劃中私有倉庫不能使用組織變數。",
            // "Selected repositories": "選定的倉庫",
                "This variable may only be used by specifically selected repositories.": "該變數只能由特定倉庫使用。",
                    // [/(\d+) selected repositor(y|ies)/, "$1 個選定的倉庫"],
                // 變數倉庫訪問 對話框
                    "Variable repository access": "變數倉庫訪問",
                    "Select the organization repositories that may use this variable.": "選擇可以使用該變數的組織倉庫。",

            "Add variable": "添加變數",

        // 更新組織變數 /organizations/<org-login>/settings/variables/actions/<name>
            "/ Update variable": "/ 更新變數",
            "Update variable": "更新變數",
                "Saving…": "保存中…",
                "Save variable": "保存變數",
...
I18N.zh["orgs/settings/oauth_application_policy"] = { // 組織設定 - 第三方應用訪問策略
    "static": { // 靜態翻譯
        ...I18N.zh["orgs-settings-menu"]["static"],
        ...
        // 設定第三方應用訪問限制 /settings/oauth_application_policy/confirm
            ...
            "Restricting access will immediately block all unapproved applications and will disable SSH keys created before February 2014.": "限制訪問將立即阻止所有未經批准的應用，並禁用 2014 年 2 月前創建的 SSH 金鑰。",
            "Read more at GitHub Help.": "請訪問 GitHub 幫助了解更多資訊。",
        ...
        // 活躍的令牌  /organizations/<org-login>/settings/personal-access-tokens/active
            ...
            "Permissions": "權限",
                ...
                "Filter permissions": "篩選權限",
                    ...
                    "Administration": "管理員",
                    "Code scanning alerts": "代碼掃描警報",
                    "Codespaces lifecycle admin": "代碼空間生命週期管理員",
                    "Codespaces metadata": "代碼空間元數據",
                    "Codespaces secrets": "代碼空間機密",
                    "Commit statuses": "提交狀態",
                    "Contents": "內容",
...
I18N.zh["orgs/settings/apps"] = { // 組織設定 - GitHub 應用
    "static": { // 靜態翻譯
        ...
        // GitHub 應用 /organizations/<org-login>/settings/apps
            ...
            "Search by username or full name": "按使用者名稱或全名搜索",
            "Grant": "授予",
...
I18N.zh["projects"] = { // 項目頁面(含倉庫項目)
    "static": { // 靜態翻譯
        ...
        // 倉庫 項目頁面  /<user-name>/<repo-name>/projects >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            "Did you know you can manage projects in the same place you keep your code? Set up a project board on GitHub to streamline and automate your workflow.": "您知道您可以在保存代碼的同一個地方管理項目嗎？在 GitHub 上設定項目面板以簡化和自動化您的工作流程。",
        ...
        // https://github.com/users/<user-name>/projects/<id>/settings
            "Collaboration settings": "協作設定",
                "Options": "選項",
                    "Visibility": "可見性",
                    "Visibility settings only impact the project itself. Project content that belongs to a repository the user does not have access to will be redacted.": "可見性設定只影響項目本身。屬於用戶無權訪問的倉庫的項目內容將被編輯。",
                    "Public": "公開",
                        "Anyone on the internet can see this project. You choose who can make changes.": "網路上的任何人都可以看到這個項目。您選擇誰可以進行更改。",
                    "Private": "私密",
            ...
            // 協作者
                ...
                "You’ll only be able to find a GitHub user by their email address if they’ve chosen to list it publicly. Otherwise, use their username instead.": "只有當 GitHub 用戶選擇公開電子信箱地址時，您才能通過他們的電子信箱地址找到他們。否則，請使用他們的使用者名稱代替。",
                "Add collaborator": "Add collaborator",
                // [/isn’t a GitHub member/, "不是 GitHub 成員"],
            "Linked repositories": "關聯的倉庫",
                "Link a repository": "關聯倉庫",
                "Get more accurate suggestions and better search results by linking up to 25 repositories to this project.": "透過將多達 25 個倉庫關聯到這個項目，獲得更準確的建議和更好的搜索結果。",
...
I18N.zh["github-copilot/signup"] = { // GitHub Copilot 個人版獲取頁面
    "static": { // 靜態翻譯
        ...
        // https://github.com/github-copilot/signup
           ...
           "The world's most widely adopted AI developer tool.": "世界上採用最廣泛的人工智慧開發工具。",
           ...
           "Start your 30-day free trial": "開始 30 天免費試用",
               ...
               "Chat with Copilot for assistance on a wide variety of scenarios, such as project-specific code explanations or help with debugging": "與 Copilot 聊天以獲取有關各種場景的幫助，例如特定於項目的代碼解釋或除錯幫助",
               "Get code suggestions as you type in more than a dozen coding languages, including Python, JavaScript, TypeScript, Go, and Ruby": "支持超過十種程式語言的代碼建議，包括 Python、JavaScript、TypeScript、Go 和 Ruby。",
...
I18N.zh["orgs/enterprise_plan"] = { // 企業版訂閱頁面
    "static": {
        ...
        "it: Control where your code and data live in a private cloud.": "它：控制您的代碼和數據在私有雲中的存放位置。",
    },
    "regexp": [ // 正則翻譯
    ],
};

I18N.zh["codespaces"] = { // 代碼空間頁面
    "static": {
        ...
        // https://github.com/codespaces/new
            ...
            "Codespace usage for this repository is paid for by": "該倉庫的代碼空間使用費由以下人員支付",
            "Repository": "倉庫",
                "To be cloned into your codespace": "要被複製到您的代碼空間",
                "Select a repository": "選擇倉庫",
        ...
        // 在拉取請求上創建代碼空間 https://github.com/codespaces/new/<user-name>/<repo-name>/pull/<pull-id>?resume=1
            ...
            "Find out more about codespaces.": "了解更多關於代碼空間的資訊。",
            ...
            "No codespace to resume": "沒有可恢復的代碼空間",
                "You don't have a codespace matching these settings. You can continue to create a new one or customize your settings.": "您沒有符合這些設定的代碼空間。您可以繼續創建一個新空間或自訂設定。",
...
I18N.zh["features"] = {
    "static":{
        ...
        "Collaborative": "協作",
            "Coding": "編程",
        "Contribute to projects quickly with automatic environment setup.": "通過自動環境設定快速為項目做出貢獻。",
        ...
        // 列表
            ...
            // 通知
                "Get updates on the GitHub activity you've subscribed to. Use the notifications inbox to customize, triage, and manage your updates.": "獲取您訂閱的 GitHub 活動更新。使用通知收件箱來自訂、分類和管理您的更新。",
            "Code reviews": "代碼審查",
                "Review new code, see visual code changes, and confidently merge code changes with automated status checks.": "審查新代碼，查看視覺代碼更改，並通過自動化狀態檢查自信地合併代碼更改。",
            ...
            "Code owners": "代碼所有者",
                "Automatically request reviews–or require approval—by selected contributors when changes are made to sections of code that they own.": "當對他們擁有的代碼部分進行更改時，自動請求選定貢獻者的審查，或者要求他們的批准。",
            ...
            "Protected branches": "保護分支",
                "Enforce restrictions on how code branches are merged, including requiring reviews, or allowing only specific contributors to work on a particular branch.": "強制限制代碼分支的合併方式，包括要求審查，或者只允許特定貢獻者在某個特定分支上工作。",
            "Team reviewers": "團隊審查人員",
                "Request a team on GitHub to review your pull request. Members of the team will get a notification indicating that you've asked for their review.": "在GitHub上請求一個團隊審查你的拉取請求。團隊成員將收到通知，表明你已經要求他們進行審查。",
            "Multiple assignees": "多人分配",
                "Assign up to 10 people to work on a given issue or pull request, letting you more easily track who's working on what.": "可指派多達10人處理特定問題或拉取請求，讓你更容易追蹤誰在處理什麼。",
            "Multiple reviewers": "多人審查",
                "Request review from multiple contributors. Requested reviewers will be notified that you've asked for their review.": "請求多個貢獻者進行審查。被請求的審核者將收到通知，告知你已請求他們進行審查。",
            "Multi-line comments": "多行評論",
                "Clarify code reviews by referencing or commenting on multiple lines at once in a pull request diff view.": "透過在拉取請求差異視圖中一次引用或評論多行程式碼，來澄清代碼審查。",
            "Public repositories": "公共倉庫",
                "Work with any GitHub member on code in a public repository you control. Make changes, open a pull request, create an issue, and more.": "與任何GitHub成員合作在你控制的公共倉庫中的代碼。進行更改，打開一個拉取請求，創建一個問題等等。",
            "Dark mode": "深色模式",
                "Choose how you experience GitHub with theme settings. Swap to dark theme or default to your system preferences.": "透過主題設定來選擇你使用GitHub的方式。切換到深色主題或預設使用你的系統偏好設定。",
    },
    "regexp": [
    ],
};

...
I18N.zh["pubilc"] = { // 公共區域翻譯
    "static": { // 靜態翻譯
        ...
        "Feature preview": "功能預覽",
            ...
            "Rich Jupyter Notebook Diffs": "豐富的 Jupyter Notebook 差異",
        ...
        "Add review comment": "添加審查意見", // 具體拉取請求 文件審查評論
        "Start a review": "開始評論", // 具體拉取請求 文件審查評論
        // 取消按鈕 提醒資訊
...
I18N.zh["settings/billing"] = { // 設定 - 帳單和計劃
    "static": { // 靜態翻譯
        ...
        // 帳單和計劃 https://github.com/settings/billing
            ...
            "Add-ons": "附加元件",
                "GitHub Copilot": "GitHub 副駕駛",
                    "Your AI powered pair programmer": "您的人工智慧配對程式設計師",
                    "Enable GitHub Copilot": "啟用 GitHub 副駕駛",
                    "Get code suggestions for whole lines or entire functions right inside your editor.": "在編輯器中獲得整行或整個函數的程式碼建議。",

                     // 組織設定
                    "Buy Copilot for Business": "購買 GitHub 副駕駛商業版",
                    "Copilot for Business": "GitHub 副駕駛商業版",
                    "GitHub Copilot uses the OpenAI Codex to suggest code and entire functions in real-time, right from your editor. $19/month/user.": "GitHub 副駕駛使用 OpenAI Codex 即時在您的編輯器中提供程式碼和整個函數建議。每月19美元/使用者。",
    ...
    "static": { // 靜態翻譯
        ...
        // 密碼和身份身份驗證 - 帳戶安全 https://github.com/settings/security
            ...
            "Passkeys": "通行金鑰",
                ...
                "Passkeys are a password replacement that validates your identity using touch, facial recognition, a password, or a PIN.": "通行金鑰是一種密碼替代品，可透過觸摸、臉部識別、密碼或 PIN 驗證您的身份。",
...
I18N.zh["settings/deleted_repositories"] = { // 設定 - 倉庫 - 刪除的倉庫
    "static": { // 靜態翻譯
        ...
        // 刪除的倉庫 https://github.com/settings/deleted_repositories
            ...
            "Learn more about restoring deleted repositories": "了解更多有關復原已刪除倉庫的資訊",
    ...
    "static": { // 靜態翻譯
        ...
        // 註冊 GitHub 應用程式 https://github.com/settings/apps/new
            ...
            "Permissions": "權限",
                ...
                "Repository permissions": "倉庫權限",
                    ...
                    "Single file": "單個文件",
                        ...
                        "Path": "路徑",
                        "The content paths to single files your app can access.": "應用程式可以訪問的單個文件的內容路徑。",
                    "Variables": "變數",
            ...
            "Subscribe to events": "訂閱事件",
                ...
                "Label": "標籤",
                    "Label created, edited or deleted.": "標籤已建立、編輯或刪除。",
                // 公共
                    "Repository changes from private to public.": "倉庫從私有更改為公共。",
                "Repository": "倉庫",
                    "Repository created, deleted, archived, unarchived, publicized, privatized, edited, renamed, or transferred.": "倉庫建立、刪除、歸檔、取消歸檔、公開、私有化、編輯、重新命名或轉移。",
                // 星標
    ...
    "static": { // 靜態翻譯
        ...
        // 匯入倉庫 第一頁 https://github.com/new/import
            "Import your project to GitHub": "將您的項目匯入到 GitHub",
                ...
                "Support for importing Mercurial, Subversion and Team Foundation Version Control (TFVC) repositories will end on October 17, 2023. For more details, see the": "對匯入 Mercurial、Subversion 和 Team Foundation 版本控制 (TFVC) 倉庫的支援將於 2023 年 10 月 17 日結束。有關詳細資訊，請參閱",
                "changelog": "更新日誌",
    ...
    "static": { // 靜態翻譯
        ...
        // 程式碼標籤卡 & 倉庫首頁 /<user-name>/<repo-name>/ 和 /<user-name>/<repo-name>/tree/<branch>
            ...
            // 未上架的 GitHub Action 項目
                "Publish this Action to Marketplace": "將此操作發布到市場",
                "Make your Action discoverable on GitHub Marketplace and in GitHub search.": "讓您的 Action 可在 GitHub 市場和 GitHub 搜尋中被發現。",
        ...
        // 初始化空倉庫 /<user-name>/<repo-name>/
            ...
            "Invite collaborators": "邀請合作者",
                "Find people using their GitHub username or email address.": "使用 GitHub 使用者名稱或電子郵件地址尋找人員。",
...
I18N.zh["repository/pull"] = { // 倉庫 - 拉取請求頁面
    "static": { // 靜態翻譯
        ...
        // 拉取請求 --> 提交 標籤卡 /<user-name>/<repo-name>/pull/<id>/commits
            ...
            // 驗證標記浮動資訊
                "This commit was created on GitHub.com and signed with GitHub’s": "此提交是在 GitHub.com 上建立的，並使用 Github 的",
    ...
    "regexp": [ // 正則翻譯
        ...
        // [/This commit will be authored by (.+)/, "此提交將由 $1 撰寫"],// 具體的拉取請求
    ...
    "static": { // 靜態翻譯
        ...
        // 編輯文件頁面 /<user-name>/<repo-name>/edit/<branch>/<file>
            ...
            // 提交更改 對話框
                ...
                "Learn more about pull requests": "了解更多有關拉取請求的資訊",
...
I18N.zh["repository/activity"] = { // 倉庫 - 活動頁面
    ...
    "regexp": [ // 正則翻譯
        ...I18N.zh["repository-public"]["regexp"],
        [/pushed (\d+) commits? to/, "推送 $1個提交到"],
        [/pushed (\d+) commits?/, "推送 $1個提交"],
    ],
};
    ...
    "static": { // 靜態翻譯
        ...
        // 通常 - 設定頁面 /<user-name>/<repo-name>/settings ====================================
            ...
            // 禁用分支保護對話框
                ...
                "Disabling branch protection rules allows you to enforce policies only with the `preview` of Repository Rulesets. You can re-enable branch protection rules at any time. This is currently not recommended for production repositories!": "禁用分支保護規則後，您只能透過倉庫規則集的 “瀏覽” 來執行策略。您可以在任何時候重新啟用分支保護規則。目前不建議在生產庫中這樣做!",
        ...
        // 建立分支保護規則 頁面 /<user-name>/<repo-name>/settings/branch_protection_rules/new====================================
            ...
            "When enabled, all commits must be made to a non-protected branch and submitted via a pull request before they can be merged into a branch that matches this rule.": "啟用後，所有提交都必須提交到不受保護的分支，並透過拉取請求提交，然後才能將它們合併到與此規則匹配的分支中。",
                ...
                "New reviewable commits pushed to a matching branch will dismiss pull request review approvals.": "推送到匹配分支的新的可審查提交將復原拉取請求的審查批准。",
                    ...
                    "Require approval of the most recent reviewable push": "要求批准最近一次可審查的推送",
                        "Whether the most recent reviewable push must be approved by someone other than the person who pushed it.": "最近一次可審核的推送是否必須得到推送者以外的人批准。",
        ...
        // 建立分支規則 /<user-name>/<repo-name>/settings/rules/new?target=branch&enforcement=disabled
            ...
            "Bypass list": "旁路列表",
                "Add bypass": "添加旁路",
                 ...
                 // 添加旁路對話框
                    "Choose which roles": "選擇哪些角色",
                    ", teams, and apps": "、團隊和應用",
                    "can bypass this ruleset": "可繞過此規則集",
            ...
            "Target repositories": "目標倉庫", // 組織設定
                ...
                "Target:": "目標：",
                    ...
                    "Dynamic list of repositories": "動態倉庫列表",
        ...
        // 添加鉤子 頁面 /<user-name>/<repo-name>/settings/hooks/new ====================================
            ...
            "Which events would you like to trigger this webhook?": "您希望哪些事件觸發此 Web 鉤子？",
                ...
                "Let me select individual events.": "讓我選擇單個事件。",
                    ...
                    "Dependabot alerts": "Dependabot 警報",
                        "Dependabot alert auto_dismissed, auto_reopened, created, dismissed, reopened, fixed, or reintroduced.": "Dependabot 警報自動駁回、自動重新打開、建立、駁回、重新打開、修復或重新引入。",
                    "Deploy keys": "部署金鑰",
                    ...
                    "Merge groups": "合併組",
                        "Merge Group requested checks, or was destroyed.": "合併組的請求檢查或被銷毀。",
                    "Meta": "中繼資料",
                    ...
                    "Repository rulesets": "倉庫規則集",
                        ...
                        "This event is not yet public. If you would like to receive payloads for this event, you will need to explicitly choose it here.": "此事件尚未公開。如果您想接收此事件的有效負載，則需要在此處明確選擇它。",
    ...
    "static": { // 靜態翻譯
        ...
        // GitHub Pages 頁面 /<user-name>/<repo-name>/settings/pages====================================
            ...
            "Custom domain": "自訂域",
                ...
                "Learn more about configuring custom domains": "了解更多有關配置自訂域的資訊",
                    "Remove": "移除",
                    "Check again": "再檢查一次",
                ...
                "Enforce HTTPS": "強制 HTTPS",
                    ...
                    "Learn more about securing your GitHub Pages site with HTTPS": "了解更多有關使用 HTTPS 保護 GitHub Pages 站點安全的資訊",
    ...
    "static": { // 靜態翻譯
        ...
        // 雙重身份驗證登入 https://github.com/sessions/two-factor/app
            ...
            "Having problems?": "有問題嗎？",
                ...
                "Use a recovery code or begin account recovery": "使用復原碼或開始帳戶復原",
        ...
        // 配置無密碼身份驗證 https://github.com/sessions/trusted-device?return_to=%2Fsettings%2Fsecurity
            ...
            "Add a passkey": "添加通行金鑰",
            "Your device supports passkeys, a password replacement that validates your identity using touch, facial recognition, a password, or a PIN.": "您的裝置支援密碼替代方案，透過觸摸、臉部識別、密碼或者 PIN 碼來驗證您的身份。",
    ...
    "static": { // 靜態翻譯
        ...
        // 搜尋結果頁面 https://github.com/search?q=  >>>>>>>>>>>>>>>>>>>>>>>>
            ...
            // &type=registrypackages
                ...
                "Learn more about GitHub Packages": "了解更多有關 GitHub 套裝軟體的資訊",
            ...
            "Search across repositories": "跨倉庫搜尋",
                ...
                "Note that we don't currently support regular expressions in the repo or org qualifiers. For more information on search syntax, see our": "請注意，我們目前不支援 repo 或 org 限定符中的正規表示式。更多有關搜尋語法的資訊，請參閱我們的",
                "syntax guide": "語法指南",
            ...
            "Why wasn't my code found?": "為什麼找不到我的程式碼？",
                "During the feature preview,": "在功能預覽期間，",
                "not all code is indexed.": "並非所有程式碼都被索引。",

                "The index currently includes more than 7 million popular public repositories, plus all private repositories accessible to members of the technical preview.": "該索引目前包括超過 700 萬個流行的公共倉庫，以及技術預覽版成員可以訪問的所有私有倉庫。",
        ...
        // 成員權限 /organizations/<org-login>/settings/member_privileges
            ...
            "Organization member permissions": "組織成員的權限",
                ...
                "Integration access requests": "整合訪問請求",
                    ...
                    "Outside collaborators will be able to request access for GitHub or OAuth apps to access this organization and its resources.": "外部協作者將能夠為 GitHub 或 OAuth 應用程式申請訪問該組織及其資源的權限。",
...
I18N.zh["projects"] = { // 項目頁面(含倉庫項目)
    "static": { // 靜態翻譯
        ...
        // 倉庫 項目頁面  /<user-name>/<repo-name>/projects >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            "Wrap up": "結束工作",
            "After you wrap up your work, close your project board to remove it from your active projects list. On to the next project!": "結束工作後，關閉項目板，並從活動項目列表中刪除。進入下一個項目！",
